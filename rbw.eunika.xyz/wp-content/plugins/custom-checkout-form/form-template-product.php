...
<div class="container">
  <form id="billing-shipping-form">
    ...
    <div id="fillup-step-1">
      <h2>Your Premium Wine Awaits—Just One More Step!</h2>
      <p>Provide your email to ensure prompt delivery.</p>
    ...
    <div id="fillup-step-2" style="display:none;">
      ...
      <div class="d-flex flex-column flex-md-row justify-content-between">
        <button type="button" class="btn btn-secondary mb-2 mb-md-0" id="back-step">Back</button>
        <button type="submit" class="btn btn-flat-maroon">Proceed to Checkout</button>
      </div>
