...
<footer>
  <div class="container-fluid pt-5 px-md-5" style="background-color: #eff2f7;color: #83868c;">
    ...
    <div class="card container pt-5" style="margin: 2rem auto 5rem">
      <div class="card-body">
        <div class="row">
          <div class="col-md-3 col-lg-2">
            <h5 class="px-4 font-weight-bold text-center text-md-left mb-5 mb-md-0" style="font-size: 22px; text-wrap: nowrap;">As seen in</h5>
          </div>

          <div class="col-md-9 col-lg-10">
            <div class="client-footer w-100">
              <div>
                <img src="<?= wp_get_attachment_url(805) ?>" width="150">
              </div>
              <div>
                <img src="<?= wp_get_attachment_url(806) ?>" width="150">
              </div>
              <div>
                <img src="<?= wp_get_attachment_url(807) ?>" width="150">
              </div>
              <div>
                <img src="<?= wp_get_attachment_url(808) ?>" width="150">
              </div>
            </div>
          </div>
        </div>
          ...
          <?php foreach ($coverage_areas as $_coverage_areas) : ?>
            <li>
              <a href="<?= $_coverage_areas->url ?>">
                <span><i class="fas fa-chevron-right mr-1"></i></span>
                <span><?= $_coverage_areas->title ?></span>
              </a>
            </li>
          <?php endforeach; ?>
        </ul>
    ...
    <div class="row p-3">
      ...
      <div class="col-md-5">
        <p>
          © London House Cleaners Ltd. <a href="https://find-and-update.company-information.service.gov.uk/company/15395756">Company No. 15395756</a> | All Rights Reserved | <a href="/terms-and-conditions/">Terms &amp; Conditions</a> | <a href="/privacy-policy/">Privacy Policy</a> | <a href="/sitemap/">Sitemap</a>
        </p>
      </div>
