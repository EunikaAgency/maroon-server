...
class Dsm_Supreme_Modules_Pro_For_Divi {
	...
	private function define_admin_hooks() {
		...
		add_action( 'init', array( $this, 'dsm_attachment_category_fields' ), 0 );
		add_action( 'wp_ajax_nopriv_divi_supreme_get_attachments', array( $this, 'divi_supreme_get_attachments' ) );
	...
	public function divi_supreme_get_attachments() {
		...
		$categories  = isset( $_REQUEST['categories'] ) ? sanitize_text_field( wp_unslash( $_REQUEST['categories'] ) ) : array(); // phpcs:ignore WordPress.Security.NonceVerification
