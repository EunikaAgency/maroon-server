...
class Dsm_Supreme_Modules_Pro_For_Divi_Public {
	...
	public function enqueue_styles() {
		...
		if ( $dsm_dynamic_assets ) {
			...
			wp_enqueue_style( 'magnific-popup', $et_builder_url . '/includes/builder/feature/dynamic-assets/assets/css/magnific_popup.css', array(), DSM_PRO_VERSION, 'all' );
			wp_enqueue_style( 'dsm-swiper' );
			wp_enqueue_style( 'dsm-popup', plugin_dir_url( __DIR__ ) . 'public/css/popup.css', array(), DSM_PRO_VERSION, 'all' );
			wp_enqueue_style( 'dsm-animate' );
	...
	public function enqueue_scripts() {
		...
		wp_register_script( 'dsm-facebook', 'https://connect.facebook.net/' . $facebook_lang . '/sdk.js#xfbml=1&version=v14.0' . $facebook_app_id, array(), null, true );
