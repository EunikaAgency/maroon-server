...
<head>
  ...
  <title>Your Quote Request – 2K Threads</title>
  <style>
      ...
      <tr>
        <td align="center">
          <table class="container" width="100%" cellpadding="0" cellspacing="0" role="presentation">
            ...
            <tr>
              <td class="content">
                <h1>Thanks for Requesting a Quote, <?= esc_html($first_name ?: $full_name); ?>!</h1>
                <p>We've received your request and are stitching together the perfect solution for your needs. One of our team members will be in touch soon to discuss your custom order.</p>

                <div class="user-details">
                  <p><strong>Name:</strong> <?= esc_html($full_name); ?></p>
                  <p><strong>Email:</strong> <?= esc_html($email); ?></p>
                  <p><strong>Phone:</strong> <?= esc_html($phone); ?></p>
                  <p><strong>Preferred Contact:</strong> <?= esc_html(implode(', ', $contact_methods)); ?></p>
                  <p><strong>Garment Types:</strong> <?= esc_html(implode(', ', $garment_types)); ?></p>
                  <p><strong>Decoration Method:</strong> <?= esc_html(implode(', ', $decoration_types)); ?></p>
                  <p><strong>Quantity:</strong> <?= esc_html($quantity); ?></p>
                  <p><strong>Project Details:</strong> <?= nl2br(esc_html($project_details)); ?></p>
                  <?php if (!empty($other_details)): ?>
                    <p><strong>Other Details:</strong> <?= nl2br(esc_html($other_details)); ?></p>
                  <?php endif; ?>
                </div>

                <p>Want to see more of what we do? Visit <a href="https://2kthreads.com.au" style="color: #000000; text-decoration: underline;">2kthreads.com.au</a> to browse our styles and services.</p>
