...
?><?php
// prolog NCoreMacros
list($_l, $_g) = NCoreMacros::initRuntime($template, '8bsez84vvv')
;
// prolog NUIMacros
...
// main template
//
NCoreMacros::includeTemplate($el->common('header'), $template->getParameters(), $_l->templates['8bsez84vvv'])->render() ?>
...
<?php NCoreMacros::includeTemplate(WpLatteMacros::getTemplatePart("ait-theme/elements/members/javascript", ""), array('enableCarousel' => $enableCarousel) + get_defined_vars(), $_l->templates['8bsez84vvv'])->render() ;