...
<?php NCoreMacros::includeTemplate(WpLatteMacros::getTemplatePart("parts/seo", ""), array() + get_defined_vars(), $_l->templates['i7q3rjkv0v'])->render() ?>
...
<?php NCoreMacros::includeTemplate(WpLatteMacros::getTemplatePart("parts/header-share", ""), array('showShare' => $options->theme->header->headerShare) + get_defined_vars(), $_l->templates['i7q3rjkv0v'])->render() ?>
...
<?php NCoreMacros::includeTemplate(WpLatteMacros::getTemplatePart("parts/social-icons", ""), array() + get_defined_vars(), $_l->templates['i7q3rjkv0v'])->render() ?>

<?php NCoreMacros::includeTemplate(WpLatteMacros::getTemplatePart("parts/languages-switcher", ""), array() + get_defined_vars(), $_l->templates['i7q3rjkv0v'])->render() ?>

<?php NCoreMacros::includeTemplate(WpLatteMacros::getTemplatePart("parts/woocommerce-cart", ""), array() + get_defined_vars(), $_l->templates['i7q3rjkv0v'])->render() ?>
					</div>
