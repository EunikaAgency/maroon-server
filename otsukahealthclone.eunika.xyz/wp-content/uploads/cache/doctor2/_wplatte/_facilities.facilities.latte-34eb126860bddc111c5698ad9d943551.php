...
?><?php
// prolog NCoreMacros
list($_l, $_g) = NCoreMacros::initRuntime($template, '5sw7qwefrm')
;
// prolog NUIMacros
...
// main template
//
NCoreMacros::includeTemplate($el->common('header'), $template->getParameters(), $_l->templates['5sw7qwefrm'])->render() ?>
...
<?php NCoreMacros::includeTemplate(WpLatteMacros::getTemplatePart("ait-theme/elements/facilities/javascript", ""), array() + get_defined_vars(), $_l->templates['5sw7qwefrm'])->render() ;