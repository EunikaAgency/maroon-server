<?php //netteCache[01]000608a:2:{s:4:"time";s:21:"0.97866800 1645106968";s:9:"callbacks";a:4:{i:0;a:3:{i:0;a:2:{i:0;s:6:"NCache";i:1;s:9:"checkFile";}i:1;s:120:"/home/585141.cloudwaysapps.com/mefvckxeyh/public_html/wp-content/themes/doctor2/ait-theme/elements/members/members.latte";i:2;i:1644560582;}i:1;a:3:{i:0;a:2:{i:0;s:6:"NCache";i:1;s:10:"checkConst";}i:1;s:20:"NFramework::REVISION";i:2;s:22:"released on 2014-08-28";}i:2;a:3:{i:0;a:2:{i:0;s:6:"NCache";i:1;s:10:"checkConst";}i:1;s:15:"WPLATTE_VERSION";i:2;s:5:"2.9.2";}i:3;a:3:{i:0;a:2:{i:0;s:6:"NCache";i:1;s:10:"checkConst";}i:1;s:17:"AIT_THEME_VERSION";i:2;s:5:"2.0.4";}}}?><?php

// source file: /home/585141.cloudwaysapps.com/mefvckxeyh/public_html/wp-content/themes/doctor2/ait-theme/elements/members/members.latte

?><?php
// prolog NCoreMacros
list($_l, $_g) = NCoreMacros::initRuntime($template, 'g5zna7qwi7')
;
// prolog NUIMacros
...
// main template
//
NCoreMacros::includeTemplate($el->common('header'), $template->getParameters(), $_l->templates['g5zna7qwi7'])->render() ?>
...
<?php if ($query->havePosts) { $layout = $el->option->layout ;$textRows = $el->option->textRows ;$socialIconsType = $el->option->socialIconsType ;if ($layout == 'box') { $enableCarousel  = $el->option->boxEnableCarousel ;$boxAlign 		  = $el->option->boxAlign ;$numOfRows       = $el->option->boxRows ;$numOfColumns    = $el->option->boxColumns ;$imageHeight     = $el->option->boxImageHeight ;$imgWidth = 640 ;} else { $enableCarousel  = $el->option->listEnableCarousel ;$numOfRows       = $el->option->listRows ;$numOfColumns    = $el->option->listColumns ;$imageHeight     = $el->option->listImageHeight ;$imgWidth = 220 ;} ?>
...
"><?php echo $template->striptags($meta->about) ?></p></div>
<?php } ?>
...
<?php if ($socialIconsType == 'font') { ?>

<?php $iterations = 0; foreach ($meta->icons as $icon) { ?>

<?php if (isset($icon['iconFont']) && $icon['iconFont'] != "") { ?>
											<li><a href="<?php echo NTemplateHelpers::escapeHtml($icon['url'], ENT_COMPAT) ?>
" target="_blank"><i class="fa <?php echo NTemplateHelpers::escapeHtml($icon['iconFont'], ENT_COMPAT) ?>"></i></a></li>
<?php } else { ?>
											<li><a href="<?php echo NTemplateHelpers::escapeHtml($icon['url'], ENT_COMPAT) ?>
" target="_blank"><img src="<?php echo NTemplateHelpers::escapeHtml($icon['image'], ENT_COMPAT) ?>
" alt="<?php echo $icon['title'] ?>" /></a></li>
<?php } ?>

<?php $iterations++; } } else { $iterations = 0; foreach ($meta->icons as $icon) { ?>
										<li><a href="<?php echo NTemplateHelpers::escapeHtml($icon['url'], ENT_COMPAT) ?>
" target="_blank"><img src="<?php echo NTemplateHelpers::escapeHtml($icon['image'], ENT_COMPAT) ?>
" alt="<?php echo $icon['title'] ?>" /></a></li>
<?php $iterations++; } } ?>
...
<?php NCoreMacros::includeTemplate(WpLatteMacros::getTemplatePart("ait-theme/elements/members/javascript", ""), array('enableCarousel' => $enableCarousel) + get_defined_vars(), $_l->templates['g5zna7qwi7'])->render() ;