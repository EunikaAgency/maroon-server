...
?><?php
// prolog NCoreMacros
list($_l, $_g) = NCoreMacros::initRuntime($template, 'socwbnst6n')
;
// prolog NUIMacros
...
// main template
//
NCoreMacros::includeTemplate($el->common('header'), $template->getParameters(), $_l->templates['socwbnst6n'])->render() ?>
...
<?php NCoreMacros::includeTemplate(WpLatteMacros::getTemplatePart("ait-theme/elements/infopanel/javascript", ""), array() + get_defined_vars(), $_l->templates['socwbnst6n'])->render() ;