...
?><?php
// prolog NCoreMacros
list($_l, $_g) = NCoreMacros::initRuntime($template, '3lv3og3l4w')
;
// prolog NUIMacros
...
// main template
//
NCoreMacros::includeTemplate($element->common('header'), $template->getParameters(), $_l->templates['3lv3og3l4w'])->render() ?>
...
<?php NCoreMacros::includeTemplate(WpLatteMacros::getTemplatePart("ait-theme/elements/toggles/javascript", ""), array() + get_defined_vars(), $_l->templates['3lv3og3l4w'])->render() ;