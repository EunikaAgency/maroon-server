...
<?php if ($elements->unsortable['revolution-slider']->display) { if($elements->unsortable['revolution-slider']->getId() === 'columns' or $elements->unsortable['revolution-slider']->isEnabled()){
				NCoreMacros::includeTemplate($elements->unsortable['revolution-slider']->getTemplate(), array('el' => $elements->unsortable['revolution-slider'], 'element' => $elements->unsortable['revolution-slider'], 'htmlId' => $elements->unsortable['revolution-slider']->getHtmlId(), 'htmlClass' => $elements->unsortable['revolution-slider']->getHtmlClass()) + $template->getParameters(), $_l->templates['19swq1hf6z'])->render();
			}else{
...
<?php if($element->getId() === 'columns' or $element->isEnabled()){
				NCoreMacros::includeTemplate($element->getTemplate(), array('el' => $element, 'element' => $element, 'htmlId' => $element->getHtmlId(), 'htmlClass' => $element->getHtmlClass()) + $template->getParameters(), $_l->templates['19swq1hf6z'])->render();
			}else{
