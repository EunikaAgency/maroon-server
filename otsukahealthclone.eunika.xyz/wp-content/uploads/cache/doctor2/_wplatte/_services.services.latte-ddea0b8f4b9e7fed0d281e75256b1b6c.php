...
?><?php
// prolog NCoreMacros
list($_l, $_g) = NCoreMacros::initRuntime($template, 'uss8323ohs')
;
// prolog NUIMacros
...
// main template
//
NCoreMacros::includeTemplate($el->common('header'), $template->getParameters(), $_l->templates['uss8323ohs'])->render() ?>
...
<?php NCoreMacros::includeTemplate(WpLatteMacros::getTemplatePart("ait-theme/elements/services/javascript", ""), array('enableCarousel' => $enableCarousel) + get_defined_vars(), $_l->templates['uss8323ohs'])->render() ;