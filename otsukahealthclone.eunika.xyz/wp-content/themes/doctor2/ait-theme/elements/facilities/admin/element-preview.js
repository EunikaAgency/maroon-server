	...
	var element = {
		...
		updateContent: function() {
			var options = $.extend({}, element.options, {
				columns: parseInt(element.getOpt('itemcolumns').val())
			});

			return ait.admin.options.elements.Ui.updateContentPreview(element.preview, element.optId, elementData.currentLocale, options);
		},
