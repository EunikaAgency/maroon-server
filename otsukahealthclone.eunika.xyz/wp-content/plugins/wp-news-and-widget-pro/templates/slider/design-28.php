<?php
/**
 * Template for WP News and Scrolling Widgets Pro Loop - design-28
 *
 * This template can be overridden by copying it to yourtheme/wp-news-and-widget-pro/slider/design-28.php
 *
...
<div class="wpnaw-news-slides">
	<div class="wpnaw-news-overlay">
		<div class="wpnaw-news-white-overlay"></div>
