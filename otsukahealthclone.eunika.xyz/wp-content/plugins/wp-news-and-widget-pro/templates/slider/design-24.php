 ...
 *
 * This template can be overridden by copying it to yourtheme/wp-news-and-widget-pro/slider/design-24.php
 *
	...
	<div class="wpnaw-news-grid-content <?php if ( empty($post_featured_image) ) { echo 'no-thumb-image'; } ?>">
		...
		if($show_content) { ?>
			<div class="wpnaw-news-content">
				<div class="wpnaw-news-line-1"></div>
				...
				<div class="wpnaw-news-line-2"></div>
