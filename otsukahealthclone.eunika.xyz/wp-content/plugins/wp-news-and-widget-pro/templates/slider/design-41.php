<?php
/**
 * Template for WP News and Scrolling Widgets Pro Loop - design-41
 *
 * This template can be overridden by copying it to yourtheme/wp-news-and-widget-pro/slider/design-41.php
 *
...
<div class="wpnaw-news-slides wpnaw-clr-<?php echo esc_attr($grid_count); ?>">
	<div class="wpnaw-news-grid-content <?php if ( empty($post_featured_image) ) { echo 'no-thumb-image'; } ?>">
		<div class="wpnaw-news-colorfull-bg">
			...
			<?php } ?>
			<div class="wpnaw-news-content-bacground">
