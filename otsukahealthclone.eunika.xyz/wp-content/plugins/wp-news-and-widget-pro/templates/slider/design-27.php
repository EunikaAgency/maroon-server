 ...
 *
 * This template can be overridden by copying it to yourtheme/wp-news-and-widget-pro/slider/design-27.php
 *
...
if(( $count % 2 ) > 0) { ?>
 ...
 <?php } else { ?>
	...
	<div class="wpnaw-news-slides wpnaw-noimage" style="<?php echo esc_attr($height_css); ?>">
 		<div class="wpnaw-news-grid-content">
			<?php if($show_category_name && $cate_name !='') { ?>
				<div class="wpnaw-news-categories"><?php echo wp_kses_post($cate_name); ?></div>
			<?php } 
