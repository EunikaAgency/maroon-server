<?php
/**
 * Template for WP News and Scrolling Widgets Pro Loop - design-14
 *
 * This template can be overridden by copying it to yourtheme/wp-news-and-widget-pro/slider/design-14.php
 *
...
<div class="wpnaw-news-slides wpnaw-clr-<?php echo esc_attr( $grid_count ); ?>">  
	<div class="wpnaw-news-grid-content">
		<div class="wpnaw-news-overlay">
			...
			<div class="wpnews-medium-6 wpnews-columns">
				<div class="wpnaw-news-title-content" style="<?php echo esc_attr( $height_css ); ?>">
