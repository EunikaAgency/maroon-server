<?php
/**
 * Template for WP News and Scrolling Widgets Pro Loop - design-10
 *
 * This template can be overridden by copying it to yourtheme/wp-news-and-widget-pro/slider/design-10.php
 *
		...
		<div class="wpnaw-news-overlay">
			...
			<div class="wpnaw-news-title-content">
				...
				<?php if( $slides_column == '3') { ?>
						<a href="<?php echo esc_url( $post_link ); ?>" target="<?php echo esc_attr( $link_target ); ?>"><?php echo wpnw_pro_limit_words( $news_post_title, 13 ); ?></a>
					<?php } else { ?>
