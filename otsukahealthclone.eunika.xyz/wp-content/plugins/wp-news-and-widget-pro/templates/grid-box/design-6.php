<?php
/**
 * Template for WP News and Scrolling Widgets Pro Loop - design-6
 *
 * This template can be overridden by copying it to yourtheme/wp-news-and-widget-pro/grid-box/design-6.php
 *
...
$grid_modulo	= ( $grid_count % 5 );
$image_height 	= ! empty( $image_height ) 	? $image_height : '500';
$dynamic_height = ( $grid_modulo == 1 ) 	? $image_height : (($image_height/2)-2);
$grid_count_box = ! empty( $grid_modulo )	? $grid_modulo : 5;
