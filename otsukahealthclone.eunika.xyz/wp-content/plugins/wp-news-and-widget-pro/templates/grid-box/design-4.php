<?php
/**
 * Template for WP News and Scrolling Widgets Pro Loop - design-4
 *
 * This template can be overridden by copying it to yourtheme/wp-news-and-widget-pro/grid-box/design-4.php
 *
...
$css_class = ( $grid_count % 2  == 0 ) ? ' wpnw-first' : '';
if($grid_count == 1) { ?>
...
<?php } else {
	...
	<div class="wpnews-medium-6 wpnews-columns <?php echo $css_class; ?>">
