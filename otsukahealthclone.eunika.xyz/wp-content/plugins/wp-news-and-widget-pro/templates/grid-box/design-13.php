<?php
/**
 * Template for WP News and Scrolling Widgets Pro Loop - design-13
 *
 * This template can be overridden by copying it to yourtheme/wp-news-and-widget-pro/grid-box/design-13.php
 *
...
<div class="wpnaw-news-grid-box wpnaw-clr-<?php echo esc_attr($grid_count); ?> <?php echo esc_attr($dynamic_class); ?> wpnews-columns">
