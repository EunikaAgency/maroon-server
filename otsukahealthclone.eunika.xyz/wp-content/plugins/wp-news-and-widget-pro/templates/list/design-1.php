 ...
 *
 * This template can be overridden by copying it to yourtheme/wp-news-and-widgets-pro/list/design-1.php
 *
...
<div class="wpnaw-news-list wpnaw-clearfix">
	<div class="wpnaw-news-list-content">
		...
		<?php } ?>
		<div class="<?php if ( empty($post_featured_image) ) { echo 'wpnews-medium-12 wpnews-columns'; } else { echo 'wpnews-medium-6 wpnews-columns'; } ?>">
			<?php if ( $post_featured_image ) { ?>
				<div class="wpnaw-image-left-overlay">
			<?php } 
