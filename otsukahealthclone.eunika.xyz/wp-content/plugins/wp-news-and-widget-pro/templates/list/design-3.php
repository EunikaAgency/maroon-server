<?php
/**
 * Template for WP News and Five Widgets Pro Loop - design-3
 *
 * This template can be overridden by copying it to yourtheme/wp-news-and-widgets-pro/list/design-3.php
 *
...
if(0 == $newscount % 2 ) { ?>
	<div class="wpnaw-news-list wpnaw-clearfix">
		<div class="wpnaw-news-list-content">
			...
			<?php } ?>
			<div class="<?php if( empty($post_featured_image) ) { echo 'wpnews-medium-12 wpnews-columns wpnaw-content-border'; } else { echo 'wpnews-medium-6 wpnews-columns wpnaw-content-border'; } ?>">
				<div class="wpnaw-title-overlay-border">
