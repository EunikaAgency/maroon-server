 ...
 *
 * This template can be overridden by copying it to yourtheme/wp-news-and-widgets-pro/list/design-6.php
 *
	...
	<div class="wpnaw-news-list-content">
		<?php if( $post_featured_image ) { ?>
			<div class="wpnews-medium-5 wpnews-columns">
				...
				<div class="wpnaw-slideline"><hr></div>
			</div>
		<?php } ?>
		<div class="<?php if ( empty($post_featured_image) ) { echo 'wpnews-medium-12 wpnews-columns'; } else { echo 'wpnews-medium-7 wpnews-columns'; } ?>">
