<?php
/**
 * Template for WP News and Five Widgets Pro Loop - design-8
 *
 * This template can be overridden by copying it to yourtheme/wp-news-and-widgets-pro/list/design-8.php
 *
...
if(0 == $newscount % 2 ) { ?>
	<div class="wpnaw-news-list wpnaw-clearfix">
		<div class="wpnaw-news-list-content">
			...
			<?php } ?>
			<div class="<?php if( empty($post_featured_image) ) { echo 'wpnews-medium-12 wpnews-columns wpnaw-news-image-content-right'; } else { echo 'wpnews-medium-6 wpnews-columns  wpnaw-news-image-content-right'; } ?>">
...
<?php } else { ?>
	...
	<div class="wpnaw-news-list wpnaw-clearfix">
		<div class="wpnaw-news-list-content">
			<div class="<?php if( empty($post_featured_image) ) { echo 'wpnews-medium-12 wpnews-columns wpnaw-news-image-content-right'; } else { echo 'wpnews-medium-6 wpnews-columns wpnaw-news-image-content-left'; } ?>">
				<?php if($show_category_name && $cate_name !='') { ?>
					<div class="wpnaw-news-categories">
						<?php echo wp_kses_post($cate_name); ?>
					</div>
