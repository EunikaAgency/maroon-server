<?php
/**
 * Template for WP News and Scrolling Widgets Pro Loop - design-44
 *
 * This template can be overridden by copying it to yourtheme/wp-news-and-widget-pro/grid/design-44.php
 *
...
<div class="wpnaw-news-grid wpnaw-clr-<?php echo $grid_count; ?> wpnews-medium-<?php echo esc_attr($newsprogrid); ?> wpnews-columns <?php echo esc_attr($css_class); ?>">
