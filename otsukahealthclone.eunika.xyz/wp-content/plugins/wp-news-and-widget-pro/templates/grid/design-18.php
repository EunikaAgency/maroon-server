<?php
/**
* Template for WP News and Scrolling Widgets Pro Loop - design-18
*
* This template can be overridden by copying it to yourtheme/wp-news-and-widget-pro/grid/design-18.php
*
...
<div class="wpnaw-news-grid  wpnews-medium-<?php echo esc_attr($newsprogrid); ?> wpnews-columns <?php echo esc_attr($css_class); ?>">
	<div class="wpnaw-news-overlay">
		<a class="wpnaw-news-link" href="<?php echo esc_url($post_link); ?>" target="<?php echo esc_attr($link_target) ?>"></a>
		...
		<div class="wpnaw-news-short-content">
			<div class="wpnaw-item-meta bottom">
				...
				if( $news_post_title ) { ?>
					<h2 class="wpnaw-news-title">
						<?php if($grid == '3') { ?>	
							<a href="<?php echo esc_url($post_link); ?>" target="<?php echo esc_attr($link_target) ?>"><?php echo wpnw_pro_limit_words($news_post_title, 8); ?></a>
						<?php } else { ?>
				...
				if($show_content) { ?>
					<div class="wpnaw-news-content">
						<?php if(empty( $show_full_content ) ) { ?>
							<div class="wpnaw-news-sub-short-content"><?php echo wpnw_pro_get_post_excerpt( NULL, get_the_content(), $content_words_limit, $content_tail ); ?></div>
