<?php
/**
 * Template for WP News and Scrolling Widgets Pro Loop - design-35
 *
 * This template can be overridden by copying it to yourtheme/wp-news-and-widget-pro/grid/design-35.php
 *
...
<div class="wpnaw-news-grid wpnews-medium-<?php echo esc_attr($newsprogrid); ?> wpnews-columns <?php echo esc_attr($css_class); ?>">
	<div class="wpnaw-news-image-bg" style="<?php echo esc_attr($height_css); ?>">
		...
		<?php } ?>
		<div class="wpnaw-news-while-overlay">
			<div class="wpnaw-news-while-overlay-inner">
