<?php
/**
 * Template for WP News and Scrolling Widgets Pro Loop - design-49
 *
 * This template can be overridden by copying it to yourtheme/wp-news-and-widget-pro/grid/design-49.php
 *
...
<div class="wpnaw-news-grid wpnews-medium-<?php echo esc_attr($newsprogrid); ?> wpnews-columns <?php echo esc_attr($css_class); ?>">
	<div class="wpnaw-news-overlay-main">
				...
				<div class="wpnaw-title-content">
					...
					if( $news_post_title ) { ?>
						<h2 class="wpnaw-news-title">
							<a class="wpnaw-link-border" href="<?php echo esc_url($post_link); ?>" target="<?php echo esc_attr($link_target) ?>"><?php echo wp_kses_post($news_post_title); ?></a>
						</h2>
					<?php } ?>
				</div>
			</div>
