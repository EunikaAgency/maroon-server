<?php
/**
 * Template for WP News and Scrolling Widgets Pro Loop - design-24
 *
 * This template can be overridden by copying it to yourtheme/wp-news-and-widget-pro/grid/design-24.php
 *
...
<?php } else { ?>
	<div class="wpnaw-news-grid  wpnews-medium-<?php echo esc_attr($newsprogrid); ?> wpnews-columns wpnaw-noimage <?php echo esc_attr($css_class); ?>" style="<?php echo esc_attr($height_css); ?>">
 		<div class="wpnaw-news-grid-content">
			<?php if( $show_category_name && $cate_name !='' ) { ?>
