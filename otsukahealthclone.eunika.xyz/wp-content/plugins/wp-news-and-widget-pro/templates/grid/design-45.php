<?php
/**
 * Template for WP News and Scrolling Widgets Pro Loop - design-45
 *
 * This template can be overridden by copying it to yourtheme/wp-news-and-widget-pro/grid/design-45.php
 *
...
if(0 != $count % 2 ) { ?>
	<div class="wpnaw-news-grid  wpnews-medium-<?php echo esc_attr($newsprogrid); ?> wpnews-columns wpnaw-withimg <?php echo esc_attr($css_class); ?>">
 ...
 <?php } else {  ?>
	...
	<div class="wpnaw-news-grid  wpnews-medium-<?php echo esc_attr($newsprogrid); ?> wpnews-columns wpnaw-noimage <?php echo esc_attr($css_class); ?>" >
 		<div class="wpnaw-news-grid-content" style="<?php echo esc_attr($height_css); ?>">			
			<?php if($show_category_name && $cate_name !='') { ?>
				<div class="wpnaw-news-categories"><?php echo wp_kses_post($cate_name); ?></div>
			<?php } 
			if( $news_post_title ) { ?>
