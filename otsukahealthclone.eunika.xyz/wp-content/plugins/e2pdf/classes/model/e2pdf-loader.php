...
class Model_E2pdf_Loader extends Model_E2pdf_Model {
    ...
    public function init() {
        if ($this->helper->get('page') == 'e2pdf-download') {
            //Comtatiability fix with https://wordpress.org/plugins/minify-html-markup/
    ...
    public function load_filters() {
        if (get_option('e2pdf_dev_update')) {
            add_filter('pre_set_site_transient_update_plugins', array(&$this, 'update_check'), 10, 1);
        }
    }
        ...
        switch ($type) {
            case 'lang':
                $data = array(
                    ...
                    'Please wait... Trying to restore License Key...' => __('Please wait... Trying to restore License Key...', 'e2pdf'),
