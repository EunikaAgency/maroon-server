...
class ProductsController {
    ...
    function get_all_woocommerce_products_array() {
        ...
        foreach ($query->posts as $post) {
            ...
            $meta_title = function_exists('aioseo') ? aioseo()->meta->title->getTitle($product->get_id()) : get_post_meta($product->get_id(), '	_aioseo_title', true);
            $meta_description  = function_exists('aioseo') ? aioseo()->meta->description->getDescription($product->get_id()) : get_post_meta($product->get_id(), '_aioseo_description', true);
