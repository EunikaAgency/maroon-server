...
namespace Haru_PrintSpace\Classes;
use WP_Query;
    ...
    class Haru_Ajax_Helper {
        ...
        public function haru_paging_nav_cpt() {
            the_posts_pagination(
                array(
                    'mid_size'  => 1,
                    'prev_text' => esc_html__( 'Prev', 'haru-printspace' ),
                    'next_text' => esc_html__( 'Next', 'haru-printspace' )
                )
            );
        }
        ...
        public function haru_paging_load_more_cpt() {
            ...
            ?>
                <a data-href="<?php echo esc_url( $link ); ?>" type="button" class="cpt-load-more haru-button haru-button--bg-black haru-button--size-large haru-button--round-large"></i>
                    <?php echo esc_html__( 'Load More', 'haru-printspace' ); ?>
                </a>
            <?php
            endif;
        }
        ...
        public function haru_paging_infinitescroll_cpt() {
            ...
            if ( ! empty( $link ) ) :
            ?>
                <nav id="infinite_scroll_button" data-max-page="<?php echo esc_attr( $wp_query->max_num_pages ); ?>" data-msgText="<?php echo esc_attr__( 'Loading...', 'haru-printspace' ); ?>" data-finishedMsg="<?php echo esc_attr__( 'All items loaded.', 'haru-printspace' ); ?>">
