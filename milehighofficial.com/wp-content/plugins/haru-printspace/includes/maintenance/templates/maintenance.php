...
<html <?php language_attributes(); ?>>
    ...
    <head>
        ...
        <script src="<?php echo plugins_url() . '/haru-printspace/assets/lib/redcountdown/jquery.knob.min.js'; ?>"></script>
        <script src="<?php echo plugins_url() . '/haru-printspace/assets/lib/redcountdown/jquery.ba-throttle-debounce.min.js'; ?>"></script>
        <script src="<?php echo plugins_url() . '/haru-printspace/assets/lib/redcountdown/jquery.redcountdown.js'; ?>"></script>
    </head>
