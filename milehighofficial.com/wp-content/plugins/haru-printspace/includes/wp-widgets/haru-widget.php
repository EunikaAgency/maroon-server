 ...
 * @extends     WP_Widget
 */
abstract class Haru_PrintSpace_Widget extends WP_Widget {
				...
				case "icon" :
					...
					<div style="margin: 13px 0">
						...
						<div>
							...
							<input style="float: right"  title="<?php echo esc_html__('Click to browse icon','haru-printspace') ?>" class="browse-icon button-secondary" type="button" value="<?php echo esc_html__('Browse...','haru-printspace') ?>" />
				...
				case "image" :
					...
					<div style="margin: 13px 0">
						...
						<div class="widget-image-field">
							...
							<button style="float: right" title="<?php echo esc_html__('Click to browse image','haru-printspace') ?>" class="browse-images button-secondary" type="button"><?php echo esc_html__('Browse...','haru-printspace') ?></button>
						</div>
