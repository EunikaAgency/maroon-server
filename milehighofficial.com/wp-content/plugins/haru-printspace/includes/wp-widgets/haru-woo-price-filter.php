...
class Haru_Woo_Price_Filter_Widget extends Haru_PrintSpace_Widget {
    ...
    public function __construct() {
        ...
        $this->widget_name        = esc_html__( 'Haru WooCommerce Price Filter', 'haru-printspace' );
        $this->widget_description = esc_html__( 'Widget filter products by price range list.', 'haru-printspace' );
        ...
        $this->settings = array(
            'title'         => array(
                'type'  => 'text',
                'std'   => esc_html__( 'Price filter', 'haru-printspace' ),
                'label' => esc_html__( 'Title', 'haru-printspace' )
            ),
            'show_ranges' => array(
                'type'  => 'checkbox',
                'std'   => esc_html__( 'Price filter', 'haru-printspace' ),
                'label' => esc_html__( 'Show empty price ranges', 'haru-printspace' ),
                'description' => esc_html__( 'If you have a lot of products, it may increase this widget performance.', 'haru-printspace' ),
            ),
        );
    ...
    private function generate_price_links( $min, $max, $min_price, $max_price, $show_ranges ) {
        ...
        $links[] = array(
            'href'  => $link_no_price,
            'title' => esc_html__( 'All', 'haru-printspace' ),
