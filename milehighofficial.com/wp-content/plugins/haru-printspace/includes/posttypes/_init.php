...
if ( ! class_exists( 'Haru_PrintSpace_Posttypes' ) ) {
	class Haru_PrintSpace_Posttypes {
		...
		public function includes() {
			require_once( HARU_PRINTSPACE_CORE_DIR . 'includes/posttypes/header.php');
			require_once( HARU_PRINTSPACE_CORE_DIR . 'includes/posttypes/footer.php');
			require_once( HARU_PRINTSPACE_CORE_DIR . 'includes/posttypes/megamenu.php');
			require_once( HARU_PRINTSPACE_CORE_DIR . 'includes/posttypes/content.php');
		}
	}
}

Haru_PrintSpace_Posttypes::instance();
