...
if ( ! class_exists( 'Haru_PrintSpace_Post_Featured_Widget' ) ) {
	class Haru_PrintSpace_Post_Featured_Widget extends Widget_Base {
		...
		public function get_title() {
			return esc_html__( 'Haru Post Featured', 'haru-printspace' );
		}
		...
		protected function register_controls() {
			...
			$post_types = array();
			$post_types['post'] = __( 'Posts', 'haru-printspace' );
	        ...
	        $this->add_control(
                'pre_style',
                [
                    'label' => __( 'Pre Post', 'haru-printspace' ),
                    'description'   => __( 'If you choose Pre Post you will use Style default from our theme.', 'haru-printspace' ),
                    'type' => Controls_Manager::SELECT,
                    'default' => 'slick',
                    'options' => [
                        'slick'     => __( 'Slick Normal', 'haru-printspace' ),
                        'slick-2'     => __( 'Slick Overflow Right', 'haru-printspace' ),
                        'slick-3'     => __( 'Slick Normal Nav Opacity', 'haru-printspace' ),
	        ...
	        $this->add_control(
	            'authors', [
	                'label' => __( 'Author', 'haru-printspace' ),
	                'label_block' => true,
	                'type' => Controls_Manager::SELECT2,
	                'multiple' => true,
	                'default' => [],
	        ...
	        $this->add_control(
	            'offset',
	            [
	                'label' => __( 'Offset', 'haru-printspace' ),
	                'type' => Controls_Manager::NUMBER,
	                'default' => '0',
	            ]
	        );
            ...
            $this->add_control(
                'post_style',
                [
                    'label' => __( 'Post Style', 'haru-printspace' ),
                    'type' => Controls_Manager::SELECT,
                    'default' => 'style-1',
                    'options' => [
            ...
            $this->add_control(
                'post_padding',
                [
                  'label' => __( 'Post Padding', 'haru-printspace' ),
                  'type' => Controls_Manager::SELECT,
                  'default' => 'no-padding',
                  'options' => [
            ...
            $this->add_control(
                ...
                [
                    ...
                    'description'   => __( 'Choose Post Hover style.', 'haru-printspace' ),
                    'type' => Controls_Manager::SELECT,
                    'default' => 'none',
                    'options' => [
            ...
            $this->add_control(
                ...
                [
                    ...
                    'raw' => '<strong>' . __( 'You can set Slide Options if you set Pre Featured Post is Slick layout.', 'haru-printspace' ) . '</strong><br>',
            ...
            $this->add_control(
                ...
                [
                    'type' => Controls_Manager::RAW_HTML,
                    'raw' => '<strong>' . __( 'You can set Grid Options if you set Pre Post is Grid layout.', 'haru-printspace' ) . '</strong><br>',
                    'content_classes' => 'elementor-panel-alert elementor-panel-alert-info',
                ]
            );
