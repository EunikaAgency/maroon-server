...
if ( ! class_exists( 'Haru_PrintSpace_Text_Animation_Widget' ) ) {
	class Haru_PrintSpace_Text_Animation_Widget extends Widget_Base {
		...
		public function get_title() {
			return esc_html__( 'Haru Text Animation', 'haru-printspace' );
		}
		...
		protected function register_controls() {
	        ...
	        $this->add_control(
				'pre_style',
				[
					'label' => __( 'Pre Text Animation', 'haru-printspace' ),
					'description' 	=> __( 'If you choose Pre Text Animation you will use Style default from our theme.', 'haru-printspace' ),
					'type' => Controls_Manager::SELECT,
					'default' => 'style-1',
					'options' => [
						'style-1' 	=> __( '- Pre Text Animation 1 (56px - Black - Type)', 'haru-printspace' ),
						'style-2' 	=> __( '- Pre Text Animation 2 (56px - Gradient - Type)', 'haru-printspace' ),
						'style-3' 	=> __( '- Pre Text Animation 3 (72px - Black - Type)', 'haru-printspace' ),
					]
				]
			);
			...
			$this->add_control(
				'pre_title', [
					'label' => esc_html__( 'Pre Title', 'haru-printspace' ),
					'type' => Controls_Manager::TEXT,
					'default' => esc_html__( 'Pre Title' , 'haru-printspace' ),
					'label_block' => true,
				]
			);
			...
			$repeater->add_control(
				'list_text', [
					'label' => esc_html__( 'Rotate Title', 'haru-printspace' ),
					'type' => Controls_Manager::TEXT,
					'default' => esc_html__( 'Rotate Title' , 'haru-printspace' ),
					'label_block' => true
				]
			);
			...
			$this->add_control(
				'list',
				[
					'label' => esc_html__( 'Text Animation', 'haru-printspace' ),
					'type' => Controls_Manager::REPEATER,
					'fields' => $repeater->get_controls(),
					'default' => [
						[
							'list_text' => esc_html__( 'Animation Title #1', 'haru-printspace' ),
						],
						[
							'list_text' => esc_html__( 'Animation Title #2', 'haru-printspace' ),
						],
					],
			...
			$this->add_control(
				'period', [
					'label' => esc_html__( 'Period (ms)', 'haru-printspace' ),
            ...
            $this->add_control(
                'pre_title_color',
                [
                    'label' => __( 'Pre Title Color', 'haru-printspace' ),
            ...
            $this->add_control(
                ...
                [
                    'label' => __( 'Text Animation Color', 'haru-printspace' ),
                    'type' => Controls_Manager::COLOR,
                    'default' => '',
                    'selectors' => [
            ...
            $this->add_control(
                'sub_title_color',
                [
                    'label' => __( 'Sub Title Color', 'haru-printspace' ),
                    'type' => Controls_Manager::COLOR,
                    'default' => '',
                    'selectors' => [
			...
			$this->add_responsive_control(
				'pre_title_font_size',
				[
					'label' => __( 'Pre Title Font Size', 'haru-printspace' ),
					'devices' => [ 'desktop', 'tablet', 'mobile' ],
			...
			$this->add_responsive_control(
				...
				[
					'label' => __( 'Text Animation Font Size', 'haru-printspace' ),
					'devices' => [ 'desktop', 'tablet', 'mobile' ],
					'type' => Controls_Manager::SLIDER,
					'range' => [
						'px' => [
			...
			$this->add_responsive_control(
				'sub_title_font_size',
				[
					'label' => __( 'Sub Title Font Size', 'haru-printspace' ),
					'devices' => [ 'desktop', 'tablet', 'mobile' ],
					'type' => Controls_Manager::SLIDER,
					'range' => [
						'px' => [
