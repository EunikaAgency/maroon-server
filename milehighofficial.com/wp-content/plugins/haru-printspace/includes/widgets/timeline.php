...
if ( ! class_exists( 'Haru_PrintSpace_Timeline_Widget' ) ) {
	class Haru_PrintSpace_Timeline_Widget extends Widget_Base {
		...
		public function get_title() {
			return esc_html__( 'Haru Timeline', 'haru-printspace' );
		}
		...
		protected function register_controls() {
	        ...
	        $this->add_control(
				'pre_style',
				[
					'label' => __( 'Pre Timeline', 'haru-printspace' ),
					'description' 	=> __( 'If you choose Pre Timeline you will use Style default from our theme.', 'haru-printspace' ),
					'type' => Controls_Manager::SELECT,
					'default' => 'style-1',
					'options' => [
						'style-1' 	=> __( 'Pre Timeline 1 (Slick)', 'haru-printspace' ),
						'style-2' 	=> __( 'Pre Timeline 2', 'haru-printspace' ),
						'style-3' 	=> __( 'Pre Timeline 3', 'haru-printspace' ),
					]
				]
			);
	        ...
	        $repeater->add_control(
				'list_time', [
					'label' => esc_html__( 'Time', 'haru-printspace' ),
					'type' => Controls_Manager::TEXT,
					'default' => esc_html__( '2030' , 'haru-printspace' ),
					'label_block' => true,
				]
			);
			...
			$repeater->add_control(
                'list_video',
                [
                    'label' => __( 'Select Video', 'haru-printspace' ),
			...
			$repeater->add_control(
	            'list_award',
	            [
	                'label' 	=> esc_html__( 'Choose Awards', 'haru-printspace' ),
			...
			$this->add_control(
				'list',
				[
					'label' => esc_html__( 'Timeline List', 'haru-printspace' ),
					'type' => Controls_Manager::REPEATER,
					'fields' => $repeater->get_controls(),
					'default' => [
						[
							'list_time' => esc_html__( 'Time #1', 'haru-printspace' ),
							'list_title' => esc_html__( 'Title #1', 'haru-printspace' ),
							'list_description' => esc_html__( 'Description', 'haru-printspace' ),
							// 'list_link' => esc_html__( 'Set Link.', 'haru-printspace' ),
						],
						[
							'list_time' => esc_html__( 'Time #2', 'haru-printspace' ),
							'list_title' => esc_html__( 'Title #2', 'haru-printspace' ),
							'list_description' => esc_html__( 'Description', 'haru-printspace' ),
							// 'list_content' => esc_html__( 'Set Link.', 'haru-printspace' ),
						],
					],
			...
			$repeater_list->add_control(
				'list_link_text', [
					'label' => esc_html__( 'Link Text', 'haru-printspace' ),
					'type' => Controls_Manager::TEXT,
					'default' => esc_html__( 'Detail' , 'haru-printspace' ),
					'label_block' => true,
				]
			);
            ...
            $this->add_control(
                ...
                [
                    ...
                    'raw' => '<strong>' . __( 'You can set Slide Options if you set Pre Timeline is Slick layout.', 'haru-printspace' ) . '</strong><br>',
