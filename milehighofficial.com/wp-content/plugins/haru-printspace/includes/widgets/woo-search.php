...
if ( ! class_exists( 'Haru_PrintSpace_Woo_Search_Widget' ) ) {
    class Haru_PrintSpace_Woo_Search_Widget extends Widget_Base {
        ...
        public function get_title() {
            return esc_html__( 'Haru Woo Search', 'haru-printspace' );
        }
        ...
        protected function register_controls() {
            ...
            $this->start_controls_section(
                'section_icon',
                [
                    'label' => __( 'Search Form', 'haru-printspace' ),
                ]
            );
            ...
            $this->add_control(
                'pre_style',
                [
                    'label' => __( 'Pre Search Form', 'haru-printspace' ),
                    'type' => Controls_Manager::SELECT,
                    'default' => 'classic',
                    'options' => [
                        'classic'   => __( 'Classic', 'haru-printspace' ),
                        'minimal'   => __( 'Minimal', 'haru-printspace' ),
                        'full_screen'   => __( 'Full Screen', 'haru-printspace' ),
                        'creative'   => __( 'Creative Border', 'haru-printspace' ),
                        'flat'   => __( 'Flat', 'haru-printspace' ),
                        'toolbar'   => __( 'Toolbar', 'haru-printspace' ),
                    ]
                ]
            );
            ...
            $this->add_control(
                'search_title',
                [
                    'label' => esc_html__( 'Search Title', 'haru-printspace' ),
                    'type' => Controls_Manager::TEXT,
                    'default' => esc_html__( 'Search' , 'haru-printspace' ),
                    'label_block' => true,
                    'condition' => [
                        'pre_style' => [ 'toolbar' ],
                    ],
            ...
            $this->add_control(
                'placeholder',
                [
                    'label' => __( 'Placeholder', 'haru-printspace' ),
                    'type' => Controls_Manager::TEXT,
                    'separator' => 'before',
                    'default' => __( 'Search', 'haru-printspace' ) . '...',
                ]
            );
            ...
            $this->add_control(
                ...
                [
                    'label' => __( 'Button', 'haru-printspace' ),
            ...
            $this->add_control(
                ...
                [
                    ...
                    'default' => 'icon',
                    'options' => [
                        'icon' => __( 'Icon', 'haru-printspace' ),
                        'text' => __( 'Text', 'haru-printspace' ),
                    ],
            ...
            $this->add_control(
                'ajax_search',
                [
                    'label'         => __( 'Ajax Search', 'haru-printspace' ),
            ...
            $this->add_control(
                'ajax_search_count',
                [
                    'label' => __( 'Ajax Search Count', 'haru-printspace' ),
            ...
            $this->add_control(
                ...
                [
                    'label' => __( 'Toggle', 'haru-printspace' ),
                    'type' => Controls_Manager::HEADING,
                    'separator' => 'before',
                    'condition' => [
                        'pre_style' => 'full_screen',
            ...
            $this->add_control(
                ...
                [
                    ...
                    'options' => [
                        ...
                        'wider'     => __( 'Wider', 'haru-printspace' ),
                    ],
                    'condition' => [
                        'pre_style' => [ 'classic' ],
                    ],
            ...
            $this->add_control(
                'button_bg_color',
                [
                    'label' => __( 'Button Background Color', 'haru-printspace' ),
                    'type' => Controls_Manager::COLOR,
                    'default' => '',
                    'selectors' => [
            ...
            $this->add_control(
                'button_text_color',
                [
                    'label' => __( 'Button Text Color', 'haru-printspace' ),
                    'type' => Controls_Manager::COLOR,
                    'default' => '',
                    'selectors' => [
            ...
            $this->add_control(
                'form_bg_color',
                [
                    'label' => __( 'Form Background Color', 'haru-printspace' ),
                    'type' => Controls_Manager::COLOR,
                    'default' => '',
                    'selectors' => [
            ...
            $this->add_control(
                'form_border_color',
                [
                    'label' => __( 'Form Border Color', 'haru-printspace' ),
                    'type' => Controls_Manager::COLOR,
                    'default' => '',
                    'selectors' => [
            ...
            $this->add_control(
                'form_text_color',
                [
                    'label' => __( 'Form Text Color', 'haru-printspace' ),
                    'type' => Controls_Manager::COLOR,
                    'default' => '',
                    'selectors' => [
            ...
            $this->add_control(
                ...
                [
                    'label' => __( 'Form Placeholder Color', 'haru-printspace' ),
                    'type' => Controls_Manager::COLOR,
                    'default' => '',
                    'selectors' => [
            ...
            $this->add_control(
                'search_title_color',
                [
                    'label' => __( 'Search Title Color', 'haru-printspace' ),
                    'type' => Controls_Manager::COLOR,
                    'default' => '',
                    'selectors' => [
        ...
        protected function render() {
            ...
            if ( 'yes' == $settings['ajax_search']  ) {
                ...
                $this->add_render_attribute( 'search-form', 'data-hint-message', esc_html__( 'Please type at least 3 characters to search...', 'haru-printspace' ) );
            ...
            $this->add_render_attribute(
                'input', [
                    ...
                    'type' => 'search',
                    'name' => 's',
                    'title' => __( 'Search', 'haru-printspace' ),
                ...
                <div <?php echo $this->get_render_attribute_string( 'search' ); ?>>
                    ...
                    <div class="haru-woo-search__toggle" data-effect="mfp-zoom-in2">
                        <?php if ( $has_icon ) : ?>
                            ...
                            <?php endif; ?>
                        <?php endif; ?>
                        <span class="elementor-screen-only"><?php esc_html_e( 'Search', 'haru-printspace' ); ?></span>
                    ...
                    <form <?php echo $this->get_render_attribute_string( 'search-form' ); ?>>
                        <div class="haru-woo-search__container">
                            <?php if ( 'minimal' === $settings['pre_style'] ) : ?>
                                <button class="haru-woo-search__submit" type="submit" title="<?php esc_attr_e( 'Search', 'haru-printspace' ); ?>" aria-label="<?php esc_attr_e( 'Search', 'haru-printspace' ); ?>">
                                    <?php if ( $has_icon ) : ?>
                                        <?php if ( $is_new || $migrated ) : ?>
                                            <?php Icons_Manager::render_icon( $settings['selected_icon'] ); ?>
                                        <?php else : ?>
                            ...
                            <?php if ( 'classic' === $settings['pre_style'] ) : ?>
                                <button class="haru-woo-search__submit <?php echo ( 'icon' === $settings['button_type'] ) ? 'is-icon' : ''; ?>" type="submit" title="<?php esc_attr_e( 'Search', 'haru-printspace' ); ?>" aria-label="<?php esc_attr_e( 'Search', 'haru-printspace' ); ?>">
                            ...
                            <?php if ( in_array( $settings['pre_style'], array( 'creative', 'flat' ) ) ) : ?>
                                ...
                                <button class="haru-woo-search__submit" type="submit" title="<?php esc_attr_e( 'Search', 'haru-printspace' ); ?>" aria-label="<?php esc_attr_e( 'Search', 'haru-printspace' ); ?>">
                                    ...
                                    <?php endif; ?>
                                    <?php if ( 'flat' === $settings['pre_style'] ) : ?>
                                        <?php if ( $has_icon ) : ?>
                                            <span class="haru-woo-search__icon">
                                                <?php if ( $is_new || $migrated ) : ?>
                                                    <?php Icons_Manager::render_icon( $settings['selected_icon'] ); ?>
