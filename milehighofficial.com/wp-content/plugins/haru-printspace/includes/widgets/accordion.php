...
if ( ! class_exists( 'Haru_PrintSpace_Accordion_Widget' ) ) {
    class Haru_PrintSpace_Accordion_Widget extends Widget_Base {
        ...
        public function get_title() {
            return esc_html__( 'Haru Accordion', 'haru-printspace' );
        }
        ...
        protected function register_controls() {
            ...
            $this->add_control(
                'pre_style',
                [
                    'label' => __( 'Pre Accordion', 'haru-printspace' ),
                    'description'   => __( 'If you choose Pre Accordion you will use Style default from our theme.', 'haru-printspace' ),
                    ...
                    'options' => [
                        ...
                        'style-7'     => __( '- Style 7', 'haru-printspace' ),
                    ]
                ]
            );
            ...
            $repeater->add_control(
                ...
                [
                    ...
                    'default' => __( 'Accordion Title', 'haru-printspace' ),
                    'dynamic' => [
                        'active' => true,
                    ],
                    'label_block' => true,
            ...
            $repeater->add_control(
                ...
                [
                    ...
                    'default' => __( 'Accordion Content', 'haru-printspace' ),
                    'show_label' => false,
                ]
            );
            ...
            $repeater->add_control(
                ...
                [
                    ...
                    'description'   => __( 'This image use for Accordion Style 2 only.', 'haru-printspace' ),
            ...
            $this->add_control(
                'tabs',
                [
                    'label' => __( 'Accordion Items', 'haru-printspace' ),
                    'type' => Controls_Manager::REPEATER,
                    'fields' => $repeater->get_controls(),
                    'default' => [
                        [
                            'tab_title' => __( 'Accordion #1', 'haru-printspace' ),
                            'tab_content' => __( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'haru-printspace' ),
                            'tab_image' => esc_html__( 'Select Image', 'haru-printspace' ),
                        ],
                        [
                            'tab_title' => __( 'Accordion #2', 'haru-printspace' ),
                            'tab_content' => __( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'haru-printspace' ),
                            'tab_image' => esc_html__( 'Select Image', 'haru-printspace' ),
                        ],
                    ],
            ...
            $this->add_control(
                ...
                [
                    'label' => __( 'Active Icon', 'haru-printspace' ),
                    'type' => Controls_Manager::ICONS,
            ...
            $this->add_control(
                'title_html_tag',
                [
                    'label' => __( 'Title HTML Tag', 'haru-printspace' ),
                    'type' => Controls_Manager::SELECT,
                    'options' => [
                        'h1' => 'H1',
                        'h2' => 'H2',
            ...
            $this->add_responsive_control(
                'active_index',
                [
                    'label' => __( 'Active Default', 'haru-printspace' ),
                    'description'   => __( 'Set default active index start from -1 (No active).', 'haru-printspace' ),
            ...
            $this->add_control(
                'faq_schema',
                [
                    'label' => __( 'FAQ Schema', 'haru-printspace' ),
            ...
            $this->add_control(
                ...
                [
                    ...
                    'options' => [
                        'left' => [
                            'title' => __( 'Start', 'haru-printspace' ),
                            'icon' => 'eicon-h-align-left',
                        ],
                        'right' => [
                            'title' => __( 'End', 'haru-printspace' ),
            ...
            $this->add_responsive_control(
                'icon_space',
                [
                    'label' => __( 'Spacing', 'haru-printspace' ),
                    ...
                    foreach ( $settings['tabs'] as $index => $item ) :
                        ...
                        <div class="haru-accordion-item <?php echo ( $index == $settings['active_index'] ) ? 'active' : ''; ?>">
                            <<?php echo Utils::validate_html_tag( $settings['title_html_tag'] ); ?> <?php echo $this->get_render_attribute_string( $tab_title_setting_key ); ?>>
                                ...
                                <?php endif; ?>
                                <a class="haru-accordion-title" href=""><h3 style="margin:0"><?php echo $item['tab_title']; ?></h3></a>
