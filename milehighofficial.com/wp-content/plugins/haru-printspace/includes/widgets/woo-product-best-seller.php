...
if ( ! class_exists( 'Haru_PrintSpace_Woo_Product_Best_Seller_Widget' ) ) {
    class Haru_PrintSpace_Woo_Product_Best_Seller_Widget extends Widget_Base {
        ...
        public function get_title() {
            return esc_html__( 'Haru Woo Product Best Seller', 'haru-printspace' );
        }
        ...
        protected function register_controls() {
            ...
            $this->start_controls_section(
                'section_settings',
                [
                    'label'     => esc_html__( 'Product Best Seller Settings', 'haru-printspace' ),
            ...
            $this->add_control(
                'pre_style',
                [
                    'label' => __( 'Pre Product Best Seller', 'haru-printspace' ),
                    'description'   => __( 'If you choose Product Best Seller you will use Style default from our theme.', 'haru-printspace' ),
