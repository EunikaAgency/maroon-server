...
if ( ! class_exists( 'Haru_PrintSpace_Episode_Category_Widget' ) ) {
    class Haru_PrintSpace_Episode_Category_Widget extends Widget_Base {
        ...
        public function get_title() {
            return esc_html__( 'Haru Episode Category', 'haru-printspace' );
        }
        ...
        protected function register_controls() {
            ...
            $post_types = array();
            $post_types['haru_episode'] = __( 'Episodes', 'haru-printspace' );
            ...
            $this->add_control(
                ...
                [
                    ...
                    'default' => '',
                    'title' => __( 'Widget Title', 'haru-printspace' ),
                ]
            );
            ...
            $this->add_control(
                'episode_style',
                [
                  'label' => __( 'Episode Style', 'haru-printspace' ),
                  'type' => Controls_Manager::SELECT,
                  'default' => 'style-1',
                  'options' => [
            ...
            $this->add_control(
                'episode_padding',
                [
                  'label' => __( 'Episode Padding', 'haru-printspace' ),
                  'type' => Controls_Manager::SELECT,
                  'default' => 'no-padding',
                  'options' => [
            ...
            $this->add_control(
                'episode_filter',
                [
                  'label' => __( 'Episode Filter', 'haru-printspace' ),
                  'type' => Controls_Manager::SELECT,
                  'default' => 'hide',
                  'options' => [
            ...
            $this->add_control(
                'episode_filter_all',
                [
                    'label' => __( 'Episode Filter All', 'haru-printspace' ),
                    'type' => Controls_Manager::SELECT,
                    'default' => 'show',
                    'options' => [
            ...
            $this->add_responsive_control(
                ...
                [
                    'label' => __( 'Episode Filter Align', 'haru-printspace' ),
