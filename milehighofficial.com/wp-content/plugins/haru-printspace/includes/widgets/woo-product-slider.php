...
if ( ! class_exists( 'Haru_PrintSpace_Woo_Product_Slider_Widget' ) ) {
    class Haru_PrintSpace_Woo_Product_Slider_Widget extends Widget_Base {
        ...
        public function get_title() {
            return esc_html__( 'Haru Woo Product Slider', 'haru-printspace' );
        }
        ...
        protected function register_controls() {
            ...
            $this->add_control(
                ...
                [
                  ...
                  'options' => [
                    ...
                    'slick-2'        => __( '- Slick Overflow', 'haru-printspace' ),
                  ]
                ]
            );
            ...
            $this->add_control(
                ...
                [
                    ...
                    'options' => [
                        'center-shadow'     => __( 'Center - Shadow', 'haru-printspace' ),
                        'center-opacity'     => __( 'Center - Opacity', 'haru-printspace' ),
                        'center-border'     => __( 'Center - Border', 'haru-printspace' ),
