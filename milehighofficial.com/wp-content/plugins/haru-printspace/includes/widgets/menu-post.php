...
if ( ! class_exists( 'Haru_PrintSpace_Menu_Post_Widget' ) ) {
	class Haru_PrintSpace_Menu_Post_Widget extends Widget_Base {
		...
		public function get_title() {
			return esc_html__( 'Haru Menu Post', 'haru-printspace' );
		}
		...
		protected function register_controls() {
	        ...
	        $this->add_control(
                ...
                [
                    ...
                    'default' => 'list-small',
                    'options' => [
                        'list-small'     => __( 'List Small', 'haru-printspace' ),
                    ]
                ]
            );
