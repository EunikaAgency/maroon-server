        ...
        <div class="product-order-content">
            ...
            <?php if ( in_array( $settings['layout'], array( 'grid' ) ) && $settings['view_more'] == 'button' ) : ?>
                ...
                <div class="products-ajax-view-more <?php echo esc_attr( $settings['view_more'] == 'button' ? '' : 'hide' ); ?>">
                    <a href="<?php echo esc_url( ( $settings['product_filter_all'] == 'show' || $settings['product_filter'] == 'hide' ) ? get_post_type_archive_link( 'product' ) : $view_more_link ); ?>" class="haru-button haru-button--outline-gray haru-button--size-medium haru-button--round-normal"><?php echo esc_html__( 'View more', 'haru-printspace' ); ?></a>
                </div>
                <?php endif; ?>
            <?php endif; ?>
        </div>
