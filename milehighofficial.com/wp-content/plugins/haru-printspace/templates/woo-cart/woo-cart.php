...
<div class="haru-cart-wrap cart-side <?php echo esc_attr( $settings['show_price'] == 'yes' ) ? 'with-price' : 'no-price'; ?>">
  <div class="haru-cart-opener">
    <a href="<?php echo esc_url( wc_get_cart_url() ); ?>" title="<?php echo esc_attr__( 'Shopping cart', 'haru-printspace' ); ?>">
  ...
  <div class="cart-side-widget">
    <div class="cart-side-header"><?php echo esc_html__( 'Shopping Cart', 'haru-printspace' ); ?>
      <div class="cart-side-close">
        <span class="cart-side-icon"></span>
        <?php echo esc_html__( 'Close', 'haru-printspace' ); ?>
      </div>
    </div>
