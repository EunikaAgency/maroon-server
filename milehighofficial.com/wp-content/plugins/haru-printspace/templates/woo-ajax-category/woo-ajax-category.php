                ...
                <li>
                    <h6 class="tab-item-heading">
                        <a class="filter-item filter-all active"
                            href="javascript:;" 
                            data-category="*"
                        ><?php echo esc_html__( 'All', 'haru-printspace' ); ?></a>
                    </h6>
                </li>
            <?php endif; ?>
    ...
    <div class="product-ajax-content">
        ...
        <div class="product-category-content">
            ...
            <div class="product-list animated fadeIn haru-clear">
                ...
                ?>
                <?php else : ?>
                    <div class="haru-info"><?php echo esc_html__( 'No product found. Please set Product Categories.', 'haru-printspace' ); ?></div>
                <?php endif; ?>
                <?php haru_reset_loop(); ?>
            </div>
            <?php endif; ?>
            ...
            <?php if ( in_array( $settings['layout'], array( 'grid', 'masonry' ) ) && $settings['view_more'] == 'button' ) : ?>
                ...
                <div class="products-ajax-view-more <?php echo esc_attr( $settings['view_more'] == 'button' ? '' : 'hide' ); ?>">
                    <a href="<?php echo esc_url( ( $settings['product_filter_all'] == 'show' || $settings['product_filter'] == 'hide' ) ? get_post_type_archive_link('product') : get_term_link( $terms[0], 'product_cat' ) ); ?>" class="haru-button haru-button--outline-gray haru-button--size-medium haru-button--round-normal"><?php echo esc_html__( 'View more', 'haru-printspace' ); ?></a>
                </div>
                <?php endif; ?>
            <?php endif; ?>
        </div>
