...
if( !class_exists( 'ReduxFramework_datetime' ) ) {
    ...
    class ReduxFramework_datetime extends ReduxFramework {
        ...
        public function enqueue() {
            ...
            wp_enqueue_style( 'datetimepicker', plugins_url( HARU_PRINTSPACE_CORE_NAME . '/assets/lib/datetimepicker/jquery.datetimepicker.css' ), array(), '', 'all' );
            wp_register_script( 'datetimepicker', plugins_url( HARU_PRINTSPACE_CORE_NAME . '/assets/lib/datetimepicker/jquery.datetimepicker.js' ), array( 'jquery' ), '', 'all' );
