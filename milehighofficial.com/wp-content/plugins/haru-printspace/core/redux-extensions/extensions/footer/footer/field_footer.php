    ...
    class ReduxFramework_Footer extends ReduxFramework {
        ...
        public function render() {
            ...
            if ( ! empty( $this->field['options'] ) ) {
                ...
                $placeholder = ( isset( $this->field['placeholder'] ) ) ? esc_attr( $this->field['placeholder'] ) : esc_html__( 'Select an Footer', 'haru-printspace' );
                ...
                echo '<strong>' . esc_html__( 'No Footer were found.', 'haru-printspace' ) . '</strong>';
            }
        } //function
