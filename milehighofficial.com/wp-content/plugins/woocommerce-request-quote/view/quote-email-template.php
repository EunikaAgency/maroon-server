        ...
        <tr>
            <td>
                <table style="border-collapse:collapse;background-color:#fff;min-width:500px;width:600px;max-width:700px;margin:auto;">
                    <thead>
                        <tr>
                            <td style="padding:2rem;color:#fff;background-color:rgba(27,111,88,0.9);background-image:url('https://milehighofficial.com/wp-content/uploads/2025/06/DTG.webp');background-blend-mode:overlay;background-repeat:no-repeat;background-position:center;background-size:cover;text-align:center;">
                                <img src="https://milehighofficial.com/wp-content/uploads/2025/07/2kthreads-white-logo.png" alt="logo" style="display:block;margin:2rem auto;width:200px;filter:invert(1);">
                            </td>
                        </tr>
                    </thead>
