...
if ( class_exists( 'WooCommerce' ) ) {
    ...
    if ( ! function_exists( 'haru_woocommerce_wishlist' ) ) {
        function haru_woocommerce_wishlist(){
            ...
            <a href="<?php echo esc_url( $wishlist_page ); ?>" class="haru-wishlist-link" title="<?php echo esc_attr__( 'Wishlist', 'printspace' ); ?>">
    ...
    if ( is_admin() ) {
        if ( ! function_exists( 'haru_admin_style_attributes_types' ) ) :
            function haru_admin_style_attributes_types( $current ) {
                ...
                $current[ 'color' ] = esc_html__( 'Color', 'printspace' );
                $current[ 'image' ] = esc_html__( 'Image', 'printspace' );
                $current[ 'label' ] = esc_html__( 'Label', 'printspace' );
        ...
        if ( ! function_exists( 'haru_admin_style_attributes_values' ) ) :
            ...
            function haru_admin_style_attributes_values( $attribute_taxonomy, $i ) {
                ...
                if ( in_array( $attribute_taxonomy->attribute_type, array( 'color', 'image', 'label' ) ) ) {
                    ...
                    ?>
                    <select multiple="multiple" data-placeholder="<?php echo esc_attr__( 'Select terms', 'printspace' ); ?>"
                    ...
                    <button class="button plus select_all_attributes"><?php echo esc_html__( 'Select all', 'printspace' ); ?></button>
                    <button class="button minus select_no_attributes"><?php echo esc_html__( 'Select none', 'printspace' ); ?></button>
                    <button class="button fr plus add_new_attribute"><?php echo esc_html__( 'Add new', 'printspace' ); ?></button>
                    <?php
                }
            }
    ...
    if ( ! function_exists( 'haru_wc_color_variation_attribute_options' ) ) :
        ...
        function haru_wc_color_variation_attribute_options( $args = array() ) {
            ...
            $args = wp_parse_args( $args, array(
                ...
                'id'               => '',
                'class'            => '',
                'show_option_none' => esc_html__( 'Choose an option', 'printspace' )
            ) );
    ...
    if ( ! function_exists('haru_button_continue_shopping')) {
        function haru_button_continue_shopping () {
            ...
            ?>
            <a href="<?php echo esc_url($continue_shopping); ?>" class="continue-shopping button"><?php echo esc_html__( 'Continue shopping', 'printspace' ); ?></a>
            <?php
        }
    }
    ...
    if ( ! function_exists('haru_woocommerce_template_single_size_guide') ) {
        function haru_woocommerce_template_single_size_guide() {
            ...
            if ( $haru_product_size_guide ) {
                echo '<div class="product-size-guide"><a href="'. esc_url( $haru_product_size_guide ) .'" data-fancybox="product-guide" data-elementor-open-lightbox="no" class="product-size-guide-link">' . esc_html__( 'Product Guide', 'printspace' ) .'</a></div>';
            }
        }
    ...
    if ( ! function_exists('haru_paging_load_more_product') ) {
        function haru_paging_load_more_product($products) {
            ...
            if (!empty($link)) :
                ?> 
                    <button data-href="<?php echo esc_url($link); ?>" type="button"  data-loading-text="<span class='fa fa-spinner fa-spin'></span> <?php echo esc_html__( 'Loading...','printspace' ); ?>" class="product-load-more">
    ...
    if ( ! function_exists( 'haru_category_menu_output' ) ) {
        function haru_category_menu_output( $is_category, $current_cat_id, $hide_empty ) {
            ...
            $output_cat = '<li' . $all_categories_class . '><a href="' . esc_url ( $page_url ) . '">' . esc_html__( 'All', 'printspace' ) . '</a></li>';
            $output_sub_cat = '';
        ...
        function haru_popup_search_result_callback() {
            ...
            if ( $keyword ) {
                ...
                <ul class="items-list">
                    ...
                    ?>
                        <li class="view-more">
                            <a href="<?php echo esc_url( site_url() ) .'?s=' . $keyword . '&post_type=product'; ?>"><?php echo esc_html__( 'View More', 'printspace' ); ?></a>
                        </li>
                    <?php
                        break; 
                        else :
                ...
                ?>
                    <p class="ajax-not-found"><?php echo esc_html__( 'No products were found matching your selection.', 'printspace' ); ?></p>
                <?php
                endif;
            }
            wp_reset_postdata();
        ...
        function haru_search_product_category_callback() {
            ...
            if ( $keyword ) {
                ...
                <ul class="items-list">
                    ...
                    ?>
                        <li class="view-more">
                            <a href="<?php echo esc_url( site_url() ) .'?s=' . $keyword . '&amp;post_type=product' . $cate_slug; ?>"><?php echo esc_html__( 'View More', 'printspace' ); ?></a>
                        </li>
                    <?php
                        break; 
                        else :
    ...
    if ( ! function_exists( 'haru_woocommerce_empty_cart_button' ) ) {
        function haru_woocommerce_empty_cart_button() {
            echo '<a href="' . esc_url( add_query_arg( 'empty_cart', 'yes' ) ) . '" class="button empty-cart-button" title="' . esc_attr( 'Clear Shopping Cart', 'printspace' ) . '">' . ( wp_is_mobile() ? esc_html__( 'Clear Cart', 'printspace' ) : esc_html__( 'Clear Shopping Cart', 'printspace' ) ) . '</a>';
        }
