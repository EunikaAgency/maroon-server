...
if ( ! function_exists( 'haru_register_sidebar' ) ) {
    function haru_register_sidebar() {
        register_sidebar( 
            array(
                'name'          => esc_html__( 'Sidebar Blog 1', 'printspace' ),
                'id'            => 'sidebar-1',
                'description'   => esc_html__( 'Widget Area 1 for Archive or Single Blog', 'printspace' ),
        ...
        register_sidebar( 
            array(
                'name'          => esc_html__( 'Sidebar Blog 2', 'printspace' ),
                'id'            => 'sidebar-2',
                'description'   => esc_html__( 'Widget Area 2 for Archive or Single Blog', 'printspace' ),
                'before_widget' => '<aside id="%1$s" class="widget %2$s">',
                'after_widget'  => '</aside>',
                'before_title'  => '<h4 class="widget-title"><span>',
                'after_title'   => '</span></h4>',
        ...
        register_sidebar( 
            array(
                ...
                'id'            => 'woocommerce',
                'description'   => esc_html__( 'WooCommerce Sidebar', 'printspace' ),
                'before_widget' => '<aside id="%1$s" class="widget %2$s">',
                'after_widget'  => '</aside>',
                'before_title'  => '<h4 class="widget-title"><span>',
                'after_title'   => '</span></h4>',
        ...
        if ( true == haru_check_core_plugin_status() ) {
            register_sidebar( 
                array(
                    'name'          => esc_html__( 'WooCommerce Filter', 'printspace' ),
                    'id'            => 'woocommerce_filter',
                    'description'   => esc_html__( 'WooCommerce Sidebar Filter', 'printspace' ),
                    'before_widget' => '<aside id="%1$s" class="widget %2$s">',
                    'after_widget'  => '</aside>',
                    'before_title'  => '<h4 class="widget-title"><span>',
                    'after_title'   => '</span></h4>',
