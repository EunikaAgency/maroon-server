...
if ( true == haru_check_core_plugin_status() ) {
	if ( file_exists( WP_PLUGIN_DIR . '/haru-printspace/core/redux-extensions/loader.php') ) {
	    require_once WP_PLUGIN_DIR . '/haru-printspace/core/redux-extensions/loader.php';
	}
}
