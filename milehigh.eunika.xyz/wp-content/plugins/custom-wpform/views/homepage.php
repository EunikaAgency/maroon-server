<?php
    ...
    wp_enqueue_style('homepage', $assets_url . 'css/homepage.css', [], filemtime($assets_path . 'css/homepage.css'));
    wp_enqueue_script('homepage', $assets_url . 'js/homepage.js', ['jquery'], filemtime($assets_path . 'js/homepage.js'), true);
    ...
    <div class="contact-form contact-form--field-title">
        ...
        <?php if ($has_product): ?>
            ...
            <div class="contact-form__row">
                <div class="input-group">
                    <input id="mockupproductname" name="productname" type="text" placeholder=" " required readonly 
        ...
        <div class="contact-form__row">
            <div class="input-group">
                ...
                <label for="mockupbusinessname">Business Name<span class="contact-form__required">*</span></label>
            </div>
        </div>
        ...
        <div class="contact-form__col checkbox-group">
            ...
            <div class="checkbox-container">
                <?php render_radios_mockup('type_of_print', [
        ...
        <?php if (!$has_product): ?>
            <div class="contact-form__row--cv">
                <label class="contact-form__label contact-form__label--block" for="mockupdesignDropzone">
                    Upload your design files and mock ups below<span class="contact-form__required">*</span>
                </label>
