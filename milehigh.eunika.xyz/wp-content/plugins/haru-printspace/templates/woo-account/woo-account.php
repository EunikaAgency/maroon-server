        ...
        <div class="haru-account__content logged-in">
            ...
            <ul class="haru-account__menu">
                ...
                <li class="haru-account__menu-item haru-account__menu-item--greeting">
                    <?php echo esc_html__( 'Howdy ', 'haru-printspace' ); ?>
                    <span class="haru-account__user-name"><?php echo esc_html( $current_user->user_login ); ?></span>
                </li>
                <li class="haru-account__menu-item">
                    <a href="<?php echo esc_url( get_permalink( get_option( 'woocommerce_myaccount_page_id' ) ) ); ?>"><?php echo esc_html__( 'My Account', 'haru-printspace' ); ?></a>
                </li>
                <?php
                    $wishlist = '';
                ...
                ?>
                <li class="haru-account__menu-item">
                    <a href="<?php echo esc_url( get_permalink( get_option( 'yith_wcwl_wishlist_page_id' ) ) ); ?>"><?php echo esc_html__( 'My Wishlist', 'haru-printspace' ); ?></a>
                </li>
                <?php endif; ?>
                <li class="haru-account__menu-item">
                    <a href="<?php echo esc_url( $account ); ?>"><?php echo esc_html__( 'My Orders', 'haru-printspace' ); ?></a>
                </li>
                <li class="haru-account__menu-item">
                    <a href="<?php echo esc_url( wp_logout_url( $logout_url ) ); ?>"><?php echo esc_html__( 'Logout', 'haru-printspace' ); ?></a>
                </li>
            </ul>
        </div>
    <?php else : ?>
        <div class="haru-account__content logged-out">
            ...
            <?php elseif ( in_array( $settings['pre_style'], array( 'style-5' ) ) ) : ?>
                <div class="haru-account__buttons">
                    <a class="haru-button haru-button--text haru-button--outline-black haru-button--outline-thin haru-button--round-normal haru-button-link" role="button" href="<?php echo esc_url( $login_url ); ?>">
                        <span class="haru-button-text"><?php echo $settings['login_text']; ?></span>
                    </a>
                </div>
            <?php endif; ?>
