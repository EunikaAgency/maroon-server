...
if ( $settings['list'] ) : ?>
          ...
          <?php endif; ?>
            <div class="haru-steps__content">
              ...
              <div class="haru-steps__info">
                <p class="haru-steps__title"><?php echo esc_html( $item['list_title'] ); ?></p>
                <div class="haru-steps__description"><?php echo wp_kses_post( $item['list_description'] ); ?></div>
                <?php if ( $item['list_link']['url'] && $item['list_button_text'] ) : ?>
                <div class="haru-steps__btn haru-button haru-button--bg-primary haru-button--size-medium haru-button--round-normal"><?php echo $item['list_button_text']; ?></div>
                <?php endif; ?>
              </div>
            </div>
          <?php if ( $item['list_link']['url'] ) : ?>
  ...
  <?php if ( in_array( $settings['pre_style'], array( 'list-3', 'list-6' ) )  ) : ?>
    <ul class="haru-steps__list">
      <?php
        foreach ( $settings['list'] as $index => $item ) : 
        $target = $item['list_link']['is_external'] ? ' target="_blank"' : '';
        ...
        <li class="haru-steps__item <?php if ( $index == 0 ) echo 'active'; ?>" data-index="<?php echo esc_attr( $index ); ?>">
          ...
          <?php endif; ?>
            <div class="haru-steps__content">
              ...
              <div class="haru-steps__btn haru-button haru-button--text-black haru-button--size-normal"><?php echo $item['list_button_text']; ?>
              <?php endif; ?>
            </div>
          <?php if ( $item['list_link']['url'] ) : ?>
          </a>
  ...
  <?php if ( 'list-5' == $settings['pre_style'] ) : ?>
    <ul class="haru-steps__list">
      <?php
        foreach ( $settings['list'] as $index => $item ) : 
        $target = $item['list_link']['is_external'] ? ' target="_blank"' : '';
