...
var HARUPRINTSPACE = HARUPRINTSPACE || {};

(function ($) {
	// Base functions
    HARUPRINTSPACE.base = {
    	init: function() {
            HARUPRINTSPACE.base.widget_select2_process_new();
            HARUPRINTSPACE.base.elementorAccordion(); // @TODO
        },
        ...
        widget_select2_process_new: function() {
            $(document).on('widget-added', HARUPRINTSPACE.base.widget_select2_new);
            $(document).on('widget-updated', HARUPRINTSPACE.base.widget_select2_new);
            HARUPRINTSPACE.base.widget_select2_new();
        },
    }

    // Document ready
    HARUPRINTSPACE.onReady = {
        init: function () {
            HARUPRINTSPACE.base.init();
        }
    };

    $(document).ready( HARUPRINTSPACE.onReady.init );
})(jQuery);
