...
if ( ! class_exists( 'Haru_PrintSpace_Nav_Menu_Widget' ) ) {
	class Haru_PrintSpace_Nav_Menu_Widget extends Widget_Base {
		...
		public function get_title() {
			return esc_html__( 'Haru Nav Menu', 'haru-printspace' );
		}
	  ...
	  //   	}
		...
		protected function register_controls() {
			...
			$this->start_controls_section(
				'section_settings',
				[
					'label' => __( 'Menu Settings', 'haru-printspace' ),
			...
			if ( ! empty( $menus ) ) {
				$this->add_control(
					'menu',
					[
						'label' => __( 'Menu', 'haru-printspace' ),
						'type' => Controls_Manager::SELECT,
						'options' => $menus,
						'default' => array_keys( $menus )[0],
						'save_default' => true,
						'separator' => 'after',
						'description' => sprintf( __( 'Go to the <a href="%s" target="_blank">Menus screen</a> to manage your menus.', 'haru-printspace' ), admin_url( 'nav-menus.php' ) ),
					]
				);
			} else {
				$this->add_control(
					...
					[
						...
						'raw' => '<strong>' . __( 'There are no menus in your site.', 'haru-printspace' ) . '</strong><br>' . sprintf( __( 'Go to the <a href="%s" target="_blank">Menus screen</a> to create one.', 'haru-printspace' ), admin_url( 'nav-menus.php?action=edit&menu=0' ) ),
						'separator' => 'after',
			...
			$this->add_control(
				...
				[
					...
					'default' => 'horizontal',
					'options' => [
						'horizontal' => __( 'Horizontal', 'haru-printspace' ),
						'vertical' => __( 'Vertical', 'haru-printspace' ),
						// 'dropdown' => __( 'Dropdown', 'haru-printspace' ),
					],
			...
			$this->add_control(
				'align_items',
				[
					'label' => __( 'Align', 'haru-printspace' ),
					...
					'options' => [
						...
						'justify' => [
							'title' => __( 'Stretch', 'haru-printspace' ),
			...
			$this->add_control(
				'pointer',
				[
					'label' 	=> __( 'Pointer', 'haru-printspace' ),
					'type' 		=> Controls_Manager::SELECT,
					'default' 	=> 'none',
					'options' 	=> [
						'none' 			=> __( 'None', 'haru-printspace' ),
						'underline' 	=> __( 'Underline', 'haru-printspace' ),
						'overline' 		=> __( 'Overline', 'haru-printspace' ),
						'double-line' 	=> __( 'Double Line', 'haru-printspace' ),
						'highlight' 	=> __( 'Highlight', 'haru-printspace' ),
					],
					'style_transfer' => true,
					'condition' => [
						'layout!' 	=> 'dropdown',
			...
			$this->add_control(
				'animation_line',
				[
					'label' 	=> __( 'Animation', 'haru-printspace' ),
					'type' 		=> Controls_Manager::SELECT,
					'default' 	=> 'fade',
					'options' 	=> [
						'fade' 		=> 'Fade',
			...
			$this->add_control(
				'indicator',
				[
					'label' 	=> __( 'Submenu Indicator', 'haru-printspace' ),
					'type' 		=> Controls_Manager::SELECT,
					'default' 	=> 'classic',
					'options' 	=> [
						'none' 		=> __( 'None', 'haru-printspace' ),
						'classic' 	=> __( 'Classic', 'haru-printspace' ),
						'chevron' 	=> __( 'Chevron', 'haru-printspace' ),
						'angle' 	=> __( 'Angle', 'haru-printspace' ),
						'plus'	 	=> __( 'Plus', 'haru-printspace' ),
					],
			...
			$this->add_control(
				'indicator_hide',
				[
					'label' 		=> __( 'Hide Level 0 Indicator', 'haru-printspace' ),
			...
			$this->add_control(
				'nav_nowrap',
				[
					'label' 		=> __( 'Nav Nowrap', 'haru-printspace' ),
					'type' 			=> \Elementor\Controls_Manager::SWITCHER,
					'return_value' 	=> 'nowrap',
					'condition' => [
						'layout' => 'horizontal',
			...
			$this->add_control(
				...
				[
					'label' 	=> __( 'Vertical Menu', 'haru-printspace' ),
			...
			$this->add_control(
                'vertical_header',
                [
                    'label' => esc_html__( 'Vertical Header', 'haru-printspace' ),
                    'type' => Controls_Manager::TEXT,
                    'default' => esc_html__( 'Shop By Categories' , 'haru-printspace' ),
                    'label_block' => false,
                    'condition' => [
                        'layout' => 'vertical',
                    ],
            ...
            $this->add_control(
                'vertical_items',
                [
                    'label' => esc_html__( 'Items To Show', 'haru-printspace' ),
            ...
            $this->add_control(
				'vertical_open_text',
				[
					'label' 	=> __( 'View More Text', 'haru-printspace' ),
					'type' => Controls_Manager::TEXT,
			...
			$this->add_control(
				'vertical_close_text',
				[
					'label' 	=> __( 'Close Text', 'haru-printspace' ),
					'type' => Controls_Manager::TEXT,
                    'default' => esc_html__( 'Close' , 'haru-printspace' ),
                    'condition' => [
                        'layout' => 'vertical',
                    ],
				]
            ...
            $this->add_control(
				'vertical_close',
				[
					'label' 		=> __( 'Close On Start', 'haru-printspace' ),
					'type' 			=> \Elementor\Controls_Manager::SWITCHER,
					'default'       => 'no',
                    'return_value'  => 'yes',
                    'condition' => [
			...
			$this->add_responsive_control(
				...
				[
					'label' => __( 'Items List Max Height', 'haru-printspace' ),
			...
			$this->add_control(
				...
				[
					'label' 	=> __( 'Mobile Dropdown', 'haru-printspace' ),
					'type' 		=> Controls_Manager::HEADING,
					'separator' => 'before',
					'condition' => [
						'layout!' => 'dropdown',
			...
			if ( ! empty( $menus ) ) {
				$this->add_control(
					'menu_mobile',
					[
						'label' => __( 'Menu Mobile', 'haru-printspace' ),
						'type' => Controls_Manager::SELECT,
						'options' => $menus,
						'default' => array_keys( $menus )[0],
						'save_default' => true,
			...
			$this->add_control(
				'dropdown',
				[
					'label' 	=> __( 'Breakpoint', 'haru-printspace' ),
					'type' 		=> \Elementor\Controls_Manager::SELECT,
					'default' 	=> 'tablet',
					'options' 	=> [
						/* translators: %d: Breakpoint number. */
						'mobile' 	=> sprintf( __( 'Mobile (< %dpx)', 'haru-printspace' ), $breakpoints['md'] ),
						/* translators: %d: Breakpoint number. */
						'tablet' 	=> sprintf( __( 'Tablet (< %dpx)', 'haru-printspace' ), $breakpoints['lg'] ),
						'none' 		=> __( 'None', 'haru-printspace' ),
					],
			...
			$this->add_control(
				'full_width',
				[
					'label' 		=> __( 'Full Width', 'haru-printspace' ),
					'type' 			=> \Elementor\Controls_Manager::SWITCHER,
					'description' 	=> __( 'Stretch the dropdown of the menu to full width.', 'haru-printspace' ),
			...
			$this->add_control(
				...
				[
					...
					'default' 		=> 'aside',
					'options' 		=> [
						'aside' 	=> __( 'Aside', 'haru-printspace' ),
						'center' 	=> __( 'Center', 'haru-printspace' ),
					],
			...
			$this->add_control(
				'toggle',
				[
					'label' 	=> __( 'Toggle Button', 'haru-printspace' ),
					'type' 		=> \Elementor\Controls_Manager::SELECT,
					'default' 	=> 'burger',
					'options' 	=> [
						'' 			=> __( 'None', 'haru-printspace' ),
						'burger' 	=> __( 'Hamburger', 'haru-printspace' ),
					],
			...
			$this->add_responsive_control(
                'toggle_align',
                [
                    'label' 	=> __( 'Toggle Align', 'haru-printspace' ),
            ...
            $this->add_control(
				...
				[
					'label' 	=> __( 'OnePage Menu', 'haru-printspace' ),
					'type' 		=> Controls_Manager::HEADING,
					'separator' => 'before',
				]
			);
			...
			$this->add_control(
				'is_onepage_menu',
				[
					'label' 		=> __( 'Is OnePage Menu', 'haru-printspace' ),
					'type' 			=> \Elementor\Controls_Manager::SWITCHER,
					'description' => sprintf( __( 'Go to the <a href="%s" target="_blank">OnePage Menu Tutorial</a> to manage your menus.', 'haru-printspace' ), 'https://harutheme.com/forums/topic/how-to-create-navigation-menu-one-page/' ),
					'prefix_class' 	=> 'haru-nav-menu--',
	        ...
	        $this->start_controls_section(
	            ...
	            [
	                'label' => esc_html__( 'Main Menu', 'haru-printspace' ),
			...
			$this->add_control(
				...
				[
					'label' => __( 'Pointer Color', 'haru-printspace' ),
					'type' => Controls_Manager::COLOR,
					'default' => '',
					'selectors' => [
			...
			$this->add_control(
				...
				[
					'label' => __( 'Pointer Color Transparent', 'haru-printspace' ),
					'description' => __( 'Pointer Color when Header Transparent', 'haru-printspace' ),
					'type' => Controls_Manager::COLOR,
					'default' => '',
					'selectors' => [
			...
			$this->add_responsive_control(
				'pointer_width',
				[
					'label' => __( 'Pointer Width', 'haru-printspace' ),
					'devices' => [ 'desktop', 'tablet', 'mobile' ],
					'type' => Controls_Manager::SLIDER,
					'range' => [
						'px' => [
			...
			$this->add_responsive_control(
				'pointer_height',
				[
					'label' => __( 'Pointer Height', 'haru-printspace' ),
					'devices' => [ 'desktop', 'tablet', 'mobile' ],
					'type' => Controls_Manager::SLIDER,
					'range' => [
						'px' => [
			...
			$this->add_responsive_control(
				...
				[
					'label' => __( 'Horizontal Padding', 'haru-printspace' ),
					'type' => Controls_Manager::SLIDER,
					'range' => [
						'px' => [
							'max' => 60,
			...
			$this->add_responsive_control(
				...
				[
					'label' => __( 'Vertical Padding', 'haru-printspace' ),
					'type' => Controls_Manager::SLIDER,
					'range' => [
						'px' => [
							'max' => 60,
			...
			$this->add_responsive_control(
				'menu_space_between',
				[
					'label' => __( 'Space Between', 'haru-printspace' ),
					'type' => Controls_Manager::SLIDER,
					'range' => [
						'px' => [
							'max' => 60,
	        ...
	        $this->start_controls_section(
				...
				[
					'label' => __( 'Dropdown Sub Menu', 'haru-printspace' ),
					'tab' => Controls_Manager::TAB_STYLE,
				]
			);
			...
			$this->add_control(
				'subdown_description',
				[
					'raw' => __( 'On desktop, this will affect the submenu.', 'haru-printspace' ),
					'type' => Controls_Manager::RAW_HTML,
			...
			$this->add_responsive_control(
				...
				[
					'label' => __( 'Border Radius', 'haru-printspace' ),
			...
			$this->add_control(
				...
				[
					'label' => __( 'Divider', 'haru-printspace' ),
					'type' => Controls_Manager::HEADING,
					'separator' => 'before',
				]
			);
			...
			$this->add_control(
				...
				[
					'label' => __( 'Border Width', 'haru-printspace' ),
					'type' => Controls_Manager::SLIDER,
					'range' => [
						'px' => [
							'max' => 50,
			...
			$this->add_responsive_control(
				...
				[
					'label' => __( 'Distance', 'haru-printspace' ),
					'type' => Controls_Manager::SLIDER,
					'range' => [
						'px' => [
							'min' => -100,
	        ...
	        $this->start_controls_section(
				...
				[
					'label' => __( 'Dropdown Mobile', 'haru-printspace' ),
					'tab' => Controls_Manager::TAB_STYLE,
				]
			);
			...
			$this->add_control(
				...
				[
					'raw' => __( 'On desktop, this will affect the submenu. On mobile, this will affect the entire menu.', 'haru-printspace' ),
					'type' => Controls_Manager::RAW_HTML,
					'content_classes' => 'elementor-descriptor',
				]
			);
			...
			$this->add_responsive_control(
				'color_toggle_button',
				[
					'label' => __( 'Toggle Button Color', 'haru-printspace' ),
					'type' => Controls_Manager::COLOR,
					'default' => '',
					'selectors' => [
			...
			$this->add_responsive_control(
				...
				[
					'label' => __( 'Toggle Button Background', 'haru-printspace' ),
					'type' => Controls_Manager::COLOR,
					'default' => '',
					'selectors' => [
			...
			$this->add_responsive_control(
				...
				[
					'label' => __( 'Box Size', 'haru-printspace' ),
					'devices' => [ 'desktop', 'tablet', 'mobile' ],
					'type' => Controls_Manager::SLIDER,
					'range' => [
						'px' => [
		...
		protected function render() {
			if ( ! class_exists( 'Haru_Nav_Menu' ) ) {
                require_once HARU_PRINTSPACE_CORE_DIR . '/includes/classes/class-haru-megamenu-nav.php';
            }
            ...
            if ( 'vertical' === $settings['layout'] ) {
				...
				$this->add_render_attribute( 'menu-header', [
					...
					// 'role' 			=> 'button',
					// 'tabindex' 		=> '0',
					// 'aria-label' 	=> __( 'Menu Header', 'haru-printspace' )
				] );
			}
			...
			$this->add_render_attribute( 'menu-toggle', [
				...
				// 'role' 			=> 'button',
				// 'tabindex' 		=> '0',
				// 'aria-label' 	=> __( 'Menu Toggle', 'haru-printspace' ),
				// 'aria-expanded' => 'false',
			] );
			...
			<div <?php echo $this->get_render_attribute_string( 'menu-toggle' ); ?>>
				...
				<span class="elementor-screen-only"><?php _e( 'Menu', 'haru-printspace' ); ?></span>
			</div>
			<nav class="haru-nav-menu--dropdown haru-nav-menu__container" aria-hidden="true">
				<!-- <div class="haru-nav-menu__title"><?php echo esc_html__( 'Menu', 'haru-printspace' ); ?></div> -->
				<?php echo $dropdown_menu_html; ?>
			</nav>
			<?php endif; ?>
			<?php
