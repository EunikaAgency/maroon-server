...
if ( ! class_exists( 'Haru_PrintSpace_Header_Icon_Box_Widget' ) ) {
    class Haru_PrintSpace_Header_Icon_Box_Widget extends Widget_Base {
        ...
        public function get_title() {
            return esc_html__( 'Haru Header Icon Box', 'haru-printspace' );
        }
        ...
        protected function register_controls() {
            ...
            $this->start_controls_section(
                'section_icon',
                [
                    'label' => __( 'Header Icon Box', 'haru-printspace' ),
                ]
            );
            ...
            $this->add_control(
                'pre_style',
                [
                    'label' => __( 'Pre Header Icon Box', 'haru-printspace' ),
                    'description'   => __( 'If you choose Pre Header Icon Box you will use Style default from our theme.', 'haru-printspace' ),
                    'type' => Controls_Manager::SELECT,
                    'default' => 'style-1',
                    'options' => [
                        'style-1'   => __( 'Pre Header Icon Box 1', 'haru-printspace' ),
                    ]
                ]
            );
