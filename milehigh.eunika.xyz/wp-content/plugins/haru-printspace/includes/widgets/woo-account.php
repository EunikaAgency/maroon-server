...
if ( ! class_exists( 'Haru_PrintSpace_Woo_Account_Widget' ) ) {
    class Haru_PrintSpace_Woo_Account_Widget extends Widget_Base {
        ...
        public function get_title() {
            return esc_html__( 'Haru Woo Account', 'haru-printspace' );
        }
        ...
        protected function register_controls() {
            ...
            $this->start_controls_section(
                'section_settings',
                [
                    'label'     => esc_html__( 'Account Settings', 'haru-printspace' ),
            ...
            $this->add_control(
                'pre_style',
                [
                    'label' => __( 'Pre Account', 'haru-printspace' ),
                    'description'   => __( 'If you choose Pre Account you will use Style default from our theme.', 'haru-printspace' ),
                    'type' => Controls_Manager::SELECT,
                    'default' => 'style-1',
                    'options' => [
                        'style-1'   => __( 'Pre Account 1 (Icon)', 'haru-printspace' ),
                        'style-2'   => __( 'Pre Account 2 (Button Small)', 'haru-printspace' ),
                        'style-3'   => __( 'Pre Account 3 (Button)', 'haru-printspace' ),
                        'style-4'   => __( 'Pre Account 4 (Toolbar)', 'haru-printspace' ),
                        'style-5'   => __( 'Pre Account 5 (Button Login)', 'haru-printspace' ),
                    ]
                ]
            );
            ...
            $this->add_control(
                'account_title',
                [
                    'label' => esc_html__( 'Account Title', 'haru-printspace' ),
                    'type' => Controls_Manager::TEXT,
                    'default' => esc_html__( 'My account' , 'haru-printspace' ),
                    'label_block' => true,
                    'condition' => [
                        'pre_style' => [ 'style-4' ],
                    ],
            ...
            $this->add_control(
                'login_text',
                [
                    'label' => __( 'Login Text', 'haru-printspace' ),
                    'type' => Controls_Manager::TEXT,
                    'default' => __( 'Login', 'haru-printspace' ),
                    'placeholder' => __( 'Login', 'haru-printspace' ),
                    'condition' => [
                        'pre_style' => array( 'style-2', 'style-3', 'style-5' ),
                    ],
                ]
            );
            ...
            //     'logout_text',
            //     [
            //         'label' => __( 'Logout Text', 'haru-printspace' ),
            //         'type' => Controls_Manager::TEXT,
            //         'default' => __( 'Logout', 'haru-printspace' ),
            //         'placeholder' => __( 'Logout', 'haru-printspace' ),
            //     ]
            // );
            ...
            $this->add_control(
                'register_text',
                [
                    'label' => __( 'Register Text', 'haru-printspace' ),
                    'type' => Controls_Manager::TEXT,
                    'default' => __( 'Register', 'haru-printspace' ),
                    'placeholder' => __( 'Register', 'haru-printspace' ),
                    'condition' => [
            ...
            $this->add_control(
                'custom_account',
                [
                    'label'         => __( 'Custom Account', 'haru-printspace' ),
                    'type'          => Controls_Manager::SWITCHER,
                    'description'   => __( 'Enable if want to custom account link.', 'haru-printspace' ),
                    'default'       => 'no',
                    'return_value'  => 'yes',
                    'separator'     => 'before',
                ]
            ...
            $this->add_control(
                'custom_login_page',
                [
                    'label' => __( 'Login Page', 'haru-printspace' ),
            ...
            $this->add_control(
                'custom_logout_page',
                [
                    'label' => __( 'Logout Page', 'haru-printspace' ),
                    'type' => Controls_Manager::SELECT2,
                    'options' => ControlsHelper::get_post_list('page'),
                    'label_block' => true,
                    'post_type' => '',
            ...
            $this->add_control(
                ...
                [
                    'label' => __( 'Register Page', 'haru-printspace' ),
                    'type' => Controls_Manager::SELECT2,
                    'options' => ControlsHelper::get_post_list('page'),
                    'label_block' => true,
                    'post_type' => '',
            ...
            $this->add_control(
                'account_title_color',
                [
                    'label' => __( 'Account Title Color', 'haru-printspace' ),
                    'type' => Controls_Manager::COLOR,
                    'default' => '',
                    'selectors' => [
