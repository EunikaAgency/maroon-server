...
if ( ! class_exists( 'Haru_PrintSpace_Nav_Menu_Template_Widget' ) ) {
	class Haru_PrintSpace_Nav_Menu_Template_Widget extends Widget_Base {
		...
		public function get_title() {
			return esc_html__( 'Haru Nav Menu Template', 'haru-printspace' );
		}
		...
		protected function register_controls() {
			...
			$this->add_control(
				...
				[
					...
					'default' => 'hover',
					'options' => [
						'hover' => __( 'Hover (For Popup)', 'haru-printspace' ),
						'toggle' => __( 'Toggle (For Canvas)', 'haru-printspace' ),
					],
