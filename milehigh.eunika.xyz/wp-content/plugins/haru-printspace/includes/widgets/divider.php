...
if ( ! class_exists( 'Haru_PrintSpace_Divider_Widget' ) ) {
	class Haru_PrintSpace_Divider_Widget extends Widget_Base {
		...
		public function get_title() {
			return esc_html__( 'Haru Divider', 'haru-printspace' );
		}
		...
		protected function register_controls() {
	        ...
	        $this->add_control(
				'pre_style',
				[
					'label' => __( 'Pre Divider', 'haru-printspace' ),
					'description' 	=> __( 'If you choose Pre Divider you will use Style default from our theme.', 'haru-printspace' ),
					'type' => Controls_Manager::SELECT,
					'default' => 'style-1',
					'options' => [
						'style-1' 	=> __( 'Style 1 (Wave Double)', 'haru-printspace' ),
						'style-2' 	=> __( 'Style 2 (Trapezoid)', 'haru-printspace' ),
						'style-3' 	=> __( 'Style 3 (Triangle)', 'haru-printspace' ),
						'style-4' 	=> __( 'Style 4 (Wave Single)', 'haru-printspace' ),
					],
			...
			$this->add_control(
				'wave_color_1',
				[
					'label' => __( 'Wave Color 1', 'haru-printspace' ),
			...
			$this->add_control(
				'wave_color_2',
				[
					'label' => __( 'Wave Color 2', 'haru-printspace' ),
					'type' => Controls_Manager::COLOR,
					'default' => '',
					'condition' => [
                        'pre_style' => [ 'style-1' ],
			...
			$this->add_responsive_control(
				'max_height',
				[
					'label' => esc_html__( 'Max Height', 'haru-printspace' ),
					'type' => Controls_Manager::SLIDER,
					'size_units' => [ 'px', 'vh' ],
					'range' => [
						'px' => [
			...
			$this->add_control(
                'reverse_shape',
                [
                    'label'         => __( 'Reverse Shape', 'haru-printspace' ),
                    'type'          => Controls_Manager::SWITCHER,
                    'description'   => __( 'Enable if you want reverse Shape.', 'haru-printspace' ),
                    'default'       => 'no',
                    'return_value'  => 'yes',
                    'condition' => [
                        'pre_style' => [ 'style-2', 'style-3' ],
