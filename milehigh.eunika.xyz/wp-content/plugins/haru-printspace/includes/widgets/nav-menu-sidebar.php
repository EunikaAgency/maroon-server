...
if ( ! class_exists( 'Haru_PrintSpace_Nav_Menu_Sidebar_Widget' ) ) {
	class Haru_PrintSpace_Nav_Menu_Sidebar_Widget extends Widget_Base {
		...
		public function get_title() {
			return esc_html__( 'Haru Nav Menu Sidebar', 'haru-printspace' );
		}
		...
		protected function register_controls() {
			...
			$this->add_control(
				...
				[
					...
					'default' => 'canvas',
					'options' => [
						'canvas' => __( 'Canvas', 'haru-printspace' ),
					],
			...
			$this->add_responsive_control(
                'sidebar_position',
                [
                    'label' 	=> __( 'Canvas Position', 'haru-printspace' ),
			...
			$this->add_control(
                'menu_content', [
                    'label' => __( 'Menu Content', 'haru-printspace' ),
                    'type' => Controls_Manager::SELECT,
                    'options' => [
                        'menu' => __( 'Menu', 'haru-printspace' ),
                        'template' => __( 'Mega Menu Templates', 'haru-printspace' ),
                    ],
                    'default' => 'menu',
                ]
            );
			...
			$this->add_control(
                'selected_icon',
                [
                    'label' => __( 'Toggle Icon', 'haru-printspace' ),
            ...
            $this->add_control(
                'canvas_dark',
                [
                    'label'         => __( 'Canvas Dark', 'haru-printspace' ),
                    'type'          => Controls_Manager::SWITCHER,
                    'description'   => __( 'Enable if use Canvas background dark.', 'haru-printspace' ),
                    'default'       => 'no',
                    'return_value'  => 'yes',
                ]
            );
	        ...
	        $this->start_controls_section(
				...
				[
					'label' => __( 'Dropdown Menu', 'haru-printspace' ),
					'tab' => Controls_Manager::TAB_STYLE,
				]
			);
