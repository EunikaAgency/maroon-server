...
if ( ! class_exists( 'Haru_PrintSpace_Close_Row_Widget' ) ) {
    class Haru_PrintSpace_Close_Row_Widget extends Widget_Base {
        ...
        public function get_title() {
            return esc_html__( 'Haru Close Row', 'haru-printspace' );
        }
        ...
        protected function register_controls() {
            ...
            $this->start_controls_section(
                'section_settings',
                [
                    'label'     => esc_html__( 'Close Row Settings', 'haru-printspace' ),
            ...
            $this->add_control(
                ...
                [
                    ...
                    'raw' => __( 'Please note this widget use to close Row on the Header. Example: Top Bar.', 'haru-printspace' ),
                    'separator' => 'after',
            ...
            $this->add_control(
                'pre_style',
                [
                    'label' => __( 'Pre Close Row', 'haru-printspace' ),
                    'description'   => __( 'If you choose Pre Close Row you will use Style default from our theme.', 'haru-printspace' ),
                    'type' => Controls_Manager::SELECT,
                    'default' => 'style-1',
                    'options' => [
                        'style-1'   => __( 'Pre Close Row 1', 'haru-printspace' ),
                        'style-2'   => __( 'Pre Close Row 2', 'haru-printspace' ),
                    ]
                ]
            );
            ...
            //     'auto_close',
            //     [
            //         'label'         => esc_html__( 'Auto Close', 'haru-printspace' ),
