...
if ( ! class_exists( 'Haru_PrintSpace_Video_Widget' ) ) {
	class Haru_PrintSpace_Video_Widget extends Widget_Base {
		...
		public function get_title() {
			return esc_html__( 'Haru Video', 'haru-printspace' );
		}
		...
		protected function register_controls() {
			...
			$this->start_controls_section(
	            'section_video',
	            [
	                'label' => esc_html__( 'Video', 'haru-printspace' ),
	        ...
	        $this->add_control(
				'pre_style',
				[
					'label' => __( 'Pre Video', 'haru-printspace' ),
					'description' 	=> __( 'If you choose Pre Video you will use Style default from our theme.', 'haru-printspace' ),
					'type' => Controls_Manager::SELECT,
					'default' => 'default',
					'options' => [
						'default' 		=> __( 'Default', 'haru-printspace' ),
						'button-icon' 	=> __( '- Button Icon', 'haru-printspace' ),
						'button-icon-2' => __( '- Button Icon 2', 'haru-printspace' ),
						'button-icon-3' => __( '- Button Icon 3', 'haru-printspace' ),
						'button-text' 	=> __( '- Button Text', 'haru-printspace' ),
					]
				]
			);
			...
			$this->add_control(
				...
				[
					...
					'placeholder' => esc_html__( 'View video', 'haru-printspace' ),
					'default' => esc_html__( 'View video', 'haru-printspace' ),
					'label_block' => true,
					'condition' => [
	        ...
	        $this->add_control(
				'video_type',
				[
					'label' => esc_html__( 'Source', 'haru-printspace' ),
					'type' => Controls_Manager::SELECT,
					'default' => 'youtube',
					'options' => [
						'youtube' => esc_html__( 'YouTube', 'haru-printspace' ),
						'vimeo' => esc_html__( 'Vimeo', 'haru-printspace' ),
						'dailymotion' => esc_html__( 'Dailymotion', 'haru-printspace' ),
						'hosted' => esc_html__( 'Self Hosted', 'haru-printspace' ),
					],
			...
			$this->add_control(
				...
				[
					...
					'placeholder' => esc_html__( 'Enter your URL', 'haru-printspace' ) . ' (YouTube)',
			...
			$this->add_control(
				...
				[
					...
					'placeholder' => esc_html__( 'Enter your URL', 'haru-printspace' ) . ' (Vimeo)',
			...
			$this->add_control(
				...
				[
					...
					'placeholder' => esc_html__( 'Enter your URL', 'haru-printspace' ) . ' (Dailymotion)',
			...
			$this->add_control(
				'insert_url',
				[
					'label' => esc_html__( 'External URL', 'haru-printspace' ),
			...
			$this->add_control(
				'hosted_url',
				[
					'label' => esc_html__( 'Choose File', 'haru-printspace' ),
			...
			$this->add_control(
				'external_url',
				[
					'label' => esc_html__( 'URL', 'haru-printspace' ),
					...
					'media_type' => 'video',
					'placeholder' => esc_html__( 'Enter your URL', 'haru-printspace' ),
					'condition' => [
						'video_type' => 'hosted',
						'insert_url' => 'yes',
					],
			...
			$this->add_control(
				'start',
				[
					'label' => esc_html__( 'Start Time', 'haru-printspace' ),
					'type' => Controls_Manager::NUMBER,
					'description' => esc_html__( 'Specify a start time (in seconds)', 'haru-printspace' ),
					'frontend_available' => true,
				]
			);
			...
			$this->add_control(
				'end',
				[
					'label' => esc_html__( 'End Time', 'haru-printspace' ),
					'type' => Controls_Manager::NUMBER,
					'description' => esc_html__( 'Specify an end time (in seconds)', 'haru-printspace' ),
					'condition' => [
			...
			$this->add_control(
				'video_options',
				[
					'label' => esc_html__( 'Video Options', 'haru-printspace' ),
			...
			$this->add_control(
				'autoplay',
				[
					'label' => esc_html__( 'Autoplay', 'haru-printspace' ),
					'type' => Controls_Manager::SWITCHER,
					'frontend_available' => true,
					'conditions' => [
						'relation' => 'or',
			...
			$this->add_control(
				'play_on_mobile',
				[
					'label' => esc_html__( 'Play On Mobile', 'haru-printspace' ),
					'type' => Controls_Manager::SWITCHER,
					'condition' => [
						'autoplay' => 'yes',
					],
			...
			$this->add_control(
				'mute',
				[
					'label' => esc_html__( 'Mute', 'haru-printspace' ),
					'type' => Controls_Manager::SWITCHER,
					'frontend_available' => true,
				]
			);
			...
			$this->add_control(
				'loop',
				[
					'label' => esc_html__( 'Loop', 'haru-printspace' ),
					'type' => Controls_Manager::SWITCHER,
					'condition' => [
						'video_type!' => 'dailymotion',
					],
			...
			$this->add_control(
				'controls',
				[
					'label' => esc_html__( 'Player Controls', 'haru-printspace' ),
					'type' => Controls_Manager::SWITCHER,
			...
			$this->add_control(
				'showinfo',
				[
					'label' => esc_html__( 'Video Info', 'haru-printspace' ),
					'type' => Controls_Manager::SWITCHER,
					'label_off' => esc_html__( 'Hide', 'haru-printspace' ),
					'label_on' => esc_html__( 'Show', 'haru-printspace' ),
					'default' => 'yes',
			...
			$this->add_control(
				'modestbranding',
				[
					'label' => esc_html__( 'Modest Branding', 'haru-printspace' ),
					'type' => Controls_Manager::SWITCHER,
					'condition' => [
						'video_type' => [ 'youtube' ],
						'controls' => 'yes',
			...
			$this->add_control(
				'logo',
				[
					'label' => esc_html__( 'Logo', 'haru-printspace' ),
					'type' => Controls_Manager::SWITCHER,
					'label_off' => esc_html__( 'Hide', 'haru-printspace' ),
					'label_on' => esc_html__( 'Show', 'haru-printspace' ),
					'default' => 'yes',
			...
			$this->add_control(
				'yt_privacy',
				[
					'label' => esc_html__( 'Privacy Mode', 'haru-printspace' ),
					'type' => Controls_Manager::SWITCHER,
					'description' => esc_html__( 'When you turn on privacy mode, YouTube won\'t store information about visitors on your website unless they play the video.', 'haru-printspace' ),
					'condition' => [
						'video_type' => 'youtube',
					],
					'frontend_available' => true,
			...
			$this->add_control(
				'lazy_load',
				[
					'label' => esc_html__( 'Lazy Load', 'haru-printspace' ),
					'type' => Controls_Manager::SWITCHER,
					'conditions' => [
						'relation' => 'or',
						'terms' => [
			...
			$this->add_control(
				'rel',
				[
					'label' => esc_html__( 'Suggested Videos', 'haru-printspace' ),
					'type' => Controls_Manager::SELECT,
					'options' => [
						'' => esc_html__( 'Current Video Channel', 'haru-printspace' ),
						'yes' => esc_html__( 'Any Video', 'haru-printspace' ),
					],
					'condition' => [
						'video_type' => 'youtube',
					],
			...
			$this->add_control(
				'vimeo_title',
				[
					'label' => esc_html__( 'Intro Title', 'haru-printspace' ),
					'type' => Controls_Manager::SWITCHER,
					'label_off' => esc_html__( 'Hide', 'haru-printspace' ),
					'label_on' => esc_html__( 'Show', 'haru-printspace' ),
					'default' => 'yes',
			...
			$this->add_control(
				'vimeo_portrait',
				[
					'label' => esc_html__( 'Intro Portrait', 'haru-printspace' ),
					'type' => Controls_Manager::SWITCHER,
					'label_off' => esc_html__( 'Hide', 'haru-printspace' ),
					'label_on' => esc_html__( 'Show', 'haru-printspace' ),
					'default' => 'yes',
			...
			$this->add_control(
				'vimeo_byline',
				[
					'label' => esc_html__( 'Intro Byline', 'haru-printspace' ),
					'type' => Controls_Manager::SWITCHER,
					'label_off' => esc_html__( 'Hide', 'haru-printspace' ),
					'label_on' => esc_html__( 'Show', 'haru-printspace' ),
					'default' => 'yes',
			...
			$this->add_control(
				'color',
				[
					'label' => esc_html__( 'Controls Color', 'haru-printspace' ),
			...
			$this->add_control(
				'download_button',
				[
					'label' => esc_html__( 'Download Button', 'haru-printspace' ),
					'type' => Controls_Manager::SWITCHER,
					'label_off' => esc_html__( 'Hide', 'haru-printspace' ),
					'label_on' => esc_html__( 'Show', 'haru-printspace' ),
					'condition' => [
			...
			$this->add_control(
				'poster',
				[
					'label' => esc_html__( 'Poster', 'haru-printspace' ),
					'type' => Controls_Manager::MEDIA,
					'dynamic' => [
						'active' => true,
					],
			...
			$this->add_control(
				'view',
				[
					'label' => esc_html__( 'View', 'haru-printspace' ),
	        ...
	        $this->start_controls_section(
				...
				[
					'label' => esc_html__( 'Image Overlay', 'haru-printspace' ),
					'condition' => [
						'pre_style' => 'default',
					],
				]
			...
			$this->add_control(
				'show_image_decoration',
				[
					'label' => esc_html__( 'Image Decoration', 'haru-printspace' ),
					'type' => Controls_Manager::SWITCHER,
					'label_off' => esc_html__( 'Hide', 'haru-printspace' ),
					'label_on' => esc_html__( 'Show', 'haru-printspace' ),
					'frontend_available' => true,
			...
			$this->add_control(
				'show_play_icon',
				[
					'label' => esc_html__( 'Play Icon', 'haru-printspace' ),
					'type' => Controls_Manager::SWITCHER,
					'default' => 'yes',
					'condition' => [
						'show_image_overlay' => 'yes',
			...
			$this->add_control(
				'lightbox',
				[
					'label' => esc_html__( 'Lightbox', 'haru-printspace' ),
					'type' => Controls_Manager::SWITCHER,
					'frontend_available' => true,
			...
			$this->add_control(
				'aspect_ratio',
				[
					'label' => esc_html__( 'Aspect Ratio', 'haru-printspace' ),
					'type' => Controls_Manager::SELECT,
					'options' => [
						'169' => '16:9',
						'219' => '21:9',
			...
			$this->add_responsive_control(
				'play_icon_size',
				[
					'label' => esc_html__( 'Size', 'haru-printspace' ),
			...
			$this->add_group_control(
				...
				[
					...
					'fields_options' => [
						'text_shadow_type' => [
							'label' => _x( 'Shadow', 'Text Shadow Control', 'haru-printspace' ),
						],
					],
					'condition' => [
						'show_image_overlay' => 'yes',
			...
			$this->add_control(
				'lightbox_ui_color',
				[
					'label' => esc_html__( 'UI Color', 'haru-printspace' ),
					'type' => Controls_Manager::COLOR,
					'selectors' => [
			...
			$this->add_control(
				...
				[
					'label' => esc_html__( 'UI Hover Color', 'haru-printspace' ),
					'type' => Controls_Manager::COLOR,
					'selectors' => [
			...
			$this->add_control(
				...
				[
					'label' => esc_html__( 'Content Width', 'haru-printspace' ),
					'type' => Controls_Manager::SLIDER,
					'default' => [
						'unit' => '%',
					],
			...
			$this->add_control(
				...
				[
					'label' => esc_html__( 'Content Position', 'haru-printspace' ),
					'type' => Controls_Manager::SELECT,
					'frontend_available' => true,
					'options' => [
						'' => esc_html__( 'Center', 'haru-printspace' ),
						'top' => esc_html__( 'Top', 'haru-printspace' ),
					],
					'selectors' => [
			...
			$this->add_responsive_control(
				...
				[
					'label' => esc_html__( 'Entrance Animation', 'haru-printspace' ),
		...
		protected function render() {
			...
			// Pre style
			if ( in_array( $settings['pre_style'], array( 'button-text', 'button-icon', 'button-icon-2', 'button-icon-3' ) ) ) {
				$settings['lightbox'] = 'yes';
			}

			$this->add_render_attribute( 'video-wrapper', 'class', 'haru-video--' . $settings['pre_style'] );

			if ( in_array( $settings['pre_style'], array( 'default' ) ) ) {
				if ( $settings['show_image_decoration'] ) {
					$this->add_render_attribute( 'video-wrapper', 'class', 'show-image-decor' );
				}
			}
            ...
            <?php endif; ?>
				...
				<div <?php $this->print_render_attribute_string( 'video-wrapper' ); ?>>
					...
					<!--  -->
					<?php if ( in_array( $settings['pre_style'], array( 'button-icon', 'button-icon-2', 'button-icon-3' ) ) ) : ?>
					<div <?php $this->print_render_attribute_string( 'image-overlay' ); ?>>
						...
						<div <?php $this->print_render_attribute_string( 'image-overlay' ); ?>>
							...
							<?php if ( 'yes' === $settings['show_play_icon'] ) : ?>
								...
								<div class="elementor-custom-embed-play" role="button">
									...
									?>
									<span class="elementor-screen-only"><?php echo esc_html__( 'Play Video', 'haru-printspace' ); ?></span>
								</div>
							<?php endif; ?>
						</div>
					<?php } ?>
