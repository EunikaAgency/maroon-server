...
if ( ! class_exists( 'Haru_PrintSpace_Woo_Wishlist_Widget' ) ) {
    class Haru_PrintSpace_Woo_Wishlist_Widget extends Widget_Base {
        ...
        public function get_title() {
            return esc_html__( 'Haru Woo Wishlist', 'haru-printspace' );
        }
        ...
        protected function register_controls() {
            ...
            $this->start_controls_section(
                'section_settings',
                [
                    'label'     => esc_html__( 'Wishlist Settings', 'haru-printspace' ),
            ...
            $this->add_control(
                'pre_style',
                [
                    'label' => __( 'Pre Wishlist', 'haru-printspace' ),
                    'description'   => __( 'If you choose Pre Wishlist you will use Style default from our theme.', 'haru-printspace' ),
                    'type' => Controls_Manager::SELECT,
                    'default' => 'style-1',
                    'options' => [
                        'style-1'   => __( 'Pre Wishlist 1', 'haru-printspace' ),
                        'style-2'   => __( 'Pre Wishlist 2 (Toolbar)', 'haru-printspace' ),
                    ]
                ]
            );
            ...
            $this->add_control(
                'wishlist_title',
                [
                    'label' => esc_html__( 'Wishlist Title', 'haru-printspace' ),
                    'type' => Controls_Manager::TEXT,
                    'default' => esc_html__( 'Wishlist' , 'haru-printspace' ),
                    'label_block' => true,
                    'condition' => [
                        'pre_style' => [ 'style-2' ],
                    ],
            ...
            $this->add_control(
                ...
                [
                    'label' => __( 'Wishlist Title Color', 'haru-printspace' ),
                    'type' => Controls_Manager::COLOR,
                    'default' => '',
                    'selectors' => [
