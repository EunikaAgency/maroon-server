...
if ( ! class_exists( 'Haru_PrintSpace_Search_Widget' ) ) {
    class Haru_PrintSpace_Search_Widget extends Widget_Base {
        ...
        public function get_title() {
            return esc_html__( 'Haru Search Form', 'haru-printspace' );
        }
        ...
        protected function register_controls() {
            ...
            $post_types_search = [
                                    'post'  => __( 'Post', 'haru-printspace' ),
                                    'page' => __( 'Page', 'haru-printspace' ),
                                    'product' => __( 'Product', 'haru-printspace' ),
                                ];

            $this->add_control(
                'post_type',
                [
                    'label' => __( 'Post Type', 'haru-printspace' ),
                    'description'   => __( 'Leave empty if search all Post Types.', 'haru-printspace' ),
                    ...
                    <form <?php echo $this->get_render_attribute_string( 'search-form' ); ?>>
                        <div class="haru-search__container">
                            ...
                            <?php if ( 'classic' === $settings['pre_style'] ) : ?>
                                <button class="haru-search__submit" type="submit" title="<?php esc_attr_e( 'Search', 'haru-printspace' ); ?>" aria-label="<?php esc_attr_e( 'Search', 'haru-printspace' ); ?>">
