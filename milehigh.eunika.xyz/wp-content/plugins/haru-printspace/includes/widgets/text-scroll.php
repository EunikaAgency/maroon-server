...
if ( ! class_exists( 'Haru_PrintSpace_Text_Scroll_Widget' ) ) {
	class Haru_PrintSpace_Text_Scroll_Widget extends Widget_Base {
		...
		public function get_title() {
			return esc_html__( 'Haru Text Scroll', 'haru-printspace' );
		}
		...
		protected function register_controls() {
	        ...
	        $this->add_control(
				'pre_style',
				[
					'label' => __( 'Pre Text Scroll', 'haru-printspace' ),
					'description' 	=> __( 'If you choose Pre Text Scroll you will use Style default from our theme.', 'haru-printspace' ),
					'type' => Controls_Manager::SELECT,
					'default' => 'style-1',
					'options' => [
						'style-1' 	=> __( '- Pre Text Scroll 1', 'haru-printspace' ),
						'style-2' 	=> __( '- Pre Text Scroll 2', 'haru-printspace' ),
						'style-3' 	=> __( 'Pre Text Scroll 3', 'haru-printspace' ),
						'style-4' 	=> __( '- Pre Text Scroll 4 - NFT', 'haru-printspace' ),
					]
				]
			);
			...
			$repeater->add_control(
	            ...
	            [
	                ...
	                'description' 	=> __( 'Use for style use Image (NFT).', 'haru-printspace' ),
