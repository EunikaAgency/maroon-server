...
if ( ! class_exists( 'Haru_PrintSpace_Woo_Product_Top_Rated_Widget' ) ) {
    class Haru_PrintSpace_Woo_Product_Top_Rated_Widget extends Widget_Base {
        ...
        public function get_title() {
            return esc_html__( 'Haru Woo Product Top Rated', 'haru-printspace' );
        }
        ...
        protected function register_controls() {
            ...
            $this->start_controls_section(
                'section_settings',
                [
                    'label'     => esc_html__( 'Product Top Rated Settings', 'haru-printspace' ),
            ...
            $this->add_control(
                'pre_style',
                [
                    'label' => __( 'Pre Product Top Rated', 'haru-printspace' ),
                    'description'   => __( 'If you choose Product Top Rated you will use Style default from our theme.', 'haru-printspace' ),
            ...
            $this->add_control(
                'posts_per_page',
                [
                    'label' => __( 'Products Per Page', 'haru-printspace' ),
            ...
            $this->add_control(
                ...
                [
                    ...
                    'description'   => __( 'Select how to sort retrieved products.', 'haru-printspace' ),
                    'type' => Controls_Manager::SELECT,
                    'default' => 'date',
                    'options' => [
                        'date'          => __( 'Publish Date', 'haru-printspace' ),
                        'id'            => __( 'ID', 'haru-printspace' ),
                        'author'        => __( 'Author', 'haru-printspace' ),
                        'title'         => __( 'Alphabetic', 'haru-printspace' ),
                        'modified'      => __( 'Modified', 'haru-printspace' ),
                        'rand'          => __( 'Random', 'haru-printspace' ),
                        'comment_count' => __( 'Comment Count', 'haru-printspace' ),
                        'menu_order'    => __( 'Menu order', 'haru-printspace' ),
                        'price'         => __( 'Price', 'haru-printspace' )
                    ]
                ]
            );
            ...
            $this->add_control(
                ...
                [
                    ...
                    'description'   => __( 'Select sorting order.', 'haru-printspace' ),
                    'type' => Controls_Manager::SELECT,
                    'default' => 'desc',
                    'options' => [
                        'desc' => esc_html__( 'Descending', 'haru-printspace' ),
                        'asc'  => esc_html__( 'Ascending', 'haru-printspace' )
