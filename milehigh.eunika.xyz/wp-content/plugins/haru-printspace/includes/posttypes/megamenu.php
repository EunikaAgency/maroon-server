...
if ( !class_exists( 'Haru_MegaMenu_Post_Type' ) ) {
    class Haru_MegaMenu_Post_Type {
        ...
        public function haru_megamenu() {
            $labels = array(
                'menu_name'          => esc_html__( 'MegaMenu Builders', 'haru-printspace' ),
                'singular_name'      => esc_html__( 'MegaMenu', 'haru-printspace' ),
                'name'               => esc_html__( 'All MegaMenu', 'haru-printspace' ),
                'add_new'            => esc_html__( 'Add New', 'haru-printspace' ),
                'add_new_item'       => esc_html__( 'Add New MegaMenu', 'haru-printspace' ),
                'edit_item'          => esc_html__( 'Edit MegaMenu', 'haru-printspace' ),
                'new_item'           => esc_html__( 'Add New MegaMenu', 'haru-printspace' ),
                'view_item'          => esc_html__( 'View MegaMenu', 'haru-printspace' ),
                'search_items'       => esc_html__( 'Search MegaMenu', 'haru-printspace' ),
                'not_found'          => esc_html__( 'No MegaMenu items found', 'haru-printspace' ),
                'not_found_in_trash' => esc_html__( 'No MegaMenu items found in trash', 'haru-printspace' ),
                'parent_item_colon'  => ''
            );

            $args = array(
                'labels'                => $labels,
                'description'           => esc_html__( 'Display MegaMenu of site', 'haru-printspace' ),
        ...
        public static function nav_edit_walker() {
            ...
            if ( ! class_exists( $walker ) ) {
                require_once HARU_PRINTSPACE_CORE_DIR . '/includes/classes/class-haru-megamenu.php';
            }
        ...
        ?>
            <p class="field-icon-font description description-wide">   
                <label for="edit-menu-item-icon-font-<?php echo esc_attr( $item_id ); ?>"><?php echo esc_html__( 'Icon Font', 'haru-printspace' ); ?> <br>
                    <input type="text" name="menu-item-haru_icon_font[<?php echo esc_attr( $item_id ); ?>]" value="<?php echo esc_attr( $icon_font ); ?>">
                </label>
                <br>
                <span><?php _e( 'Please click <a href="https://harutheme.com/forums/topic/list-of-font-icons-use-in-each-theme-from-harutheme/" target="_blank"> <b>here</b></a> to see the list of icons.', 'haru-printspace' ); ?></span>
            </p>
            <p class="field-icon-image description description-wide">   
                <label for="edit-menu-item-icon-image-<?php echo esc_attr( $item_id ); ?>"><?php echo esc_html__( 'Icon Image', 'haru-printspace' ); ?></label>
                ...
                <span><?php echo esc_html__( 'If have both Icon Font & Icon Image, Icon Image will be used.', 'haru-printspace' ); ?></span>
            </p>
            ...
            <p class="field-addclass description description-wide">
                <label for="edit-menu-item-haru_mega_profile-<?php echo esc_attr( $item_id ); ?>"> 
                  <?php echo esc_html__( 'Megamenu Builder' ); ?> <br>
                    <select name="menu-item-haru_mega_profile[<?php echo esc_attr( $item_id ); ?>]">
                        <option value=""><?php echo esc_html__( 'Disable', 'haru-printspace' ); ?></option>
                ...
                <a href="<?php echo  esc_url( admin_url( 'edit.php?post_type=haru_megamenu') ); ?>" target="_blank" title="<?php _e( 'Sub Megamenu Management', 'haru-printspace' ); ?>"><?php _e( 'Sub Megamenu Management', 'haru-printspace' ); ?></a><br>
                <span><?php _e( 'If enabled megamenu, its submenu will be disabled.', 'haru-printspace' ); ?></span>
            </p>

            <p class="field-haru_width description description-thin">   
                <label for="edit-menu-item-haru_width-<?php echo esc_attr($item_id); ?>"><?php _e( 'Width (Number of Pixels)', 'haru-printspace' ); ?><br>
            ...
            <?php 
                $full_width = array(
                    ...
                    'container'     => __( 'Container', 'haru-printspace' ),
                    'stretch'       => __( 'Stretch', 'haru-printspace' ),
                ); 
            ?> 
            <p class="field-haru_full_width description description-thin">   
                <label for="edit-menu-item-haru_full_width-<?php echo esc_attr( $item_id ); ?>"><?php _e( 'Fullwidth', 'haru-printspace' ); ?><br>
            ...
            <p class="field-addclass description description-wide">
                <span><?php _e( 'If have both width & Fullwidth, Fullwidth will be used. Please set Fullwidth is None for Vertical Menu.', 'haru-printspace' ); ?></span>
            </p>
        ...
        ?>
            <p class="field-addclass description description-thin">
                <label for="edit-menu-item-haru_text_label-<?php echo esc_attr( $item_id ); ?>"><?php _e( 'Label', 'haru-printspace' ); ?><br />
                    <input type="text" name="menu-item-haru_text_label[<?php echo esc_attr( $item_id ); ?>]" value="<?php echo esc_attr( $text_label ); ?>">
                </label>
            </p>

            <p class="field-addclass description description-thin">
                <label for="edit-menu-item-haru_text_label_color-<?php echo esc_attr($item_id); ?>"><?php _e( 'Label Color', 'haru-printspace' ); ?><br /></label>
        ...
        public static function script() {
            wp_enqueue_media();
            wp_enqueue_script( 'haru-upload-image', HARU_PRINTSPACE_CORE_URL . 'assets/js/upload.js', array( 'jquery', 'wp-pointer' ), Haru_PrintSpace::VERSION, true );
        }
