...
if ( ! function_exists( 'haru_after_comment_form' ) ) {
  function haru_after_comment_form( $post_id ) {
    ...
    cancel_comment_reply_link( esc_html__( 'Cancel Reply', 'haru-printspace' ) );
  }
...
if ( ! function_exists( 'haru_get_cancel_comment_reply_link' ) ) {
  function haru_get_cancel_comment_reply_link( $text ) {
    if ( empty( $text ) ) {
      $text = esc_html__( 'Click here to cancel reply.', 'haru-printspace' );
    }
...
if ( ! function_exists( 'haru_dokan_social_icons' ) ) {
  function haru_dokan_social_icons( $fields ) {
    $fields = [
      'fb' => [
        'icon'  => 'facebook-f',
        'title' => __( 'Facebook', 'haru-printspace' ),
      ],
      'twitter' => [
        'icon'  => 'twitter',
        'title' => __( 'Twitter', 'haru-printspace' ),
      ],
      'pinterest' => [
        'icon'  => 'pinterest-p',
        'title' => __( 'Pinterest', 'haru-printspace' ),
      ],
      'linkedin' => [
        'icon'  => 'linkedin-in',
        'title' => __( 'LinkedIn', 'haru-printspace' ),
      ],
      'youtube' => [
        'icon'  => 'youtube',
        'title' => __( 'Youtube', 'haru-printspace' ),
      ],
      'instagram' => [
        'icon'  => 'instagram',
        'title' => __( 'Instagram', 'haru-printspace' ),
      ],
      'flickr' => [
        'icon'  => 'flickr',
        'title' => __( 'Flickr', 'haru-printspace' ),
      ],
    ];
