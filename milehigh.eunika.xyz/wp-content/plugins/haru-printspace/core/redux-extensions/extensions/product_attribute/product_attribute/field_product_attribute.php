    ...
    class ReduxFramework_product_attribute extends ReduxFramework {
        ...
        public function render() {
            ...
            if ( ! empty( $this->field['options'] ) ) {
                ...
                $placeholder = ( isset( $this->field['placeholder'] ) ) ? esc_attr( $this->field['placeholder'] ) : esc_html__( 'Select an item', 'haru-printspace' );
                ...
                echo '<option value="none">'. esc_html__( 'None', 'haru-printspace' ) .'</option>';
                ...
                echo '<strong>' . esc_html__( 'No items of this type were found.', 'haru-printspace' ) . '</strong>';
            }
        } //function
