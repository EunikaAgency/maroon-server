...
if ( !class_exists( 'ReduxFramework_extension_wbc_importer' ) ) {
    ...
    class ReduxFramework_extension_wbc_importer {
            ...
            if ( isset( $_REQUEST['type'] ) && $_REQUEST['type'] == "import-demo-content" && array_key_exists( $_REQUEST['demo_import_id'], $this->wbc_import_files ) ) {
                ...
                if ( file_exists( $demo_data_loc.'/'.$import_parts['content_file'] ) && is_file( $demo_data_loc.'/'.$import_parts['content_file'] ) ) {
                    ...
                    if ( !isset( $import_parts['imported'] ) || true === $reimporting ) {
                        ...
                        echo esc_html__( "Demo Already Imported", 'haru-printspace' );
                    }
                }
        ...
        function add_importer_section() {
            ...
            $wbc_importer_label = trim( esc_html( apply_filters( 'wbc_importer_label', __( 'Demo Importer', 'haru-printspace' ) ) ) );

            $wbc_importer_label = ( !empty( $wbc_importer_label ) ) ? $wbc_importer_label : __( 'Demo Importer', 'haru-printspace' );
            ...
            $this->parent->sections[] = array(
                ...
                'desc'   => '<p class="description">'. apply_filters( 'wbc_importer_description', esc_html__( 'Works best to import on a new install of WordPress. Please make sure PHP Settings of your Server as suggestion in our document.', 'haru-printspace' ) ).'</p>',
                'icon'   => 'el-icon-website',
                'fields' => array(
                    array(
                        'id'       => 'haru_svg_support',
                        'type'     => 'switch',
                        'title'    => esc_html__( 'SVG Support', 'haru-printspace' ),
                        'subtitle' => esc_html__( 'Allow your site support SVG files', 'haru-printspace' ),
                    ...
                    array(
                        ...
                        'type'  => 'info',
                        'style' => 'critical',
                        'title' => esc_html__( 'Demo Importer Tutorial', 'haru-printspace' ),
                    ...
                    array(
                        ...
                        'type'  => 'info',
                        'style' => 'critical',
                        'title' => esc_html__( 'Import Customize Product (Design Online Product)', 'haru-printspace' ),
                        'icon'  => 'el el-info-circle',
                    ...
                    array(
                        ...
                        'type'  => 'info',
                        'style' => 'critical',
                        'title' => esc_html__( 'Demo Importer Time', 'haru-printspace' ),
                        'icon'  => 'el el-info-circle',
                        'desc'  => esc_html__( 'Demo Importer will take more than 5 minutes, so please patient when import demo data.', 'haru-printspace' ),
                    ),
                    array(
            ...
            $this->parent->sections[] = array(
                'title'      => esc_html__( 'Maintenance Mode', 'haru-printspace' ),
                'desc'       => '',
                'subsection' => false,
                ...
                'fields'     => array(
                    array(
                        ...
                        'type'     => 'button_set',
                        'title'    => esc_html__( 'Maintenance Mode', 'haru-printspace' ),
                        'subtitle' => esc_html__( 'Enable/Disable your site maintenance mode.', 'haru-printspace' ),
                        'desc'     => '',
                        'options'  => array(
                            '1' => 'On',
                            '0' => 'Off',
                    ...
                    array(
                        ...
                        'type'        => 'text',
                        'placeholder' => esc_html__( 'Maintenance Mode', 'haru-printspace' ),
                        'required'    => array( 'enable_maintenance', '=', '1' ),
                        'title'       => esc_html__( 'Maintenance title', 'haru-printspace' ),
                        'subtitle'    => esc_html__( 'Insert coming soon title.', 'haru-printspace' ),
                        'default'     => esc_html__( 'Maintenance Mode', 'haru-printspace' ),
                    ),
                    array(
                        ...
                        'url'      => true,
                        'required' => array( 'enable_maintenance', '=', '1' ),
                        'title'    => esc_html__( 'Maintenance Background', 'haru-printspace' ),
                        'subtitle' => esc_html__( 'Select maintenance background image.', 'haru-printspace' ),
                        'desc'     => '',
                        'default'  => '',
                        'args'     => array()
                    ),
                    array(
                        ...
                        'required'    => array( 'enable_maintenance', '=', '1' ),
                        'title'       => esc_html__( 'Online time', 'haru-printspace' ),
                        'subtitle'    => esc_html__( 'Your page will automatic end maintenance mode after this time.', 'haru-printspace' ),
                    ),
                    ...
                    array(
                        ...
                        'required'    => array( 'enable_maintenance', '=', '1' ),
                        'title'       => esc_html__( 'Timezone', 'haru-printspace' ),
                        'subtitle'    => esc_html__( 'You can change timezone from here. More details: http://php.net/manual/en/timezones.php', 'haru-printspace' ),
                    ...
                    array(
                        ...
                        'type'      => 'multi_text',
                        'required'  => array( 'enable_maintenance', '=', '1' ),
                        'title'     => esc_html__( 'Maintenance social profiles', 'haru-printspace'),
                        'subtitle'  => esc_html__( 'You can change # to your URL and fa fa-facebook to other social class. Please read more in the document.', 'haru-printspace'),
                        'desc' => esc_html__( 'Please insert code with format: <li><a href="#"><i class="fa fa-heart"></i></a></li>', 'haru-printspace'),
        ...
        *************************************************************************/
        ...
        function wbc_extended_example( $demo_active_import , $demo_directory_path ) {
            ...
            *************************************************************************/
            ...
            if ( class_exists( 'RevSlider' ) ) {
                ...
                $wbc_sliders_array = array(
                    ...
                    // 'home8' => 'home-8.zip', // Set slider zip name
                );
            ...
            *************************************************************************/
            ...
            // If it's demo1 - demo6
            $wbc_menu_array = array( 'home1', 'home2', 'home3', 'home4', 'home5', 'home6', 'home7', 'home8' );
