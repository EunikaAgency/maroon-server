	...
	function shoptimizer_header_cart() {
		...
		if ( shoptimizer_is_woocommerce_activated() ) {
			...
			<?php if ( true === $shoptimizer_layout_woocommerce_display_cart ) { ?>
				...
				<ul class="site-header-cart menu d-flex" style="gap: 0.5rem">
						<li class="phone">
							<a href="tel:0485856986">
								<i class="fa fa-phone-alt"></i>
							</a>
						</li> 
					<li class="cart"><?php shoptimizer_cart_link(); ?></li>
				</ul>
					...
					<div class="shoptimizer-sticky-add-to-cart__content">
						...
						<?php } else { ?>
							...
							<a href="<?php echo esc_url( $product->add_to_cart_url() ); ?>" data-quantity="1" 
								data-product_id="<?php echo shoptimizer_safe_html( $id ); ?>" data-product_sku="" class="add_to_cart_button ajax_add_to_cart button" rel="nofollow"><?php echo esc_attr( $product->single_add_to_cart_text() ); ?></a>
