<link rel="stylesheet" href="{{ WCRQ_ASSETS_URL . 'css/wc-form-shipping.css?ver=' . time() }}">
<script src="{{ WCRQ_ASSETS_URL . 'js/wc-form-shipping.js?ver=' . time() }}"></script>
...
<div class="woocommerce-shipping-fields">
  ...
  <div class="shipping-options text-center d-flex justify-content-around align-items-center">
    ...
    <div class="form-group col-md-6">
      <input type="hidden" name="ship_to_different_address" id="ship_to_different_address_input" value="{{ WC()->cart->needs_shipping_address() }}">
    ...
    <div class="form-group col-md-6">
      <input type="hidden" name="store_pickup" id="store_pickup_input" value="{{! WC()->cart->needs_shipping_address() }}">
...
<div class="woocommerce-additional-fields">
    ...
    @if (apply_filters(
        ...
        @if (!WC()->cart->needs_shipping() || wc_ship_to_billing_address_only())
            <h3>@php esc_html_e('Additional information', 'woocommerce'); @endphp</h3>
        @endif
