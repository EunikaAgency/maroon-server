...
jQuery(document).ready(function(){
	...
	jQuery('body').on('change', '#commercekit_inventory_display, #commercekit_ajax_search, #commercekit_ajs_hidevar, #commercekit_waitlist, #commercekit_wishlist, #commercekit_countdown_timer, #commercekit_order_bump, #commercekit_pdp_triggers, #commercekit_pdp_gallery, #commercekit_pdp_lightbox, #commercekit_pdp_attributes_gallery, #commercekit_pdp_video_autoplay, #commercekit_pdp_mobile_optimized, #commercekit_attribute_swatches, #commercekit_attribute_swatches_plp, #commercekit_as_activate_atc, #commercekit_as_logger, #commercekit_as_enable_tooltips, #commercekit_sticky_atc_desktop, #commercekit_sticky_atc_mobile, #commercekit_sticky_atc_tabs, #commercekit_fsn_cart_page, #commercekit_fsn_mini_cart, #commercekit_fsn_before_ship, #commercekit_size_guide, #commercekit_size_guide_search, #commercekit_store_badge', function(){
		if( jQuery(this).prop('checked') )
...
function update_attribute_swatches_options(){
	if( jQuery('#commercekit_attribute_swatches').length > 0 ){
		...
		if( jQuery('#commercekit_attribute_swatches_plp').prop('checked') && jQuery('#commercekit_as_activate_atc').prop('checked') ){
			...
			jQuery('#as-more-opt-txt').hide();
		} else {
			jQuery('#as-quick-atc-txt').hide();
			jQuery('#as-more-opt-txt').show();
		}
	}
}
