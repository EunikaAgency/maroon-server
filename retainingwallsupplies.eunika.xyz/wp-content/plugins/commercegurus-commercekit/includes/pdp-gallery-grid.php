			...
			if ( $attachment_ids && $product->get_image_id() ) {
				...
				foreach ( $attachment_ids as $attachment_id ) {
					...
					if ( isset( $video_gallery[ $attachment_id ] ) && ! empty( $video_gallery[ $attachment_id ] ) ) {
						echo commercegurus_get_product_gallery_video_html( $video_gallery[ $attachment_id ], $pre_load, $pdp_autoplay, $attachment_id ); // phpcs:disable WordPress.XSS.EscapeOutput.OutputNotEscaped
					} else {
						if ( $pre_load ) {
