...
.commercekit-order-bump .ckobp-title { width: 100%; padding-bottom: 15px; font-weight: 600; font-size: 14px; line-height: 1.4; color: #111; }
...
.commercekit-order-bump .ckobp-name { color: #111; font-size: 14px; line-height: 1.4; }
...
function commercekitOrderBumpAdd(product_id, obj){
	...
	fetch( commercekit_ajs.ajax_url + '=commercekit_order_bump_add', {
		...
		var ckobp_actions = obj.closest('.ckobp-actions');
		if( ckobp_actions ){
			var ckobp_added = ckobp_actions.querySelector('.ckobp-added');
			var ckobp_button = ckobp_actions.querySelector('.ckobp-button');
			if( ckobp_added && ckobp_button ){
				ckobp_added.style.display = 'block';
				ckobp_button.style.display = 'none';
			}
		}
...
function commercekit_order_bump_tracking_meta_box() {
	add_meta_box( 'commercekit-order-bump-tracking', esc_html__( 'CommerceKit Order Bump', 'commercegurus-commercekit' ), 'commercekit_order_bump_tracking_meta_box_display', 'shop_order', 'side', 'low' );
}
add_action( 'admin_init', 'commercekit_order_bump_tracking_meta_box' );
