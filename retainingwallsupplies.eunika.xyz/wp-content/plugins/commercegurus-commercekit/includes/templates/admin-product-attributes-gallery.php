						...
						<div class="product-images-container">
							...
							<?php if ( count( $image_ids ) ) { ?>
								<?php foreach ( $image_ids as $image_id ) { ?>
									...
									?>
								<li class="product-image" data-image_id="<?php echo esc_attr( $image_id ); ?>"><img width="<?php echo esc_url( $image[1] ); ?>" height="<?php echo esc_url( $image[2] ); ?>" src="<?php echo esc_url( $image[0] ); ?>" /><ul class="actions"><li><a href="javascript:;" class="cgkit-image-delete"><?php esc_html_e( 'Remove', 'commercegurus-commercekit' ); ?></a></li></ul><span class="dashicons dashicons-video-alt3 cgkit-videomanager <?php echo isset( $commercekit_video_gallery[ $old_slug ][ $image_id ] ) ? 'cgkit-editvideo' : 'cgkit-addvideo'; ?>"></span></li>
								<?php } ?>
							<?php } ?>
				...
				<div id="cgkit-dialog-video">
					<div class="inside cgkit-formgroup">
						<div class="form-group"><br />
							...
							<input id="cgkit-video-input" placeholder="<?php esc_html_e( 'Youtube, Vimeo or video url (.mp4)', 'commercegurus-commercekit' ); ?>" class="cgkit-video form-control" name="cgkit_video_input" value="" data-error="<?php esc_html_e( 'Youtube, Vimeo or video url (.mp4 format only) allowed.', 'commercegurus-commercekit' ); ?>" /><br /><br />
