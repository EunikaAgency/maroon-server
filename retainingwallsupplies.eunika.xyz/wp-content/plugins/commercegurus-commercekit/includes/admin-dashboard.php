	...
	<div class="inside">
		...
		<div class="ckit-features-grid">
			...
			<section <?php echo ( $enable_fsn_cart_page || $enable_fsn_mini_cart ) ? 'class="active"' : ''; ?>>
				...
				<div class="ckit-feature-heading">
					<h3><a href="?page=commercekit&tab=free-shipping-notification"><?php esc_html_e( 'Free Shipping Notification', 'commercegurus-commercekit' ); ?></a> <span class="beta-module">Beta</span></h3>
			...
			<section <?php echo isset( $commercekit_options['store_badge'] ) && 1 === (int) $commercekit_options['store_badge'] ? 'class="active"' : ''; ?>>
				...
				<div class="ckit-feature-heading">
					<h3><a href="?page=commercekit&tab=badge"><?php esc_html_e( 'Product Badges', 'commercegurus-commercekit' ); ?></a> <span class="beta-module">Beta</span></h3>
			...
			<section <?php echo ( $enable_size_guide ) ? 'class="active"' : ''; ?>>
				...
				<div class="ckit-feature-heading">
					<h3><a href="?page=commercekit&tab=size-guide"><?php esc_html_e( 'Size Guides', 'commercegurus-commercekit' ); ?></a> <span class="beta-module">Beta</span></h3>
