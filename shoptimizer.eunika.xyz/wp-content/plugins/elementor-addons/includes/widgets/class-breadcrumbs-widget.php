...
class Breadcrumbs_Widget extends Widget_Base {
    ...
    public function get_title() {
        return __( 'Breadcrumbs', 'ea-addons' );
    }
    ...
    public function get_style_depends() {
        wp_register_style(
            'ea-breadcrumbs-css',
            EA_ADDONS_URL . 'views/breadcrumbs-view/breadcrumbs-view.css',
            [],
            '1.0.2'
        );
    ...
    public function get_script_depends() {
        wp_register_script(
            'ea-breadcrumbs-js',
            EA_ADDONS_URL . 'views/breadcrumbs-view/breadcrumbs-view.js',
            [],
            '1.0.2',
            true
        );
    ...
    protected function render() {
        ...
        include plugin_dir_path(__FILE__) . '../../views/breadcrumbs-view/breadcrumbs-view.php';
    }
