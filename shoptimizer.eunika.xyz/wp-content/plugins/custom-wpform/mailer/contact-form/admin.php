            ...
            <tr>
              ...
              <tr>
                <td class="content">
                  ...
                  <p><strong>Someone just filled out the contact form on your website.</strong></p>

                  <table cellpadding="8" cellspacing="0" border="0" width="100%" style="background: #f9f9f9; border-radius: 8px; margin: 20px 0;">
                    <tr>
                    ...
                    <tr>
                      ...
                      <td><?= nl2br(esc_html($additional_info)); ?></td>
                    </tr>
                  </table>

                  <p>Please review and respond to this inquiry as soon as possible.</p>

                  <p style="font-weight: bold; margin-top: 20px;">– Automated Notification | 2K Threads</p>
                </td>
              </tr>
            <tr>
              <td class="footer">
