...
class CMB2_JS {
	...
	protected static function colorpicker_frontend() {
		...
		wp_localize_script( 'wp-color-picker', 'wpColorPickerL10n', array(
			'clear'         => esc_html__( 'Clear', 'haru-printspace' ),
			'defaultString' => esc_html__( 'Default', 'haru-printspace' ),
			'pick'          => esc_html__( 'Select Color', 'haru-printspace' ),
			'current'       => esc_html__( 'Current Color', 'haru-printspace' ),
		) );
	}
		...
		$l10n = array(
			...
			'defaults'          => array(
				...
				'date_picker'  => array(
					'changeMonth'     => true,
					'changeYear'      => true,
					'dateFormat'      => _x( 'mm/dd/yy', 'Valid formatDate string for jquery-ui datepicker', 'haru-printspace' ),
					'dayNames'        => explode( ',', esc_html__( 'Sunday, Monday, Tuesday, Wednesday, Thursday, Friday, Saturday', 'haru-printspace' ) ),
					'dayNamesMin'     => explode( ',', esc_html__( 'Su, Mo, Tu, We, Th, Fr, Sa', 'haru-printspace' ) ),
					'dayNamesShort'   => explode( ',', esc_html__( 'Sun, Mon, Tue, Wed, Thu, Fri, Sat', 'haru-printspace' ) ),
					'monthNames'      => explode( ',', esc_html__( 'January, February, March, April, May, June, July, August, September, October, November, December', 'haru-printspace' ) ),
					'monthNamesShort' => explode( ',', esc_html__( 'Jan, Feb, Mar, Apr, May, Jun, Jul, Aug, Sep, Oct, Nov, Dec', 'haru-printspace' ) ),
					'nextText'        => esc_html__( 'Next', 'haru-printspace' ),
					'prevText'        => esc_html__( 'Prev', 'haru-printspace' ),
					'currentText'     => esc_html__( 'Today', 'haru-printspace' ),
					'closeText'       => esc_html__( 'Done', 'haru-printspace' ),
					'clearText'       => esc_html__( 'Clear', 'haru-printspace' ),
				),
				'time_picker'  => array(
					'timeOnlyTitle' => esc_html__( 'Choose Time', 'haru-printspace' ),
					'timeText'      => esc_html__( 'Time', 'haru-printspace' ),
					'hourText'      => esc_html__( 'Hour', 'haru-printspace' ),
					'minuteText'    => esc_html__( 'Minute', 'haru-printspace' ),
					'secondText'    => esc_html__( 'Second', 'haru-printspace' ),
					'currentText'   => esc_html__( 'Now', 'haru-printspace' ),
					'closeText'     => esc_html__( 'Done', 'haru-printspace' ),
					'timeFormat'    => _x( 'hh:mm TT', 'Valid formatting string, as per http://trentrichardson.com/examples/timepicker/', 'haru-printspace' ),
					'controlType'   => 'select',
					'stepMinute'    => 5,
				),
			),
			'strings' => array(
				'upload_file'  => esc_html__( 'Use this file', 'haru-printspace' ),
				'upload_files' => esc_html__( 'Use these files', 'haru-printspace' ),
				'remove_image' => esc_html__( 'Remove Image', 'haru-printspace' ),
				'remove_file'  => esc_html__( 'Remove', 'haru-printspace' ),
				'file'         => esc_html__( 'File:', 'haru-printspace' ),
				'download'     => esc_html__( 'Download', 'haru-printspace' ),
				'check_toggle' => esc_html__( 'Select / Deselect All', 'haru-printspace' ),
			),
		);
