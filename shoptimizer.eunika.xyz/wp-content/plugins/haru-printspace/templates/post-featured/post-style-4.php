...
?>
<article class="grid-item post-item post-item--style-4 post-item--hover-<?php echo esc_attr( $settings['hover'] ); ?>">
        ...
        <div class="post-item__content">
        	...
        	<div class="post-item__meta">
                <div class="post-item__meta-author">
                    <span class="post-item__by"><?php echo esc_html__( 'by', 'haru-pricom' ) ?></span>
