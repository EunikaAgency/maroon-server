...
<?php if ( in_array( $settings['pre_style'], array( 'style-2', 'style-12', 'style-32' ) ) ) : ?>
	<?php if ( $settings['link']['url'] ) : ?>
		<a class="" href="<?php echo esc_url( $settings['link']['url'] ); ?>" <?php echo $target . $nofollow; ?>>
	<?php endif; ?>
			<div class="haru-banner__image">
			...
			<div class="haru-banner__content">
				...
				<div class="haru-banner__description"><?php echo $settings['description']; ?></div>
				<?php if ( 'style-12' == $settings['pre_style'] ) : ?>
...
<?php if ( in_array( $settings['pre_style'], array( 'style-11' ) ) ) : ?>
	<?php if ( $settings['link']['url'] ) : ?>
		<a class="" href="<?php echo esc_url( $settings['link']['url'] ); ?>" <?php echo $target . $nofollow; ?>>
	<?php endif; ?>
			<div class="haru-banner__image">
	...
	<?php endif; ?>
			...
			<div class="haru-banner__content">
				...
				<?php if ( $settings['link']['url'] ) : ?>
					...
					<?php else : ?>
						<div class="haru-banner__btn haru-button haru-button--outline haru-button--outline-black haru-button--outline-thin haru-button--round-normal haru-button--size-large haru-button--has-icon"><?php echo $settings['button_text']; ?></div>
					<?php endif; ?>
				<?php endif; ?>
			</div>
	<?php if ( $settings['link']['url'] ) : ?>
			...
			<div class="haru-banner__content">
				<div class="haru-banner__title">
					<div class="haru-banner__title-content">
						<?php echo $settings['title']; ?><span class="haru-banner__sub-title"><?php echo $settings['sub_title']; ?></span>
					</div>
				</div>
			</div>
	<?php if ( $settings['link']['url'] ) : ?>
...
<?php if ( in_array( $settings['pre_style'], array( 'style-5', 'style-19' ) ) ) : ?>
	<div class="haru-banner__image">
	<?php if ( $settings['link']['url'] ) : ?>
		<a class="" href="<?php echo esc_url( $settings['link']['url'] ); ?>" <?php echo $target . $nofollow; ?>>
	<?php endif; ?>
	...
	<div class="haru-banner__content">
		...
		<?php if ( $settings['link']['url'] ) : ?>
			<?php if ( in_array( $settings['pre_style'], array( 'style-5' ) ) ) : ?>
				<a class="haru-banner__btn haru-button haru-button--bg-black haru-button--size-medium haru-button--round-normal" href="<?php echo esc_url( $settings['link']['url'] ); ?>" <?php echo $target . $nofollow; ?>><?php echo $settings['button_text']; ?>
				</a>
			<?php else : ?>
	...
	<?php endif; ?>
			...
			<div class="haru-banner__content">
		    	...
		    	<?php if ( $settings['button_text'] ) : ?>
					<div class="haru-banner__btn haru-button haru-button--text-black haru-button--size-normal"><?php echo $settings['button_text']; ?></div>
				<?php endif; ?>
			</div>
	<?php if ( $settings['link']['url'] ) : ?>
		</a>
...
<?php if ( in_array( $settings['pre_style'], array( 'style-8', 'style-9', 'style-10', 'style-17', 'style-18' ) ) ) : ?>
	<?php if ( $settings['link']['url'] ) : ?>
		<a class="" href="<?php echo esc_url( $settings['link']['url'] ); ?>" <?php echo $target . $nofollow; ?>>
	<?php endif; ?>
			<div class="haru-banner__image">
			...
			<div class="haru-banner__content">
				<?php if ( in_array( $settings['pre_style'], array( 'style-9', 'style-10', 'style-17' ) ) ) : ?>
				<div class="haru-banner__sub-title"><?php echo $settings['sub_title']; ?></div>
				<?php endif; ?>
				...
				<?php if ( $settings['description'] ) : ?>
					<?php if ( !in_array( $settings['pre_style'], array( 'style-17' ) ) ) : ?>
					<div class="haru-banner__description"><?php echo $settings['description']; ?>
			        </div>
			        <?php endif; ?>
		    	<?php endif; ?>
				...
				<?php if ( $settings['link']['url'] ) : ?>
					...
					<?php elseif ( 'style-17' == $settings['pre_style'] ) : ?>
						<div class="haru-banner__btn haru-button haru-button--bg-black haru-button--round-normal haru-button--size-medium"><?php echo $settings['button_text']; ?>
					<?php elseif ( 'style-18' == $settings['pre_style'] ) : ?>
						<div class="haru-button haru-button--bg haru-button--bg-white haru-button--size-medium haru-button--round-normal"><?php echo $settings['button_text']; ?>
					<?php else : ?>
...
<?php if ( in_array( $settings['pre_style'], array( 'style-13', 'style-31' ) ) ) : ?>
	<?php if ( $settings['link']['url'] ) : ?>
		<a class="" href="<?php echo esc_url( $settings['link']['url'] ); ?>" <?php echo $target . $nofollow; ?>>
	<?php endif; ?>
			<div class="haru-banner__image">
...
<?php if ( in_array( $settings['pre_style'], array( 'style-14', 'style-16', 'style-29' ) ) ) : ?>
	<?php if ( $settings['link']['url'] ) : ?>
		<a class="" href="<?php echo esc_url( $settings['link']['url'] ); ?>" <?php echo $target . $nofollow; ?>>
	<?php endif; ?>
			<div class="haru-banner__image">
			...
			<div class="haru-banner__content">
				...
				<div class="haru-banner__description"><?php echo $settings['description']; ?></div>
				<?php if ( $settings['link']['url'] ) : ?>
					<?php if ( 'style-14' == $settings['pre_style'] ) : ?>
						<div class="haru-banner__btn haru-button haru-button--bg-white haru-button--round-normal haru-button--size-medium"><?php echo $settings['button_text']; ?></div>
					<?php else : ?>
						<div class="haru-banner__btn haru-button haru-button--text-black haru-button--size-normal"><?php echo $settings['button_text']; ?></div>
					<?php endif; ?>
				<?php endif; ?>
...
<?php if ( in_array( $settings['pre_style'], array( 'style-15', 'style-23' ) ) ) : ?>
	<?php if ( $settings['link']['url'] ) : ?>
		<a class="" href="<?php echo esc_url( $settings['link']['url'] ); ?>" <?php echo $target . $nofollow; ?>>
	<?php endif; ?>
			<div class="haru-banner__image">
			...
			<?php if ( 'style-15' != $settings['pre_style'] ) : ?>
			<div class="haru-banner__content">
				<h6 class="haru-banner__title"><?php echo $settings['title']; ?></h6>
				<?php if ( $settings['sub_title'] ) : ?>
					<span class="haru-banner__sub-title"><?php echo $settings['sub_title']; ?></span>
...
<?php if ( in_array( $settings['pre_style'], array( 'style-24' ) ) ) : ?>
	<?php if ( $settings['link']['url'] ) : ?>
		<a class="" href="<?php echo esc_url( $settings['link']['url'] ); ?>" <?php echo $target . $nofollow; ?>>
	<?php endif; ?>
			<div class="haru-banner__image">
	...
	<?php endif; ?>
			<div class="haru-banner__wrap">
				<div class="haru-banner__content">
					...
					<?php if ( $settings['link']['url'] ) : ?>
						<?php if ( 'style-27' == $settings['pre_style'] ) : ?>
							<div class="haru-banner__btn haru-button haru-button--text haru-button--text-black haru-button--size-medium"><?php echo $settings['button_text']; ?>
						<?php endif; ?>
					</div>
					<?php endif; ?>
				</div>
...
<?php if ( in_array( $settings['pre_style'], array( 'style-30' ) ) ) : ?>
	<?php if ( $settings['link']['url'] ) : ?>
		<a class="" href="<?php echo esc_url( $settings['link']['url'] ); ?>" <?php echo $target . $nofollow; ?>>
	<?php endif; ?>
			<div class="haru-banner__content">
			...
			<?php if ( $settings['link']['url'] ) : ?>
				<?php if ( 'style-30' == $settings['pre_style'] ) : ?>
					<div class="haru-banner__btn haru-button haru-button--text-black haru-button--size-medium"><?php echo $settings['button_text']; ?></div>
				<?php else : ?>
					<div class="haru-banner__btn haru-button haru-button--text-black haru-button--size-medium"><?php echo $settings['button_text']; ?></div>
				<?php endif; ?>
			<?php endif; ?>
