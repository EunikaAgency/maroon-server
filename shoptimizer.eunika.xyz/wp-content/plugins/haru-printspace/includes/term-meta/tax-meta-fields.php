<?php
	...
	if ( ! function_exists( 'haru_variation_styling' ) ):
		...
		function haru_variation_styling() {
			...
			$fields[ 'color' ] = array(
				array(
					'label' => esc_html__( 'Color', 'haru-printspace' ), // <label>
					'desc'  => esc_html__( 'Choose a color', 'haru-printspace' ), // description
					'id'    => 'product_attribute_color', // name of field
					'type'  => 'color'
				),
				array(
					'label' => esc_html__( 'Is Dual Color?', 'haru-printspace' ), // <label>
					'desc'  => esc_html__( 'Enable Dual Color', 'haru-printspace' ), // description
				...
				array(
					'label' => esc_html__( 'Secondary Color', 'haru-printspace' ), // <label>
					'desc'  => esc_html__( 'Choose a color', 'haru-printspace' ), // description
			...
			$fields[ 'image' ] = array(
				array(
					'label' => esc_html__( 'Image', 'haru-printspace' ), // <label>
					'desc'  => esc_html__( 'Choose a Image', 'haru-printspace' ), // description
			...
			$fields[ 'label' ] = array(
				array(
					'label' => esc_html__( 'Label', 'haru-printspace' ), // <label>
					'desc'  => esc_html__( 'The text of label (should be same as name)', 'haru-printspace' ), // description
