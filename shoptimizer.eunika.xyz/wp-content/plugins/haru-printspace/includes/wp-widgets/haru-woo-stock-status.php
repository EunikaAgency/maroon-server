...
class Haru_Woo_Stock_Status_Widget extends Haru_PrintSpace_Widget {
    ...
    public function __construct() {
        ...
        $this->widget_name        = esc_html__( 'Haru WooCommerce Stock Status', 'haru-printspace' );
        $this->widget_description = esc_html__( 'Widget filter in-stock and on-sale products.', 'haru-printspace' );
        ...
        $this->settings = array(
            'title'         => array(
                'type'  => 'text',
                'std'   => esc_html__( 'Stock status', 'haru-printspace' ),
                'label' => esc_html__( 'Title', 'haru-printspace' )
            ),
            'instock' => array(
                'type'   => 'checkbox',
                'std'    => '1',
                'label'   => esc_html__( 'In Stock filter', 'haru-printspace' ),
            ),
            'outofstock' => array(
                'type'   => 'checkbox',
                'std'    => '1',
                'label'   => esc_html__( 'Out Of Stock filter', 'haru-printspace' ),
            ),
            'onbackorder' => array(
                'type'   => 'checkbox',
                'std'    => '0',
                'label'   => esc_html__( 'On Back Order filter', 'haru-printspace' ),
            ),
            'onsale' => array(
                'type'   => 'checkbox',
                'std'    => '1',
                'label'   => esc_html__( 'On Sale filter', 'haru-printspace' ),
            ),
        );
            ...
            <?php if ( $instance['onsale'] ) : ?>
                <li>
                    <a href="<?php echo esc_url( $this->get_link( 'onsale' ) ); ?>" class="<?php echo in_array( 'onsale', $current_stock_status ) ? 'haru-active' : ''; ?>">
                        <?php esc_html_e( 'On sale', 'haru-printspace' ); ?>
                    </a>
                </li>
            <?php endif; ?>
            ...
            <?php if ( $instance['instock'] ) : ?>
                <li>
                    <a href="<?php echo esc_url( $this->get_link( 'instock' ) ); ?>" class="<?php echo in_array( 'instock', $current_stock_status ) ? 'haru-active' : ''; ?>">
                        <?php esc_html_e( 'In stock', 'haru-printspace' ); ?>
                    </a>
                </li>
            <?php endif; ?>
            ...
            <?php if ( $instance['outofstock'] ) : ?>
                <li>
                    <a href="<?php echo esc_url( $this->get_link( 'outofstock' ) ); ?>" class="<?php echo in_array( 'outofstock', $current_stock_status ) ? 'haru-active' : ''; ?>">
                        <?php esc_html_e( 'Out of stock', 'haru-printspace' ); ?>
                    </a>
                </li>
            <?php endif; ?>
            ...
            <?php if ( $instance['onbackorder'] ) : ?>
                <li>
                    <a href="<?php echo esc_url( $this->get_link( 'onbackorder' ) ); ?>" class="<?php echo in_array( 'onbackorder', $current_stock_status ) ? 'haru-active' : ''; ?>">
                        <?php esc_html_e( 'On back order', 'haru-printspace' ); ?>
                    </a>
                </li>
            <?php endif; ?>
        </ul>
