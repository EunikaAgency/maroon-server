...
class Haru_Woo_Layered_Nav_Widget extends Haru_PrintSpace_Widget {
    ...
    public function __construct() {
        ...
        $this->widget_name        = esc_html__( 'Haru WooCommerce Layered Nav', 'haru-printspace' );
        $this->widget_description = esc_html__( 'Widget display WooCommerce Layered Nav filter.', 'haru-printspace' );
        ...
        $categories_array = array(
            esc_html__( 'All categories', 'haru-printspace' ) => 'all',
        );
        ...
        $this->settings = array(
            'title'         => array(
                'type'  => 'text',
                'std'   => esc_html__( 'Filter by', 'haru-printspace' ),
                'label' => esc_html__( 'Title', 'haru-printspace' )
            ),
            'attribute' => array(
                'type'   => 'dropdown',
                'std'    => '',
                'label'   => esc_html__( 'Attribute', 'haru-printspace' ),
                'options' => $attribute_array,
            ),
            'category' => array(
                'type'    => 'select2',
                'std' => array( 'all' ),
                'label'    => esc_html__( 'Show on category', 'haru-printspace' ),
                'options'  => $categories_array,
            ),
            'query_type' => array(
                'type'   => 'dropdown',
                'std'    => 'and',
                'label'   => esc_html__( 'Query type', 'haru-printspace' ),
                'options' => array(
                    'and' => esc_html__( 'AND', 'haru-printspace' ),
                    'or'  => esc_html__( 'OR', 'haru-printspace' ),
                ),
            ),
            'display'       => array(
                'type'   => 'dropdown',
                'std'    => 'list',
                'label'   => esc_html__( 'Display type', 'haru-printspace' ),
                'options' => array(
                    'list'   => esc_html__( 'List', 'haru-printspace' ),
                    'double' => esc_html__( '2 Columns', 'haru-printspace' ),
                    'list-inline' => esc_html__( 'List Inline', 'haru-printspace' ),
                ),
            ),
            'size' => array(
                'type'   => 'dropdown',
                'std'    => 'normal',
                'label'   => esc_html__( 'Swatches size', 'haru-printspace' ),
                'options' => array(
                    'normal' => esc_html__( 'Normal', 'haru-printspace' ),
                    'large'  => esc_html__( 'Large', 'haru-printspace' ),
                    'small'  => esc_html__( 'Small', 'haru-printspace' ),
                ),
            ),
            'labels' => array(
                'type'   => 'dropdown',
                'std'    => 'on',
                'label'   => esc_html__( 'Show labels', 'haru-printspace' ),
                'options' => array(
                    'on'  => esc_html__( 'ON', 'haru-printspace' ),
                    'off' => esc_html__( 'OFF', 'haru-printspace' ),
                ),
            ),
            'tooltips' => array(
                'type'   => 'dropdown',
                'std'    => 'off',
                'label'   => esc_html__( 'Show tooltips', 'haru-printspace' ),
                'options' => array(
                    'on'  => esc_html__( 'ON', 'haru-printspace' ),
                    'off' => esc_html__( 'OFF', 'haru-printspace' ),
                ),
