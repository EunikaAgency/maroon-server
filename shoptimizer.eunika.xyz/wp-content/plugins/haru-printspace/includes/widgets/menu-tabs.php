...
if ( ! class_exists( 'Haru_PrintSpace_Menu_Tabs_Widget' ) ) {
    class Haru_PrintSpace_Menu_Tabs_Widget extends Widget_Base {
        ...
        public function get_title() {
            return esc_html__( 'Haru Menu Tabs', 'haru-printspace' );
        }
