...
if ( ! class_exists( 'Haru_PrintSpace_Counter_Widget' ) ) {
	class Haru_PrintSpace_Counter_Widget extends Widget_Base {
		...
		public function get_title() {
			return esc_html__( 'Haru Counter', 'haru-printspace' );
		}
		...
		protected function register_controls() {
			...
			$this->add_control(
                'pre_style',
                [
                    'label' => __( 'Pre Counter', 'haru-printspace' ),
                    'description'   => __( 'If you choose Pre Counter you will use Style default from our theme.', 'haru-printspace' ),
                    ...
                    'options' => [
                        ...
                        'style-7'   => __( '- Style 7 - NFT', 'haru-printspace' ),
                    ]
                ]
            );
			...
			$this->add_control(
				'starting_number',
				[
					'label' => __( 'Starting Number', 'haru-printspace' ),
			...
			$this->add_control(
				'ending_number',
				[
					'label' => __( 'Ending Number', 'haru-printspace' ),
					'type' => Controls_Manager::NUMBER,
					'default' => 100,
					'dynamic' => [
						'active' => true,
			...
			$this->add_control(
				'prefix',
				[
					'label' => __( 'Number Prefix', 'haru-printspace' ),
			...
			$this->add_control(
				'suffix',
				[
					'label' => __( 'Number Suffix', 'haru-printspace' ),
					'type' => Controls_Manager::TEXT,
					'dynamic' => [
						'active' => true,
					],
					'default' => '',
					'placeholder' => __( 'Plus', 'haru-printspace' ),
				]
			);
			...
			$this->add_control(
				'duration',
				[
					'label' => __( 'Animation Duration', 'haru-printspace' ),
					'type' => Controls_Manager::NUMBER,
					'default' => 2000,
					'min' => 100,
					'step' => 100,
			...
			$this->add_control(
				'thousand_separator',
				[
					'label' => __( 'Thousand Separator', 'haru-printspace' ),
			...
			$this->add_control(
				...
				[
					'label' => __( 'Separator', 'haru-printspace' ),
					'type' => Controls_Manager::SELECT,
					'condition' => [
			...
			$this->add_control(
				...
				[
					...
					'default' => __( 'Cool Number', 'haru-printspace' ),
					'placeholder' => __( 'Cool Number', 'haru-printspace' ),
				]
			);
			...
			$this->add_control(
				...
				[
					...
					'default' => __( 'Description', 'haru-printspace' ),
					'placeholder' => __( 'Description', 'haru-printspace' ),
					'condition' => [
						'pre_style' => [ 'style-3' ],
					],
				]
			...
			$this->add_responsive_control(
                ...
                [
					...
					'selectors' => [
						...
						'{{WRAPPER}} .haru-counter--style-7 .gr-counter' => '{{VALUE}}',
					]
                ]
            );
            ...
            $this->add_control(
                'disable_appear',
                [
                    'label'         => __( 'Disable Appear', 'haru-printspace' ),
                    'type'          => Controls_Manager::SWITCHER,
                    'description'   => __( 'Disable start Counter when appear.', 'haru-printspace' ),
                    'default'       => 'no',
                    'return_value'  => 'yes',
                ]
            );
