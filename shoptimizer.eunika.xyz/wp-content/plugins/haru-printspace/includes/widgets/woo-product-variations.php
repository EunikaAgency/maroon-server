...
if ( ! class_exists( 'Haru_PrintSpace_Woo_Product_Variations_Widget' ) ) {
    class Haru_PrintSpace_Woo_Product_Variations_Widget extends Widget_Base {
        ...
        public function get_title() {
            return esc_html__( 'Haru Woo Product Variations', 'haru-printspace' );
        }
        ...
        protected function register_controls() {
            ...
            $this->add_control(
                ...
                [
                    ...
                    'default' => __( 'Print Your Own', 'haru-printspace' ),
                    'condition' => [
                        'layout' => 'popup',
                    ],
                ]
            ...
            $this->add_control(
                'button_style',
                [
                    'label' => __( 'Button Style', 'haru-printspace' ),
                    'type' => Controls_Manager::SELECT,
                    'default' => 'style-1',
                    'options' => [
                        'style-1' => __( 'Style 1 (Primary Color - Medium)', 'haru-printspace' ),
                        'style-2' => __( 'Style 2 (Black Color - Medium)', 'haru-printspace' ),
                        'style-3' => __( 'Style 3 (Outline - Medium)', 'haru-printspace' ),
                        'style-4' => __( 'Style 4 (Text - Black)', 'haru-printspace' ),
                    ],
                    'condition' => [
                        'layout' => 'popup',
                    ],
            ...
            $this->add_control(
                'button_shadow',
                [
                    'label'         => __( 'Button Shadow', 'haru-printspace' ),
            ...
            $this->add_control(
                'product_id',
                [
                    'label' => __( 'Search & Select Product', 'haru-printspace' ),
        ...
        protected function render() {
            ...
            <?php if ( Plugin::$instance->editor->is_edit_mode() || Plugin::$instance->preview->is_preview_mode() ) : ?>
                <div class="haru-notice"><?php echo sprintf( __( 'Please read to the <strong><a href="%s" target="_blank">Print Your Own Tutorial</a></strong> to create this feature.', 'haru-printspace' ), 'https://harutheme.com/forums/topic/how-to-build-print-your-own-feature-in-woocommerce/' ); ?></div>
            <?php endif; ?>
