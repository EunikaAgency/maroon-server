...
if ( ! class_exists( 'Haru_PrintSpace_Image_Blob_Widget' ) ) {
	class Haru_PrintSpace_Image_Blob_Widget extends Widget_Base {
		...
		public function get_title() {
			return esc_html__( 'Haru Image Blob', 'haru-printspace' );
		}
		...
		protected function register_controls() {
	        ...
	        $this->add_control(
				'pre_style',
				[
					'label' => __( 'Pre Image Blob', 'haru-printspace' ),
					'description' 	=> __( 'If you choose Pre Image Blob you will use Style default from our theme.', 'haru-printspace' ),
