...
if ( ! class_exists( 'Haru_PrintSpace_Google_Maps_Widget' ) ) {
    class Haru_PrintSpace_Google_Maps_Widget extends Widget_Base {
        ...
        public function get_title() {
            return esc_html__( 'Haru Google Maps', 'haru-printspace' );
        }
        ...
        protected function register_controls() {
            ...
            $this->start_controls_section(
                'section_settings',
                [
                    'label'     => esc_html__( 'Google Maps Settings', 'haru-printspace' ),
                ...
                if ( ! $api_key ) {
                    $this->add_control(
                        ...
                        [
                            ...
                            'raw' => sprintf(
                                __( 'Set your Google Maps API Key in Elementor\'s <a href="%1$s" target="_blank">Integrations Settings</a> page. Create your key <a href="%2$s" target="_blank">here.', 'haru-printspace' ),
            ...
            $this->add_control(
                'pre_style',
                [
                    'label' => __( 'Pre Google Maps', 'haru-printspace' ),
                    'description'   => __( 'If you choose Pre Google Maps you will use Style default from our theme.', 'haru-printspace' ),
                    'type' => Controls_Manager::SELECT,
                    'default' => 'none',
                    'options' => [
                        'none'   => __( 'None (Default)', 'haru-printspace' ),
                        'style-1'   => __( 'Pre Google Maps 1 (Filter Gray)', 'haru-printspace' ),
                        'style-2'   => __( 'Pre Google Maps 2 (Filter Pink)', 'haru-printspace' ),
                        'style-3'   => __( 'Pre Google Maps 3 (Filter Dark)', 'haru-printspace' ),
                    ]
                ]
            );

            $default_address = __( 'London Eye, London, United Kingdom', 'haru-printspace' );
            $this->add_control(
                'address',
                [
                    'label' => __( 'Location', 'haru-printspace' ),
            ...
            $this->add_responsive_control(
                'height',
                [
                    'label' => __( 'Height', 'haru-printspace' ),
                    'type' => Controls_Manager::SLIDER,
                    'range' => [
                        'px' => [
                            'min' => 40,
            ...
            $this->add_control(
                'hover_transition',
                [
                    'label' => __( 'Transition Duration', 'haru-printspace' ),
                    'type' => Controls_Manager::SLIDER,
                    'range' => [
                        'px' => [
                            'max' => 3,
