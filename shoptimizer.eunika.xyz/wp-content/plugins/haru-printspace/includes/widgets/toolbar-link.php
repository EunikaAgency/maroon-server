...
if ( ! class_exists( 'Haru_PrintSpace_Toolbar_Link_Widget' ) ) {
    class Haru_PrintSpace_Toolbar_Link_Widget extends Widget_Base {
        ...
        public function get_title() {
            return esc_html__( 'Haru Toolbar Link', 'haru-printspace' );
        }
        ...
        protected function register_controls() {
            ...
            $this->start_controls_section(
                'section_icon',
                [
                    'label' => __( 'Toolbar Link', 'haru-printspace' ),
                ]
            );
            ...
            $this->add_control(
                'pre_style',
                [
                    'label' => __( 'Pre Toolbar Link', 'haru-printspace' ),
                    'description'   => __( 'If you choose Pre Toolbar Link you will use Style default from our theme.', 'haru-printspace' ),
                    'type' => Controls_Manager::SELECT,
                    'default' => 'style-1',
                    'options' => [
                        'style-1'   => __( 'Pre Toolbar Link 1', 'haru-printspace' ),
                    ]
                ]
            );
            ...
            $this->add_control(
                'link_title',
                [
                    'label' => esc_html__( 'Link Title', 'haru-printspace' ),
                    'type' => Controls_Manager::TEXT,
                    'default' => esc_html__( 'Home' , 'haru-printspace' ),
                    'label_block' => true,
                ]
            );
