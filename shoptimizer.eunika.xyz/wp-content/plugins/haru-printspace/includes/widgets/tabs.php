...
if ( ! class_exists( 'Haru_PrintSpace_Tabs_Widget' ) ) {
    class Haru_PrintSpace_Tabs_Widget extends Widget_Base {
        ...
        public function get_title() {
            return esc_html__( 'Haru Tabs', 'haru-printspace' );
        }
        ...
        protected function register_controls() {
            ...
            $this->start_controls_section(
                'settings_section',
                [
                    'label' => esc_html__( 'General Settings', 'haru-printspace'  ),
                ]
            );
            ...
            $this->add_control(
                'layout',
                [
                    'label' => esc_html__( 'Layout', 'haru-printspace' ),
                    'type' => Controls_Manager::SELECT,
                    'default' => 'horizontal',
                    'label_block' => false,
                    'options' => [
                        'horizontal' => esc_html__( 'Horizontal', 'haru-printspace' ),
                        'horizontal-2' => esc_html__( 'Horizontal 2', 'haru-printspace' ),
                        'vertical' => esc_html__( 'Vertical', 'haru-printspace' ),
                    ],
                ]
            );
            ...
            $this->add_control(
                'icon_show',
                [
                    'label' => esc_html__( 'Enable Icon', 'haru-printspace' ),
            ...
            $this->add_control(
                'icon_position',
                [
                    'label' => esc_html__( 'Icon Position', 'haru-printspace' ),
                    'type' => Controls_Manager::SELECT,
                    'default' => 'inline-icon',
                    'label_block' => false,
                    'options' => [
                        'top-icon' => esc_html__( 'Stacked', 'haru-printspace' ),
                        'inline-icon' => esc_html__( 'Inline', 'haru-printspace' ),
                    ],
                    'condition' => [
                        'icon_show' => 'yes',
                    ],
            ...
            $this->add_control(
                'pre_style',
                [
                    'label' => __( 'Pre Tab', 'haru-printspace' ),
                    'description'   => __( 'If you choose Pre Tab you will use Style default from our theme.', 'haru-printspace' ),
                    'type' => Controls_Manager::SELECT,
                    'default' => 'style-1',
                    'options' => [
                        'style-1'   => __( 'Pre Tab 1 (Classic)', 'haru-printspace' ),
                        'style-2'   => __( 'Pre Tab 2 (Shadow)', 'haru-printspace' ),
                        'style-3'   => __( '- Pre Tab 3 (Tag List)', 'haru-printspace' ),
                    ]
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .haru-tab__nav ul' => '{{VALUE}}',
                    ],
                    'condition' => [
                        'pre_style' => array( 'style-3' ),
                    ],
                ]
            );
            ...
            $this->add_control(
                'hover_action',
                [
                    'label' => __( 'Hover Action', 'haru-printspace' ),
                    'type' => Controls_Manager::SWITCHER,
            ...
            $repeater->add_control(
                'list_show_as_default', [
                    'label' => __( 'Set as Default', 'haru-printspace' ),
                    'type' => Controls_Manager::SWITCHER,
                    'default' => 'inactive',
            ...
            $repeater->add_control(
                'list_icon_type', [
                    ...
                    'options' => [
                        'none' => [
                            'title' => esc_html__( 'None', 'haru-printspace' ),
                            'icon' => 'fas fa-ban',
                        ],
                        'icon' => [
                            'title' => esc_html__( 'Icon', 'haru-printspace' ),
                            'icon' => 'fas fa-cog',
                        ],
                        'image' => [
                            'title' => esc_html__( 'Image', 'haru-printspace' ),
                            'icon' => 'fas fa-image',
                        ],
                    ],
                    'default' => 'icon',
            ...
            $repeater->add_control(
                'list_title_image', [
                    'label' => esc_html__( 'Image', 'haru-printspace' ),
            ...
            $repeater->add_control(
                'list_tab_content', [
                    'label' => esc_html__( 'Tab Content', 'haru-printspace' ),
                    'type' => Controls_Manager::WYSIWYG,
                    'default' => esc_html__( 'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Optio, neque qui velit. Magni dolorum quidem ipsam eligendi, totam, facilis laudantium cum accusamus ullam voluptatibus commodi numquam, error, est. Ea, consequatur.', 'haru-printspace' ),
                    'dynamic' => [ 'active' => true ],
                    'condition' => [
            ...
            $this->add_control(
                'list',
                [
                    'label' => esc_html__( 'Tab List', 'haru-printspace' ),
                    'type' => Controls_Manager::REPEATER,
                    'fields' => $repeater->get_controls(),
                    'default' => [
                        [
                            'list_title' => esc_html__( 'Tab Title 1', 'haru-printspace' ),
                            ...
                            'list_text_type' => 'content',
                            'list_primary_templates' => '',
                            'list_tab_content' => esc_html__( 'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Optio, neque qui velit. Magni dolorum quidem ipsam eligendi, totam, facilis laudantium cum accusamus ullam voluptatibus commodi numquam, error, est. Ea, consequatur.', 'haru-printspace' ),
                        ],
                        [
                            'list_title' => esc_html__( 'Tab Title 2', 'haru-printspace' ),
                            'list_show_as_default' => 'inactive',
                            'list_icon_type' => 'icon',
                            'list_title_icon' => '',
                            'list_title_image' => '',
