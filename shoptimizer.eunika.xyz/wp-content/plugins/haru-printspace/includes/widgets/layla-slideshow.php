...
if ( ! class_exists( 'Haru_PrintSpace_Layla_Slideshow_Widget' ) ) {
    class Haru_PrintSpace_Layla_Slideshow_Widget extends Widget_Base {
        ...
        public function get_title() {
            return esc_html__( 'Haru Layla Slideshow', 'haru-printspace' );
        }
        ...
        protected function register_controls() {
            ...
            $this->add_control(
                ...
                [
                  ...
                  'options' => [
                    ...
                    'fullscreen'    => esc_html__( 'Fullscreen', 'haru-printspace' ),
                  ]
                ]
            );
            ...
            $this->add_control(
                'source_type',
                [
                    'label' => esc_html__( 'Source Type', 'haru-printspace' ),
                    'type' => Controls_Manager::SELECT,
                    'default' => 'haru_video',
                    'options' => [
                        'haru_video' => esc_html__( 'Videos', 'haru-printspace' ),
                        'all_post_types'  => esc_html__( 'All Posts', 'haru-printspace' ),
                        'gallery' => esc_html__( 'Gallery', 'haru-printspace' ),
                        'videos' => esc_html__( 'Custom Videos', 'haru-printspace' )
                    ],
                ]
            );
            ...
            $this->add_control(
                'counter_label',
                [
                    'label' => __( 'Counter Label', 'haru-printspace' ),
                    'type' => Controls_Manager::TEXT,
