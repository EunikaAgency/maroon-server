...
if ( ! class_exists( 'Haru_PrintSpace_Icon_Box_Widget' ) ) {
    class Haru_PrintSpace_Icon_Box_Widget extends Widget_Base {
        ...
        public function get_title() {
            return esc_html__( 'Haru Icon Box', 'haru-printspace' );
        }
        ...
        protected function register_controls() {
            ...
            $this->start_controls_section(
                'section_icon',
                [
                    'label' => __( 'Icon Box', 'haru-printspace' ),
                ]
            );
            ...
            $this->add_control(
                'pre_style',
                [
                    'label' => __( 'Pre Icon Box', 'haru-printspace' ),
                    'description'   => __( 'If you choose Pre Icon Box you will use Style default from our theme.', 'haru-printspace' ),
                    'type' => Controls_Manager::SELECT,
                    'default' => 'style-1',
                    'options' => [
                        'style-1'   => __( 'Pre Icon Box 1', 'haru-printspace' ),
                        'style-2'   => __( 'Pre Icon Box 2', 'haru-printspace' ),
                        'style-3'   => __( '- Pre Icon Box 3', 'haru-printspace' ),
                        'style-4'   => __( '- Pre Icon Box 4', 'haru-printspace' ),
                        'style-5'   => __( '- Pre Icon Box 5', 'haru-printspace' ),
                        'style-6'   => __( '- Pre Icon Box 6', 'haru-printspace' ),
                        'style-7'   => __( '- Pre Icon Box 7', 'haru-printspace' ),
                        'style-8'   => __( '- Pre Icon Box 8', 'haru-printspace' ),
                        'style-9'   => __( '- Pre Icon Box 9', 'haru-printspace' ),
                        'style-10'   => __( '- Pre Icon Box 10 - Image', 'haru-printspace' ),
                        'style-11'   => __( '- Pre Icon Box 11', 'haru-printspace' ),
                        'style-12'   => __( 'Pre Icon Box Landing', 'haru-printspace' ),
                        'style-13'   => __( '- Pre Icon Box 13', 'haru-printspace' ),
                        'style-14'   => __( 'Pre Icon Box 14 - Menu', 'haru-printspace' ),
                        'style-15'   => __( '- Pre Icon Box 15', 'haru-printspace' ),
                        'style-16'   => __( '- Pre Icon Box 16', 'haru-printspace' ),
                        'style-17'   => __( '- Pre Icon Box 17', 'haru-printspace' ),
                        'style-18'   => __( '- Pre Icon Box 18 - Image', 'haru-printspace' ),
                        'style-19'   => __( '- Pre Icon Box 19', 'haru-printspace' ),
                        'style-20'   => __( '- Pre Icon Box 20', 'haru-printspace' ),
                        'style-21'   => __( '- Pre Icon Box 21 - NFT', 'haru-printspace' ),
                    ]
                ]
            );
            ...
            $this->add_control(
                'title_text',
                [
                    'label' => __( 'Title & Description', 'haru-printspace' ),
                    'type' => Controls_Manager::TEXT,
                    'dynamic' => [
                        'active' => true,
                    ],
                    'default' => __( 'This is the heading', 'haru-printspace' ),
            ...
            $this->add_control(
                ...
                [
                    ...
                    'default' => __( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'haru-printspace' ),
            ...
            $this->add_control(
                ...
                [
                    ...
                    'type' => Controls_Manager::TEXT,
                    'default' => __( 'This is sub title', 'haru-printspace' ),
            ...
            $this->add_control(
                'is_featured',
                [
                    'label'         => __( 'Is Featured', 'haru-printspace' ),
                    'type'          => Controls_Manager::SWITCHER,
                    'description'   => __( 'Enable if you want Icon bigger than others.', 'haru-printspace' ),
                    'default'       => 'no',
                    'return_value'  => 'yes',
                    'condition' => [
                        'pre_style' => [ 'style-10', 'style-18' ],
            ...
            $this->add_control(
                ...
                [
                    ...
                    'default' => '',
                    'selectors' => [
                        '{{WRAPPER}} .haru-icon-box' => 'background-color: {{VALUE}};',
                    ],
                    'condition' => [
                        'pre_style' => [ 'style-19' ],
                    ],
        ...
        protected function render() {
            ...
            <?php endif; ?>
                ...
                <div <?php echo $this->get_render_attribute_string( 'icon-box' ); ?>>
                    <?php if ( $has_icon ) : ?>
                        <?php if ( in_array( $settings['pre_style'], array( 'style-1', 'style-2', 'style-4', 'style-5', 'style-6', 'style-7', 'style-8', 'style-9', 'style-11', 'style-12', 'style-14', 'style-15', 'style-16', 'style-17', 'style-19', 'style-20', 'style-21' ) ) ) : ?>

                            <?php if ( in_array( $settings['pre_style'], array( 'style-6' ) ) ) : ?>
                            <div class="haru-icon-box__wrap">
                            <?php endif; ?>
                    ...
                    <?php if ( in_array( $settings['pre_style'], array( 'style-10', 'style-18' ) ) ) : ?>
