...
if ( ! class_exists( 'Haru_PrintSpace_Romeo_Slideshow_Widget' ) ) {
    class Haru_PrintSpace_Romeo_Slideshow_Widget extends Widget_Base {
        ...
        public function get_title() {
            return esc_html__( 'Haru Romeo Slideshow', 'haru-printspace' );
        }
        ...
        protected function register_controls() {
            ...
            $this->add_control(
                ...
                [
                  ...
                  'default' => 'boxed',
                  'options' => [
                    'boxed'      => __( 'Boxed', 'haru-printspace' ),
                    'fullscreen'    => __( 'Fullscreen', 'haru-printspace' ),
                  ]
                ]
            );
            ...
            $this->add_control(
                'source_type',
                [
                    'label' => __( 'Source Type', 'haru-printspace' ),
                    'type' => Controls_Manager::SELECT,
                    'default' => 'haru_video',
                    'options' => [
                        'haru_video' => __( 'Videos', 'haru-printspace' ),
                        'all_post_types'  => __( 'All Posts', 'haru-printspace' ),
                        'gallery' => __( 'Gallery', 'haru-printspace' ),
                        'videos' => __( 'Custom Videos', 'haru-printspace' )
                    ],
                ]
            );
            ...
            $this->add_control(
                'slides_gallery',
                [
                    'label' => __( 'Slides', 'haru-printspace' ),
            ...
            $repeater->add_control(
                'video_media',
                [
                    'label' => __( 'Choose File', 'haru-printspace' ),
            ...
            $repeater->add_control(
                'video_permalink',
                [
                    'label' => __( 'Permalink', 'haru-printspace' ),
            ...
            $this->add_control(
                'videos',
                [
                    'label' => __( 'Videos', 'haru-printspace' ),
            ...
            $this->start_controls_section(
                ...
                [
                    'label'     => __( 'Counter', 'haru-printspace' ),
                    'tab'       => Controls_Manager::TAB_CONTENT,
                ]
            );
            ...
            $this->add_control(
                'counter_text',
                [
                    'label' => __( 'Counter Text', 'haru-printspace' ),
                    'type' => Controls_Manager::TEXT,
                    'default' => esc_html__( 'Project' , 'haru-printspace' ),
                    'label_block' => true,
                ]
            );
            ...
            $this->start_controls_section(
                ...
                [
                    'label'     => __( 'View All Button', 'haru-printspace' ),
                    'tab'       => Controls_Manager::TAB_CONTENT,
                ]
            );
            ...
            $this->add_control(
                'button_text',
                [
                    'label' => __( 'Button Text', 'haru-printspace' ),
                    'type' => Controls_Manager::TEXT,
            ...
            $this->add_control(
                'button_link',
                [
                    'label' => __( 'Button Link', 'haru-printspace' ),
                    'type' => Controls_Manager::URL,
            ...
            $this->start_controls_section(
                ...
                [
                    'label'     => __( 'Socials', 'haru-printspace' ),
                    'tab'       => Controls_Manager::TAB_CONTENT,
                ]
            );
            ...
            $this->add_control(
                'social_title',
                [
                    'label' => __( 'Social Title', 'haru-printspace' ),
                    'type' => Controls_Manager::TEXT,
                    'default' => esc_html__( 'Follow us' , 'haru-printspace' ),
                    'label_block' => true,
                ]
            );
            ...
            $this->add_control(
                'list',
                [
                    'label' => esc_html__( 'Social List', 'haru-printspace' ),
                    'type' => Controls_Manager::REPEATER,
            ...
            $this->add_control(
                'image_overlay_color',
                [
                    'label'     => __( 'Images Overlay Color', 'haru-printspace' ),
                    'type'      => Controls_Manager::COLOR,
            ...
            $this->add_control(
                'text_color_counter',
                [
                    'label'     => __( 'Counter Text Color', 'haru-printspace' ),
                    'type'      => Controls_Manager::COLOR,
                    'default'   => '',
                    'selectors' => [
            ...
            $this->add_control(
                'text_color_title',
                [
                    'label'     => __( 'Title Text Color', 'haru-printspace' ),
                    'type'      => Controls_Manager::COLOR,
                    'default'   => '',
                    'selectors' => [
            ...
            $this->add_control(
                'bullets_color',
                [
                    'label'     => __( 'Bullets Color', 'haru-printspace' ),
                    'type'      => Controls_Manager::COLOR,
                    'default'   => '',
                    'selectors' => [
                    ...
                    <div class="slider-wrap">
                        ...
                        <?php if ( $settings['list'] ) : ?>
                            <div class="social-wrap">
                                <div class="social-label"><?php echo esc_html__( 'Follow us', 'haru-printspace' ); ?></div>
