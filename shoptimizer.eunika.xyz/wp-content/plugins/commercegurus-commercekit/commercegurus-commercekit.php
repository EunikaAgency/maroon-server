...
function commercekit_scripts() {
	...
	$enable_attr_swatches = defined( 'COMMERCEKIT_ATTRIBUTE_SWATCHES_VISIBLE' ) ? ( COMMERCEKIT_ATTRIBUTE_SWATCHES_VISIBLE ? 1 : 0 ) : ( isset( $commercekit_options['attribute_swatches'] ) && 1 === (int) $commercekit_options['attribute_swatches'] ? 1 : 0 );
	...
	if ( isset( $commercekit_options['countdown_timer'] ) && 1 === (int) $commercekit_options['countdown_timer'] ) {
		wp_enqueue_style( 'commercekit-countdown-css', plugins_url( 'assets/css/countdown.css', __FILE__ ), array(), CGKIT_CSS_JS_VER );
	}

	$sticky_atc_desktop = defined( 'COMMERCEKIT_STICKY_ATC_DESKTOP_VISIBLE' ) ? COMMERCEKIT_STICKY_ATC_DESKTOP_VISIBLE : ( isset( $commercekit_options['sticky_atc_desktop'] ) && 1 === (int) $commercekit_options['sticky_atc_desktop'] ? 1 : 0 );
	$sticky_atc_desktop = apply_filters( 'commercekit_module_sticky_atc_desktop_visible', $sticky_atc_desktop );
	$sticky_atc_mobile  = defined( 'COMMERCEKIT_STICKY_ATC_MOBILE_VISIBLE' ) ? COMMERCEKIT_STICKY_ATC_MOBILE_VISIBLE : ( isset( $commercekit_options['sticky_atc_mobile'] ) && 1 === (int) $commercekit_options['sticky_atc_mobile'] ? 1 : 0 );
	$sticky_atc_mobile  = apply_filters( 'commercekit_module_sticky_atc_mobile_visible', $sticky_atc_mobile );
	$sticky_atc_tabs    = defined( 'COMMERCEKIT_STICKY_ATC_TABS_VISIBLE' ) ? COMMERCEKIT_STICKY_ATC_TABS_VISIBLE : ( isset( $commercekit_options['sticky_atc_tabs'] ) && 1 === (int) $commercekit_options['sticky_atc_tabs'] ? 1 : 0 );
