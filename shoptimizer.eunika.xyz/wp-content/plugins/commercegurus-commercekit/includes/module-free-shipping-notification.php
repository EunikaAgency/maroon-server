...
function commercekit_fsn_add_shortcode() {
	...
	$enable_widget_pos_fsn = isset( $options['widget_pos_fsn'] ) && 1 === (int) $options['widget_pos_fsn'] ? true : false;
...
if ( isset( $commercekit_options['widget_pos_fsn'] ) && 1 === (int) $commercekit_options['widget_pos_fsn'] ) {
