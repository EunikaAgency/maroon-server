...
function commercekit_attribute_swatches_options_html( $html, $args ) {
	...
	$as_enabled = defined( 'COMMERCEKIT_ATTRIBUTE_SWATCHES_VISIBLE' ) ? COMMERCEKIT_ATTRIBUTE_SWATCHES_VISIBLE : ( isset( $commercekit_options['attribute_swatches'] ) && 1 === (int) $commercekit_options['attribute_swatches'] ? true : false );
...
function commercekit_attribute_swatches_attribute_label( $label, $name ) {
	...
	$commercekit_options = get_option( 'commercekit', array() );
	$cgkit_as_enabled    = defined( 'COMMERCEKIT_ATTRIBUTE_SWATCHES_VISIBLE' ) ? ( COMMERCEKIT_ATTRIBUTE_SWATCHES_VISIBLE ? 1 : 0 ) : ( isset( $commercekit_options['attribute_swatches'] ) && 1 === (int) $commercekit_options['attribute_swatches'] ? 1 : 0 );
