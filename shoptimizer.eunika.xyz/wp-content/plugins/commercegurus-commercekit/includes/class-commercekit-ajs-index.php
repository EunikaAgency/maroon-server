...
class CommerceKit_AJS_Index {
	 ...
	 */
	public function get_search_product_ids( $keywords, $return_all = false, $language = '' ) {
		global $wpdb;
	 ...
	 */
	public function get_search_post_ids( $keywords, $return_all = false, $language = '', $language_plug = '' ) {
		global $wpdb;
		$keywords = trim( $keywords );
		if ( empty( $keywords ) ) {
			if ( $return_all ) {
