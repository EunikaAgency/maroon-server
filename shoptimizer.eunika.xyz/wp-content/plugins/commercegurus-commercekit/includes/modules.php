...
$enable_sticky_atc_desk = defined( 'COMMERCEKIT_STICKY_ATC_DESKTOP_VISIBLE' ) ? COMMERCEKIT_STICKY_ATC_DESKTOP_VISIBLE : ( isset( $commercekit_options['sticky_atc_desktop'] ) && 1 === (int) $commercekit_options['sticky_atc_desktop'] ? 1 : 0 );
$enable_sticky_atc_desk = apply_filters( 'commercekit_module_sticky_atc_desktop_visible', $enable_sticky_atc_desk );
$enable_sticky_atc_mobi = defined( 'COMMERCEKIT_STICKY_ATC_MOBILE_VISIBLE' ) ? COMMERCEKIT_STICKY_ATC_MOBILE_VISIBLE : ( isset( $commercekit_options['sticky_atc_mobile'] ) && 1 === (int) $commercekit_options['sticky_atc_mobile'] ? 1 : 0 );
$enable_sticky_atc_mobi = apply_filters( 'commercekit_module_sticky_atc_mobile_visible', $enable_sticky_atc_mobi );
$enable_sticky_atc_tabs = defined( 'COMMERCEKIT_STICKY_ATC_TABS_VISIBLE' ) ? COMMERCEKIT_STICKY_ATC_TABS_VISIBLE : ( isset( $commercekit_options['sticky_atc_tabs'] ) && 1 === (int) $commercekit_options['sticky_atc_tabs'] ? 1 : 0 );
...
$enable_widget_pos_fsn  = isset( $commercekit_options['widget_pos_fsn'] ) && 1 === (int) $commercekit_options['widget_pos_fsn'] ? 1 : 0;
$enable_size_guide      = isset( $commercekit_options['size_guide'] ) && 1 === (int) $commercekit_options['size_guide'] ? 1 : 0;
$enable_store_badge     = defined( 'COMMERCEKIT_STORE_BADGES_VISIBLE' ) ? COMMERCEKIT_STORE_BADGES_VISIBLE : ( isset( $commercekit_options['store_badge'] ) && 1 === (int) $commercekit_options['store_badge'] ? 1 : 0 );
