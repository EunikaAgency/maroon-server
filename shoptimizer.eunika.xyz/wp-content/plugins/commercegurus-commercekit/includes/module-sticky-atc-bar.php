...
function commercekit_sticky_atc_bar_wrappers() {
	...
	$classes                = array();
	$enable_sticky_atc_tabs = defined( 'COMMERCEKIT_STICKY_ATC_TABS_VISIBLE' ) ? COMMERCEKIT_STICKY_ATC_TABS_VISIBLE : ( isset( $options['sticky_atc_tabs'] ) && 1 === (int) $options['sticky_atc_tabs'] ? true : false );
