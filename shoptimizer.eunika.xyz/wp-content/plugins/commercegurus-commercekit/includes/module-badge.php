...
$cgkit_pdpa_gallery = isset( $cgkit_options['pdp_attributes_gallery'] ) && 1 === (int) $cgkit_options['pdp_attributes_gallery'] && $cgkit_pdp_gallery ? true : false;
...
function commercekit_badge_show_badges( $product, $type = 'product' ) {
	...
	$pdpa_gallery = isset( $options['pdp_attributes_gallery'] ) && 1 === (int) $options['pdp_attributes_gallery'] && $pdp_gallery ? true : false;
	$wrap_class   = '';
