...
$layout_template = '<div class="swiper-container cg-main-swiper"><ul class="swiper-wrapper cg-psp-gallery" itemscope itemtype="http://schema.org/ImageGallery">{gallery-images}</ul><button class="swiper-button-next" aria-label="Next slide"></button><button class="swiper-button-prev" aria-label="Previous slide"></button><button class="load-more-images more" data-more="' . esc_html__( 'Load more images', 'commercegurus-commercekit' ) . '" data-less="' . esc_html__( 'Show less images', 'commercegurus-commercekit' ) . '">' . esc_html__( 'Load more images', 'commercegurus-commercekit' ) . '</button></div><div thumbsSlider="" class="swiper-container cg-thumb-swiper cg-thumbs-' . esc_attr( $pdp_attributes_thumbs ) . ' cg-thumbs-count-{img-count}"><ul class="swiper-wrapper" itemscope itemtype="http://schema.org/ImageGallery">{gallery-thumbs}</ul>' . ( isset( $options['pdp_thumb_arrows'] ) && 1 === (int) $options['pdp_thumb_arrows'] ? '<button class="swiper-button-next swiper-button-disabled" aria-label="Next slide"></button><button class="swiper-button-prev swiper-button-disabled" aria-label="Previous slide"></button>' : '' ) . '</div>';
