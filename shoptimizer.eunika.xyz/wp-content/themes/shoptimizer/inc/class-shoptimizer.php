...
if ( ! class_exists( 'shoptimizer' ) ) :
	...
	class shoptimizer {
		...
		public function body_classes( $classes ) {
			...
			$shoptimizer_layout_wrapper = '';
			$shoptimizer_layout_wrapper = shoptimizer_get_option( 'shoptimizer_layout_wrapper' );
			...
			if ( 'mobile-grid-two' === $shoptimizer_layout_woocommerce_mobile_grid ) {
				$classes[] = 'm-grid-2';
			}

			// Page container
			if ( 'yes' === $shoptimizer_layout_wrapper ) {
				$classes[] = 'shoptimizer-contained';
			}
