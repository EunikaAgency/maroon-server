...
class Advanced extends CheckersAbstract {
	...
	private function analyzeOpenGraph() {
		...
		if ( ! $this->pageParser->isScraping ) {
			...
			$facebook = [
				'title'       => aioseo()->helpers->encodeOutputHtml( aioseo()->social->facebook->getTitle() ),
				'description' => aioseo()->helpers->encodeOutputHtml( aioseo()->social->facebook->getDescription() ),
				'image'       => aioseo()->social->facebook->getImage( $this->object['id'] ),
			];
			$twitter  = [
				'title'       => aioseo()->helpers->encodeOutputHtml( aioseo()->social->twitter->getTitle() ),
				'description' => aioseo()->helpers->encodeOutputHtml( aioseo()->social->twitter->getDescription() ),
