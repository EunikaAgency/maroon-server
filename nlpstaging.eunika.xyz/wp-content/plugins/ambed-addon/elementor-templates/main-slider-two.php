                                ...
                                <div class="col-xl-12">
                                    <div class="main-slider-two__content">
                                        <?php if (!empty($slider['sub_title'])) : ?>
                                            <p class="main-slider-two__sub-title"><?php echo wp_kses($slider['sub_title'], 'ambed_allowed_tags'); ?></p>
                                        <?php endif; ?>
                                        <?php if (!empty($slider['title'])) : ?>
                                            <h2 class="main-slider-two__title"><?php echo wp_kses($slider['title'], 'ambed_allowed_tags'); ?></h2>
                                        <?php endif; ?>
                                        <?php if (!empty($slider['button_label'])) : ?>
                                            <div class="main-slider-two__btn-box">
                                                <a <?php echo esc_attr(!empty($slider['button_url']['is_external']) ? 'target=_blank' : ' '); ?> href="<?php echo esc_url($slider['button_url']['url']); ?>" class="main-slider-two__btn thm-btn"><?php echo esc_html($slider['button_label']); ?></a>
                                            </div>
                                        <?php endif; ?>
                                    </div>
                                </div>
