<?php if ('layout_two' == $settings['layout_type']) : ?>
	...
	<section class="blog-two">
		<?php if (!empty($settings['background_image'])) : ?>
			<div class="blog-two-bg" style="background-image: url(<?php echo esc_url($settings['background_image']['url']) ?>);"></div>
		<?php endif; ?>
		<div class="container">
					...
					<?php if (!empty($settings['summary'])) : ?>
						<div class="col-xl-6 col-lg-6">
							<div class="blog-two__right">
								<p class="blog-two__right-text"><?php echo wp_kses($settings['summary'], 'ambed_allowed_tags'); ?></p>
							</div>
						</div>
					<?php endif; ?>
				</div>
