...
class Custom_Footer_Widget1 extends Widget_Base {
    ...
    public function get_title() {
        return __('Custom Footer', 'plugin-name');
    }
    ...
    protected function register_controls() {
        $this->start_controls_section(
            ...
            [
                'label' => __('Footer Menus', 'plugin-name'),
        ...
        $this->add_control(
            'company_menu',
            [
                'label' => __('Company Menu', 'plugin-name'),
        ...
        $this->add_control(
            'area_menu',
            [
                'label' => __('Areas We Cover', 'plugin-name'),
                'type' => Controls_Manager::SELECT,
                'options' => $menu_options,
                'default' => array_key_first($menu_options),
            ]
        ...
        $this->add_control(
            'services_menu',
            [
                'label' => __('Services Menu', 'plugin-name'),
                'type' => Controls_Manager::SELECT,
                'options' => $menu_options,
                'default' => array_key_first($menu_options),
            ]
        ...
        $this->add_control(
            'resources_menu',
            [
                'label' => __('Resources Menu', 'plugin-name'),
                'type' => Controls_Manager::SELECT,
                'options' => $menu_options,
                'default' => array_key_first($menu_options),
            ]
        ...
        $this->add_control(
            'partners_menu',
            [
                'label' => __('Partners Menu', 'plugin-name'),
                'type' => Controls_Manager::SELECT,
                'options' => $menu_options,
                'default' => array_key_first($menu_options),
            ]
