...
class Custom_Navbar_Widget extends Widget_Base {
    ...
    public function get_title() {
        return __('Custom Navbar Widget', 'plugin-name');
    }
...
<style>
    ...
    **********************/
    ...
    /* Apply hover to the parent <li> so submenu stays open even if cursor is between */
    ...
    .custom-nav .navbar-nav .sub-menu ul {
        padding: 0;
    }
...
<nav class="custom-nav navbar navbar-expand-lg" id="customnavbar">
    ...
    <div class="offcanvas offcanvas-start " tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
        ...
        <div class="offcanvas-body d-flex justify-content-between">
            <?php
                wp_nav_menu([
                    'menu' => 'One Page Home Three',
                    'menu_class' => 'navbar-nav',
                    'container' => false,
                    'depth' => 3, // Allows 3 levels of dropdown
                    'walker' => new Simple_Hover_Dropdown_Walker(),
